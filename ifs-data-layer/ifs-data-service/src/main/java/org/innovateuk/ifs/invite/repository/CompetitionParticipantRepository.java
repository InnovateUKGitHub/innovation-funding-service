...
public interface CompetitionParticipantRepository extends PagingAndSortingRepository<AssessmentParticipant, Long> {
    ...
    String PARTICIPANTS_NOT_ON_ASSESSMENT_PANEL = "SELECT competitionParticipant " +
            "FROM AssessmentParticipant competitionParticipant " +
    ...
    String PARTICIPANTS_WITHOUT_ASSESSMENTS = "SELECT cp FROM AssessmentParticipant cp WHERE cp.competition.id = :compId " +
            "AND cp.role = :role " +
    ...
    String PARTICIPANTS_WITH_ASSESSMENTS = "SELECT cp FROM AssessmentParticipant cp WHERE " +
