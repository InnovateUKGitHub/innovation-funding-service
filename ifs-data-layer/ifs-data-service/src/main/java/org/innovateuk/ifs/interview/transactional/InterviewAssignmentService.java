...
public interface InterviewAssignmentService {
    ...
    @PreAuthorize("hasAnyAuthority('applicant', 'assessor', 'comp_admin', 'project_finance', 'external_finance', 'innovation_lead', 'stakeholder', 'support', 'monitoring_officer', 'knowledge_transfer_adviser')")
