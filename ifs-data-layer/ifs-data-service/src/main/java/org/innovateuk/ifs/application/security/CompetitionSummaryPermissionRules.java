...
public class CompetitionSummaryPermissionRules extends BasePermissionRules {
    ...
    public boolean innovationLeadsCanViewCompetitionSummaryOnAssginedComps(Long competitionId, UserResource user) {
    ...
    public boolean allInternalUsersCanViewCompetitionSummaryOtherThanInnovationLeads(Long competitionId, UserResource user) {
