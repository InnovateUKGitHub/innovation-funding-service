...
public interface RenameOrganisationV1Api {
    ...
    RestResult<List<Organisation>> findOrganisationsByCompaniesHouseNumber(
    ...
    RestResult<List<Organisation>> findOrganisationsByName(@PathVariable("name") final String name);
