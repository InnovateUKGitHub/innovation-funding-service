...
public class AssessmentReviewPanelInvite extends CompetitionInvite<AssessmentReviewPanelInvite>  {

    public AssessmentReviewPanelInvite() {
    }

    /**
     * An existing User invited to an Assessment Panel.
     */
    public AssessmentReviewPanelInvite(final User existingUser, final String hash, Competition competition) {
