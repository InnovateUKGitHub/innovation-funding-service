...
public interface ProcurementMilestoneService<R extends ProcurementMilestoneResource, S extends ProcurementMilestoneId> {
    ...
    ServiceResult<Void> delete(S milestoneId);
    ...
    ServiceResult<R> get(S milestoneId);
