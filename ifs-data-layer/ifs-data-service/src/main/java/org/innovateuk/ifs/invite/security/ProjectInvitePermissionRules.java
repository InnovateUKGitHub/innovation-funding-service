...
public class ProjectInvitePermissionRules extends BasePermissionRules {
    ...
    public boolean partnersOnProjectCanViewInvite(final ProjectInviteResource invite, UserResource user) {
    ...
    public boolean partnersOnProjectCanSendInvite(final ProjectInviteResource invite, UserResource user) {
    ...
    public boolean partnersOnProjectCanSaveInvite(final ProjectInviteResource invite, UserResource user) {
        return isUserPartnerOnProjectWithinSameOrganisation(invite, user);
    }


    private boolean isUserPartnerOnProjectWithinSameOrganisation(final ProjectInviteResource invite, UserResource user){
    ...
    private boolean isUserMemberOfProjectTeam(final ProjectInviteResource invite, UserResource user) {
