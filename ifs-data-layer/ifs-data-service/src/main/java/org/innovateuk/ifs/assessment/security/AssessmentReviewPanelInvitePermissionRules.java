...
/**
 * Provides the permissions around CRUD operations for {@link AssessmentReviewPanelInvite} resources.
 */
@Component
@PermissionRules
public class AssessmentReviewPanelInvitePermissionRules extends BasePermissionRules {
