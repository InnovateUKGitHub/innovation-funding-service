...
public interface FileService {
    ...
    ServiceResult<FileEntry> createFile(FileEntryResource file, Supplier<InputStream> inputStreamSupplier);
    ...
    @NotSecured(value = "This Service is to be used within other secured services", mustBeSecuredByOtherServices = true)
    ServiceResult<FileEntry> updateFile(FileEntryResource updatedFile, Supplier<InputStream> inputStreamSupplier);
