...
public class ProjectProcurementMilestonePermissionRules extends BasePermissionRules {
    ...
    public boolean partnersCanSeeTheProjectFinancesForTheirOrganisation(final ProjectProcurementMilestoneResource projectFinanceResource, final UserResource user) {
    ...
    public boolean internalUserCanSeeProjectFinancesForOrganisations(final ProjectProcurementMilestoneResource projectFinanceResource, final UserResource user) {
        return isInternal(user);
    }

    @PermissionRule(value = "VIEW", description = "A stakeholder user can see project finances for organisations")
    public boolean stakeholderUserCanSeeProjectFinancesForOrganisations(final ProjectProcurementMilestoneResource projectFinanceResource, final UserResource user) {
    ...
    public boolean competitionFinanceUserCanSeeProjectFinancesForOrganisations(final ProjectProcurementMilestoneResource projectFinanceResource, final UserResource user) {
