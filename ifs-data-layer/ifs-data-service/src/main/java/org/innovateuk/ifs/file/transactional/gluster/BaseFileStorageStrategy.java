...
import static org.innovateuk.ifs.file.transactional.gluster.FileFunctions.pathElementsToFile;
import static org.innovateuk.ifs.file.transactional.gluster.FileFunctions.pathElementsToPath;
...
abstract class BaseFileStorageStrategy implements FileStorageStrategy {
    ...
    public ServiceResult<File> getFile(FileEntry file) {
        ...
        log.info(foldersPath.toString());
        log.info(foldersPath.toAbsolutePath().toString());
