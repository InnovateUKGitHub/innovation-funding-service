...
public interface MonitoringOfficerService {
    ...
    @PreAuthorize("hasPermission(#userId, 'org.innovateuk.ifs.user.resource.UserResource', 'GET_MONITORING_OFFICER_PROJECTS')")
    ServiceResult<List<ProjectResource>> filterMonitoringOfficerProjects(long userId, boolean projectInSetup, boolean previousProject, boolean documentsComplete, boolean documentsIncomplete, boolean documentsAwaitingReview);
    ...
    @PreAuthorize("hasPermission(#projectId, 'org.innovateuk.ifs.project.resource.ProjectResource', 'VIEW_MONITORING_OFFICER')")
    ServiceResult<Void> sendDocumentReviewNotification(long projectId, long userId);
