...
public class ProjectDetailsPermissionRules extends BasePermissionRules {
    ...
    @PermissionRule(
            value = "UPDATE_START_DATE", description = "The IFS Administrator can update the start date")
    public boolean ifsAdministratorCanUpdateStartDate(ProjectResource project, UserResource user) {
