...
public class CompetitionInitialiser {
    ...
    private List<FinanceRowType> ktpFinanceTypes() {
        return newArrayList(ASSOCIATE_SALARY_COSTS, ASSOCIATE_DEVELOPMENT_COSTS, TRAVEL, CONSUMABLES, KNOWLEDGE_BASE, ESTATE_COSTS, ASSOCIATE_SUPPORT, OTHER_COSTS, ADDITIONAL_COMPANY_COSTS, FINANCE, OTHER_FUNDING, YOUR_FINANCE);
    }
