...
public class OverheadFilePermissionRules extends BasePermissionRules {
    ...
    public boolean consortiumCanUpdateAnOverheadsFileForTheirApplicationAndOrganisation(final ApplicationFinanceRow overheads, final UserResource user) {
        return isCollaborator(overheads, user);
    }
    ...
    public boolean consortiumCanDeleteAnOverheadsFileForTheirApplicationAndOrganisation(final ApplicationFinanceRow overheads, final UserResource user) {
        return isCollaborator(overheads, user);
    }
    ...
    public boolean consortiumCanReadDetailsAnOverheadsFileForTheirApplicationAndOrganisation(final ApplicationFinanceRow overheads, final UserResource user) {
        return isCollaborator(overheads, user);
    }
    ...
    public boolean internalUserCanReadDetailsOfAnOverheadsFileForTheirApplicationAndOrganisation(final ApplicationFinanceRow overheads, final UserResource user) {
    ...
    public boolean supportAndIfsAdminCanReadContentsOfAnOverheadsFileForANotSubmittedApplication(final ApplicationFinanceRow overheads, final UserResource user) {
    ...
    public boolean internalUsersCanReadContentsOfAnOverheadsFileForASubmittedApplication(final ApplicationFinanceRow overheads, final UserResource user) {
    ...
    public boolean consortiumCanReadContentsOfAnOverheadsFileForTheirApplicationAndOrganisation(final ApplicationFinanceRow overheads, final UserResource user) {
        return isCollaborator(overheads, user);
    }

    private boolean isCollaborator(final ApplicationFinanceRow overheads, final UserResource user) {
    ...
    private boolean isDownloadableAfterSubmission(final ApplicationFinanceRow overheads, final UserResource user) {
        return isApplicationSubmitted(overheads) && isInternal(user);
    }

    private boolean isApplicationSubmitted(final ApplicationFinanceRow overheads) {
        final ApplicationFinance applicationFinance = overheads.getTarget();
        final Long applicationId = applicationFinance.getApplication().getId();
