...
public class AffiliationController {
    ...
    public RestResult<AffiliationListResource> getUserAffiliationsOld(@PathVariable("userId") long userId) {
        return affiliationService.getUserAffiliations(userId).toGetResponse();
    }

    @GetMapping("/id/{userId}/get-user-affiliations")
    ...
    public RestResult<Void> updateUserAffiliationsOld(@PathVariable("userId") long userId,
    ...
    @PutMapping("/id/{userId}/update-user-affiliations")
