...
public class FinanceCheckNotesServiceImpl implements FinanceCheckNotesService {
    ...
    @Autowired
    public FinanceCheckNotesServiceImpl(NoteRepository noteRepository, UserServiceImpl userService, NoteMapper noteMapper, PostMapper postMapper) {
        service = new MappingThreadService<>(noteRepository, userService, noteMapper, postMapper, ProjectFinance.class);
    }
