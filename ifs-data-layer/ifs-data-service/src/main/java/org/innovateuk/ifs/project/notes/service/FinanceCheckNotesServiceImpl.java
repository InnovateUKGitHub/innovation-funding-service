...
public class FinanceCheckNotesServiceImpl implements FinanceCheckNotesService {
    ...
    @Autowired
    public FinanceCheckNotesServiceImpl(NoteRepository noteRepository, UserRepository userRepository, NoteMapper noteMapper, PostMapper postMapper) {
        service = new MappingThreadService<>(noteRepository, userRepository, noteMapper, postMapper, ProjectFinance.class);
    }
