...
public class ProjectWorkflowHandler extends BaseWorkflowEventHandler<ProjectProcess, ProjectState, ProjectEvent, Project, ProjectUser> {
    ...
    public boolean handleProjectOffline(Project project, User internalUser) {
        return fireEvent(internalUserEvent(project, internalUser, ProjectEvent.HANDLE_OFFLINE), project);
    }

    public boolean completeProjectOffline(Project project, User internalUser) {
    ...
    public boolean markAsSuccessful(Project project, User internalUser) {
        return fireEvent(internalUserEvent(project, internalUser, ProjectEvent.MARKED_AS_SUCCESSFUL), project);
    }

    public boolean markAsUnsuccessful(Project project, User internalUser) {
        return fireEvent(internalUserEvent(project, internalUser, ProjectEvent.MARKED_AS_UNSUCCESSFUL), project);
    }
