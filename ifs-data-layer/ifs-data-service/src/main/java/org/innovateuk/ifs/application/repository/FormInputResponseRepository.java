...
public interface FormInputResponseRepository extends PagingAndSortingRepository<FormInputResponse, Long> {
    ...
    FormInputResponse findOneByApplicationIdAndFormInputQuestionQuestionSetupType(long applicationId, CompetitionSetupQuestionType questionSetupType);
    ...
    //Implement this to fix permission issue with file upload - INFUND-2059
