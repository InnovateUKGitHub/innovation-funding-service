...
public interface StatusService {
    ...
    @SecuredBySpring(value = "READ_COMPETITION_STATUS", securedType = CompetitionProjectsStatusResource.class,
            description = "Comp Admins, project finance and support users should be able to access the current status of the competition")
    ...
    @SecuredBySpring(value = "READ_PROJECT_STATUS", securedType = ProjectStatusResource.class,
            description = "Comp Admins, project finance and support users should be able to access the current status of the project")
