...
/* IFS-1620 assumes feedback cannot be released until at least one application is funded and informed
            "EXISTS (SELECT m.date FROM Milestone m WHERE m.type = 'FEEDBACK_RELEASED' and m.competition.id = c.id) OR " + */
