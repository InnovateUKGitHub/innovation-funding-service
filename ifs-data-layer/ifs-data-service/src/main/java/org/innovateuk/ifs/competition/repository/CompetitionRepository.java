...
public interface CompetitionRepository extends PagingAndSortingRepository<Competition, Long> {
    ...
    String INNOVATION_LEAD_STAKEHOLDER_COMPETITION_FINANCE_PROJECT_SETUP_WHERE_CLAUSE = "WHERE cp.user.id = :userId " +
            "AND cp.role in ('INNOVATION_LEAD', 'STAKEHOLDER', 'COMPETITION_FINANCE') " +
    ...
    String INNOVATION_LEAD_STAKEHOLDER_COMPETITION_FINANCE_PREVIOUS_WHERE_CLAUSE = "WHERE cp.user.id = :userId AND " +
    ...
    String INNOVATION_LEAD_STAKEHOLDER_COMPETITION_FINANCE_PROJECT_SETUP_QUERY = "SELECT distinct cp.competition FROM CompetitionParticipant cp " + INNOVATION_LEAD_STAKEHOLDER_COMPETITION_FINANCE_PROJECT_SETUP_WHERE_CLAUSE + " ORDER BY cp.competition.name";

    String INNOVATION_LEAD_STAKEHOLDER_PROJECT_SETUP_COUNT_QUERY = "SELECT count(distinct cp.competition.id) FROM CompetitionParticipant cp " + INNOVATION_LEAD_STAKEHOLDER_COMPETITION_FINANCE_PROJECT_SETUP_WHERE_CLAUSE;
    ...
    String INNOVATION_LEAD_STAKEHOLDER_COMPETITION_FINANCE_PREVIOUS_QUERY = "SELECT distinct cp.competition FROM CompetitionParticipant cp " + INNOVATION_LEAD_STAKEHOLDER_COMPETITION_FINANCE_PREVIOUS_WHERE_CLAUSE + " ORDER BY cp.competition.id DESC";

    String INNOVATION_LEAD_STAKEHOLDER_PREVIOUS_COUNT_QUERY = "SELECT count(distinct cp.competition.id) FROM CompetitionParticipant cp " + INNOVATION_LEAD_STAKEHOLDER_COMPETITION_FINANCE_PREVIOUS_WHERE_CLAUSE;
    ...
    @Query(INNOVATION_LEAD_STAKEHOLDER_COMPETITION_FINANCE_PROJECT_SETUP_QUERY)
    ...
    @Query(INNOVATION_LEAD_STAKEHOLDER_COMPETITION_FINANCE_PREVIOUS_QUERY)
