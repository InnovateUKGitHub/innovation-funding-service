...
public interface CompetitionRepository extends PagingAndSortingRepository<Competition, Long> {
    ...
    public static final String GET_PENDING_SPEND_PROFILES = "SELECT NEW org.innovateuk.ifs.competition.resource.CompetitionPendingSpendProfilesResource(" +
    ...
    List<CompetitionPendingSpendProfilesResource> getPendingSpendProfiles(@Param("competitionId") long competitionId);
