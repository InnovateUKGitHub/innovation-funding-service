...
ALTER TABLE bank_details
  ...
  ADD CONSTRAINT bank_details_to_address_id_fk FOREIGN KEY (address_id) REFERENCES address (id);
...
ALTER TABLE organisation_application_address
  ...
  ADD CONSTRAINT organisation_application_address_to_application_id FOREIGN KEY (application_id) REFERENCES application (id),
