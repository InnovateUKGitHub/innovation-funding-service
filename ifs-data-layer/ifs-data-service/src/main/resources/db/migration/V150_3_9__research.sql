update ignore growth_table gt
        ...
        inner join form_input_response research_and_development_response on research_and_development_response.form_input_id = research_and_development_input.id and research_and_development_response.application_id=app.id
        inner join process_role research_and_development_updated_by on research_and_development_updated_by.id = research_and_development_response.updated_by_id and research_and_development_updated_by.organisation_id = af.organisation_id
