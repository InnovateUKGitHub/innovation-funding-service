update ignore growth_table gt
        ...
        inner join form_input_response year_end_response on year_end_response.form_input_id = year_end_input.id and year_end_response.application_id=app.id
        inner join process_role year_end_updated_by on year_end_updated_by.id = year_end_response.updated_by_id and year_end_updated_by.organisation_id = af.organisation_id
