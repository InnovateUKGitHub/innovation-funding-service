...
VALUES ('Innovate UK - Subsidy control', 'default-subsidy-control-terms-and-conditions-v4', 4, 'GRANT', @system_maintenance_user_id, NOW(), NOW(), @system_maintenance_user_id);