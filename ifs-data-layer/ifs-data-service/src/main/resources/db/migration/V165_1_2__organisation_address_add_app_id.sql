...
CREATE TABLE application_organisation_address (
  id bigint(20) NOT NULL AUTO_INCREMENT,
  organisation_address_id bigint(20) NOT NULL,
  application_id bigint(20) NOT NULL,
  PRIMARY KEY (id),
  CONSTRAINT application_organisation_address_to_application_fk FOREIGN KEY (application_id) REFERENCES application (id),
  CONSTRAINT application_organisation_address_to_organisation_address_fk FOREIGN KEY (organisation_address_id) REFERENCES organisation_address (id)
