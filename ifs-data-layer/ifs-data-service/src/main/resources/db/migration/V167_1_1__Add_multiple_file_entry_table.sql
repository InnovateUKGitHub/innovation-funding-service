...
CREATE TABLE `form_input_response_file_entry` (
  `form_input_response_id` bigint(20),
  `file_entry_id` bigint(20),
  PRIMARY KEY (`form_input_response_id`,`file_entry_id`),
  CONSTRAINT `form_input_response_file_entry_fk` FOREIGN KEY (`form_input_response_id`) REFERENCES `form_input_response` (`id`),
