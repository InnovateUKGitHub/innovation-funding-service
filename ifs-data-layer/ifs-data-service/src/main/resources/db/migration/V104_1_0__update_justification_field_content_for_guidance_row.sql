--  Update justification content for Sector competition template

SET @question5_form_input_id = (SELECT id FROM form_input WHERE guidance_title LIKE 'Guidance for assessing outcomes and route to market' AND competition_id = 3);

UPDATE guidance_row
SET justification = 'The applicant provides little or no information about the target customers.'
WHERE subject = '1,2'
AND form_input_id = @question5_form_input_id;
