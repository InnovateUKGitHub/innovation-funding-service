...
INSERT INTO question (assign_enabled,description,mark_as_completed_enabled,multiple_statuses,name,short_name,priority,question_number,competition_id,section_id,assessor_maximum_score,question_type,question_setup_type) VALUES (1,'Please provide the brief description of your project that you were asked for during your original Horizon 2020 funding application.',1,0,'Public description','Public description',3,NULL,@template_id,@section_project_details_id,NULL,'GENERAL','PUBLIC_DESCRIPTION');
set @question_public_description_id = (SELECT LAST_INSERT_ID());
INSERT INTO question (assign_enabled,description,mark_as_completed_enabled,multiple_statuses,name,short_name,priority,question_number,competition_id,section_id,assessor_maximum_score,question_type,question_setup_type) VALUES (0,'Description not used',1,0,'Horizon 2020 grant agreement','Horizon 2020 grant agreement',4,NULL,@template_id,@section_project_details_id,NULL,'LEAD_ONLY','GRANT_AGREEMENT');
...
-- Form Inputs
-- project details
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (400,2,@template_id,1,'Public description','What should I include in the project public description?','<p>Innovate UK publishes information about projects we have funded. This is in line with government practice on openness and transparency of public-funded activities.</p><p>Describe your project in a way that will be easy for a non-specialist to understand. Don\'t include any information that is confidential, for example, intellectual property or patent details.</p> ',0,@question_public_description_id,'APPLICATION',1,NULL);
set @fi_public_description_id = (SELECT LAST_INSERT_ID());

-- your organisation
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,19,@template_id,1,'Size',NULL,NULL,0,@question_organisation_size_id,'APPLICATION',1,NULL);
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,24,@template_id,0,'Turnover (£)','Your turnover from the last financial year.','',2,@question_organisation_size_id,'APPLICATION',1,NULL);
set @fi_turnover_id = (SELECT LAST_INSERT_ID());
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,25,@template_id,0,'Full time employees','Number of full time employees at your organisation.','',3,@question_organisation_size_id,'APPLICATION',1,NULL);
set @fi_employees_id = (SELECT LAST_INSERT_ID());
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,26,@template_id,0,'End of last financial year','Enter the date of your last financial year.','',4,@question_organisation_size_id,'APPLICATION',0,NULL);
set @fi_end_fin_year_id = (SELECT LAST_INSERT_ID());
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,27,@template_id,0,'Annual turnover','','',5,@question_organisation_size_id,'APPLICATION',0,NULL);
set @fi_fin_turnover_id = (SELECT LAST_INSERT_ID());
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,27,@template_id,0,'Annual profits','','',6,@question_organisation_size_id,'APPLICATION',0,NULL);
set @fi_fin_profit_id = (SELECT LAST_INSERT_ID());
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,27,@template_id,0,'Annual export','','',7,@question_organisation_size_id,'APPLICATION',0,NULL);
set @fi_fin_export_id = (SELECT LAST_INSERT_ID());
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,27,@template_id,0,'Research and development spend','','',8,@question_organisation_size_id,'APPLICATION',0,NULL);
set @fi_fin_rd_id = (SELECT LAST_INSERT_ID());
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,28,@template_id,0,'Full time employees','How many full-time employees did you have on the project at the close of your last financial year?','',9,@question_organisation_size_id,'APPLICATION',0,NULL);
set @fi_fin_employees_id = (SELECT LAST_INSERT_ID());

-- your funding
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,17,@template_id,1,'Other funding','What should I include in the other public funding section?','<p>You must provide details of other public funding that you are currently applying for (or have already applied for) in relation to this project. You do not need to include completed grants that were used to reach this point in the development process. This information is important as other public sector support counts as part of the funding you can receive for your project.</p>',0,@question_other_funding_id,'APPLICATION',1,NULL);
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,7,@template_id,1,'Please enter the grant % you wish to claim for this project','What funding level should I enter?','<p>For a business or academic organisation, you can apply for any funding percentage between 0% and the maximum allowable for your organisation size. For other organisation types, you can apply for any funding percentage between 0% and 100%. The amount you apply for must reflect other funding you may have received. It must also be within participation levels which you can review on the Finances Overview page.</p>',0,@question_funding_level_id,'APPLICATION',1,NULL);

INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,8,@template_id,1,'Labour',NULL,NULL,0,@question_labour_id,'APPLICATION',1,NULL);
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,9,@template_id,1,'Overheads',NULL,NULL,0,@question_overhead_id,'APPLICATION',1,NULL);
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,10,@template_id,1,'Materials',NULL,NULL,0,@question_material_id,'APPLICATION',1,NULL);
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,11,@template_id,1,'Capital Usage',NULL,NULL,0,@question_capital_id,'APPLICATION',1,NULL);
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,12,@template_id,1,'Sub-contracting costs',NULL,NULL,0,@question_subcontracting_id,'APPLICATION',1,NULL);
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,13,@template_id,1,'Travel and subsistence',NULL,NULL,0,@question_travel_id,'APPLICATION',1,NULL);
INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,14,@template_id,1,'Other costs',NULL,NULL,0,@question_other_id,'APPLICATION',1,NULL);

INSERT INTO form_input (word_count,form_input_type_id,competition_id,included_in_application_summary,description,guidance_title,guidance_answer,priority,question_id,scope,active,allowed_file_types) VALUES (NULL,16,@template_id,1,NULL,NULL,NULL,0,@question_finance_summary_id,'APPLICATION',1,NULL);
...
INSERT INTO competition_type (name, active, template_competition_id) VALUES ('Horizon 2020', 0, @template_id);
