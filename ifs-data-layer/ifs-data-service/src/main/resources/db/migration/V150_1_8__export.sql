update ignore growth_table gt
        ...
        inner join form_input_response annual_export_response on annual_export_response.form_input_id = annual_export_input.id and annual_export_response.application_id=app.id
        inner join process_role annual_export_updated_by on annual_export_updated_by.id = annual_export_response.updated_by_id and annual_export_updated_by.organisation_id = af.organisation_id
