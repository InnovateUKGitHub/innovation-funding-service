...
-- We can't remove the organisation_address_id column because DW expect it, although they don't use it. remove not null and wipe data.
ALTER TABLE bank_details MODIFY COLUMN organisation_address_id bigint(20);
UPDATE bank_details SET organisation_address_id = NULL;
