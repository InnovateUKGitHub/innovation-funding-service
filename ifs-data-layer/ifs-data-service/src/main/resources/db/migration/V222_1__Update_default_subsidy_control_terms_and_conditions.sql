...
VALUES ('Innovate UK - Subsidy control', 'default-subsidy-control-terms-and-conditions-v3', 3, 'GRANT', @system_maintenance_user_id, NOW(), NOW(), @system_maintenance_user_id);