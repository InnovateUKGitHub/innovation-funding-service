...
VALUES ('Aerospace Technology Institute (ATI) - Subsidy control', 'ati-subsidy-control-terms-and-conditions-v3', 2, 'GRANT', @system_maintenance_user_id, NOW(), NOW(), @system_maintenance_user_id);