...
ALTER TABLE application ADD CONSTRAINT fk_application_external_config FOREIGN KEY(application_external_config_id) REFERENCES application_external_config(id);
