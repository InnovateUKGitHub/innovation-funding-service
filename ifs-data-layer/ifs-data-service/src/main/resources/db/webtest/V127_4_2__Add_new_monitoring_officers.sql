...
VALUES ('Orville.Gibbs@gmail.com', 'Orville', 'Gibbs', 'ACTIVE', '623d49e5-816e-4acf-b95a-5d712562e037', 0, 0, @ifs_web_system_user_id, NOW(), @ifs_web_system_user_id, NOW());

INSERT INTO `user`
(email, first_name, last_name, status, uid, system_user, allow_marketing_emails, created_by, created_on, modified_by, modified_on)
VALUES ('Nilesh.Patti@gmail.com', 'Nilesh', 'Patti', 'ACTIVE', 'ea4bc32f-4149-444b-a781-02c6b08ae0d1', 0, 0, @ifs_web_system_user_id, NOW(), @ifs_web_system_user_id, NOW());

INSERT INTO `user`
(email, first_name, last_name, status, uid, system_user, allow_marketing_emails, created_by, created_on, modified_by, modified_on)
VALUES ('Rupesh.Pereira@gmail.com', 'Rupesh', 'Pereira', 'ACTIVE', '4486a84a-fbef-419a-9cd0-032170031c97', 0, 0, @ifs_web_system_user_id, NOW(), @ifs_web_system_user_id, NOW());
