...
SELECT @financial_year_end_id := id FROM form_input WHERE competition_id = @comp_id AND question_id=@question_id AND form_input_type_id =26;
...
UPDATE form_input SET active = 1 WHERE id = @financial_year_end_id;
...
INSERT INTO form_input_response (update_date, value, form_input_id, updated_by_id, application_id) VALUES(NOW(), '01-2020', @financial_year_end_id, @process_role_id, @app_id);
...
INSERT INTO form_input_response (update_date, value, form_input_id, updated_by_id, application_id) VALUES(NOW(), '1230', @financial_overview_id1, @process_role_id, @app_id);
INSERT INTO form_input_response (update_date, value, form_input_id, updated_by_id, application_id) VALUES(NOW(), '1230', @financial_overview_id2, @process_role_id, @app_id);
INSERT INTO form_input_response (update_date, value, form_input_id, updated_by_id, application_id) VALUES(NOW(), '1230', @financial_overview_id3, @process_role_id, @app_id);
INSERT INTO form_input_response (update_date, value, form_input_id, updated_by_id, application_id) VALUES(NOW(), '1230', @financial_overview_id4, @process_role_id, @app_id);
INSERT INTO form_input_response (update_date, value, form_input_id, updated_by_id, application_id) VALUES(NOW(), '12-2021', @financial_year_end_id, @process_role_id_4, @app_id);
...
INSERT INTO form_input_response (update_date, value, form_input_id, updated_by_id, application_id) VALUES(NOW(), '1230', @financial_overview_id1, @process_role_id_4, @app_id);
INSERT INTO form_input_response (update_date, value, form_input_id, updated_by_id, application_id) VALUES(NOW(), '1230', @financial_overview_id2, @process_role_id_4, @app_id);
INSERT INTO form_input_response (update_date, value, form_input_id, updated_by_id, application_id) VALUES(NOW(), '1230', @financial_overview_id3, @process_role_id_4, @app_id);
INSERT INTO form_input_response (update_date, value, form_input_id, updated_by_id, application_id) VALUES(NOW(), '1230', @financial_overview_id4, @process_role_id_4, @app_id);

-- Update project in setup to use the non growth table values
SELECT @comp_id_2 := id FROM competition WHERE name = 'Predicting market trends programme';
SELECT @app_id_2 := id FROM application WHERE competition = @comp_id_2 AND name = 'Water balance creates a threshold in soil pH at the global scale';
