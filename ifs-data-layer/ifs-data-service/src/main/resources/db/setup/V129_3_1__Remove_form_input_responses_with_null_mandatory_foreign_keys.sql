...
-- Those NOT NULL constraints have been revered in V129_5_1. As a result the below statement has been commented (as this has not yet been run on production)
