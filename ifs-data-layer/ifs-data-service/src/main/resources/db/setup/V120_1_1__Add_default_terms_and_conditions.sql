...
-- Add entry into terms and conditions table for the version 2 of default Innovate UK terms and conditions
INSERT INTO terms_and_conditions (name, template, version)
    VALUES ("Innovate UK", "default-terms-and-conditions-v2", 2);
