...
(0, '<a href="https://www.surveymonkey.co.uk/r/ifsaccount" target="_blank" rel="external">Complete the survey (opens in new window).</a><p>We will not use this data when we assess your application. We collect this data anonymously and only use it to help us understand our funding recipients better.</p>', 'Equality, diversity and inclusion', 3, 5, 64, 'GENERAL', 'EQUALITY_DIVERSITY_INCLUSION'),
(0, '<a href="https://www.surveymonkey.co.uk/r/ifsaccount" target="_blank" rel="external">Complete the survey (opens in new window).</a><p>We will not use this data when we assess your application. We collect this data anonymously and only use it to help us understand our funding recipients better.</p>', 'Equality, diversity and inclusion', 3, 6, 66, 'GENERAL', 'EQUALITY_DIVERSITY_INCLUSION'),
(0, '<a href="https://www.surveymonkey.co.uk/r/ifsaccount" target="_blank" rel="external">Complete the survey (opens in new window).</a><p>We will not use this data when we assess your application. We collect this data anonymously and only use it to help us understand our funding recipients better.</p>', 'Equality, diversity and inclusion', 3, 7, 81, 'GENERAL', 'EQUALITY_DIVERSITY_INCLUSION'),
