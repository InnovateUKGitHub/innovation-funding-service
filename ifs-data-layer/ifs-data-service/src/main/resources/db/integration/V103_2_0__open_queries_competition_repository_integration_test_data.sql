...
INSERT INTO profile (id, created_by, created_on, modified_by, modified_on) values (@profile_id + 2, @user_id, NOW(), @user_id, NOW());
INSERT INTO user (email, profile_id, uid, created_by, created_on, modified_by, modified_on) values ('pmifs2100@gmail.vom', @profile_id + 2, 'uid0012654321', @user_id, NOW(), @user_id, NOW());
...
SELECT MAX(class_pk) INTO @pfin_id FROM thread WHERE class_name ='org.innovateuk.ifs.finance.domain.ProjectFinance';
INSERT INTO project_finance (id, project_id, organisation_id) values (@pfin_id + 1, @proj_id, @org_id + 1);
INSERT INTO thread (class_pk, class_name, title, thread_type) values (@pfin_id + 1, 'org.innovateuk.ifs.finance.domain.ProjectFinance', 'Thread1', 'QUERY');
...
INSERT INTO project_finance (id, project_id, organisation_id) values (@pfin_id + 2, @proj_id + 1, @org_id + 2);

INSERT INTO thread (id, class_pk, class_name, title, thread_type) values (@thread_id + 1, @pfin_id + 2, 'org.innovateuk.ifs.finance.domain.ProjectFinance', 'Thread2', 'QUERY');
...
INSERT INTO project_finance (id, project_id, organisation_id) values (@pfin_id + 3, @proj_id + 2, @org_id + 1);

INSERT INTO thread (id, class_pk, class_name, title, thread_type) values (@thread_id + 2, @pfin_id + 3, 'org.innovateuk.ifs.finance.domain.ProjectFinance', 'Thread3', 'QUERY');
...
INSERT INTO thread (id, class_pk, class_name, title, thread_type) values (@thread_id + 3, @pfin_id + 3, 'org.innovateuk.ifs.finance.domain.ProjectFinance', 'Thread32', 'QUERY');
...
INSERT INTO project_finance (id, project_id, organisation_id) values (@pfin_id + 4, @proj_id + 3, @org_id + 1);

INSERT INTO thread (id, class_pk, class_name, title, thread_type) values (@thread_id + 4, @pfin_id + 4, 'org.innovateuk.ifs.finance.domain.ProjectFinance', 'Thread4', 'QUERY');
...
INSERT INTO thread (id, class_pk, class_name, title, thread_type) values (@thread_id + 5, @pfin_id + 4, 'org.innovateuk.ifs.finance.domain.ProjectFinance', 'Thread5', 'NOTE');
...
INSERT INTO thread (id, class_pk, class_name, title, thread_type) values (@thread_id + 6, @pfin_id + 4, 'org.innovateuk.ifs.finance.domain.Wibble', 'Thread6', 'QUERY');
...
INSERT INTO project_finance (id, project_id, organisation_id) values (@pfin_id + 5, @proj_id + 4, @org_id + 1);
INSERT INTO thread (id, class_pk, class_name, title, thread_type) values (@thread_id + 7, @pfin_id + 5, 'org.innovateuk.ifs.finance.domain.ProjectFinance', 'Thread7', 'QUERY');
...
INSERT INTO project_finance (id, project_id, organisation_id) values (@pfin_id + 6, @proj_id + 4, @org_id + 2);
INSERT INTO thread (id, class_pk, class_name, title, thread_type) values (@thread_id + 8, @pfin_id + 6, 'org.innovateuk.ifs.finance.domain.ProjectFinance', 'Thread8', 'QUERY');
...
INSERT INTO project_finance (id, project_id, organisation_id) values (@pfin_id + 7, @proj_id + 5, @org_id + 1);
INSERT INTO thread (id, class_pk, class_name, title, thread_type) values (@thread_id + 9, @pfin_id + 7, 'org.innovateuk.ifs.finance.domain.ProjectFinance', 'Thread9', 'QUERY');
...
INSERT INTO project_finance (id, project_id, organisation_id) values (@pfin_id + 8, @proj_id + 6, @org_id + 1);
INSERT INTO thread (id, class_pk, class_name, title, thread_type) values (@thread_id + 10, @pfin_id + 8, 'org.innovateuk.ifs.finance.domain.ProjectFinance', 'Thread10', 'QUERY');
...
INSERT INTO project_finance (id, project_id, organisation_id) values (@pfin_id + 9, @proj_id + 7, @org_id + 1);
INSERT INTO thread (id, class_pk, class_name, title, thread_type) values (@thread_id + 11, @pfin_id + 9, 'org.innovateuk.ifs.finance.domain.ProjectFinance', 'Thread11', 'QUERY');
