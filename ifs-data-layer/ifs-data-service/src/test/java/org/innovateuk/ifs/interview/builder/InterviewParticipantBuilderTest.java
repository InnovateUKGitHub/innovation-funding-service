...
public class InterviewParticipantBuilderTest {
    ...
    public void buildOne() {
        ...
        InterviewInvite expectedInvite = InterviewInviteBuilder.newInterviewInvite().build();

        InterviewParticipant participant = InterviewParticipantBuilder.newInterviewParticipant()
                .withId(expectedId)
    ...
    public void buildMany() {
        ...
        InterviewInvite[] expectedCompetitionInvites = InterviewInviteBuilder.newInterviewInvite().buildArray(2, InterviewInvite.class);
        ...
        List<InterviewParticipant> participants = InterviewParticipantBuilder.newInterviewParticipant()
                .withId(expectedIds)
        ...
        InterviewParticipant first = participants.get(0);
        ...
        InterviewParticipant second = participants.get(1);
