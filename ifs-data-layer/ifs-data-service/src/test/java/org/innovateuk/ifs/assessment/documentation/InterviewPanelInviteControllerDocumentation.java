...
public class InterviewPanelInviteControllerDocumentation extends BaseControllerMockMVCTest<InterviewInviteController> {
    ...
    public void openInvite() throws Exception {
        ...
        InterviewInviteResource interviewReviewPanelInviteResource = ASSESSMENT_INTERVIEW_PANEL_INVITE_RESOURCE_BUILDER.build();
