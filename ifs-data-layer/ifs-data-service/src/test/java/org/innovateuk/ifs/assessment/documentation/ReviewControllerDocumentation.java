...
public class ReviewControllerDocumentation extends BaseControllerMockMVCTest<ReviewController>{
    ...
    public void getAssessmentReviews() throws Exception {
        List<ReviewResource> assessmentResources = assessmentReviewResourceBuilder.build(2);
    ...
    public void getAssessmentReview() throws Exception {
        ReviewResource reviewResource = assessmentReviewResourceBuilder.build();

        when(assessmentPanelServiceMock.getAssessmentReview(reviewId)).thenReturn(serviceSuccess(reviewResource));
    ...
    public void rejectInvitation() throws Exception {
        ReviewRejectOutcomeResource rejectOutcomeResource = assessmentReviewRejectOutcomeResourceBuilder.build();
