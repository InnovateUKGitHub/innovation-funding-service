...
public class CsvUtils {
    ...
    public static class ProjectLine {
        ...
        public Boolean uploadSignedGrantOffLetter;
        ...
        private ProjectLine(List<String> line) {
            ...
            uploadSignedGrantOffLetter = nullableBoolean(line.get(i++)) && publishGrantOffLetter;
        }
    }
    ...
    public static class CompetitionLine {
        ...
        public Boolean competitionOrganisationConfig;
        ...
        private CompetitionLine(List<String> line, int lineNumber) {
            ...
            competitionOrganisationConfig = nullableBoolean(line.get(i++));
        }
    }
