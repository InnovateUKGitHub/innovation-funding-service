...
import static org.innovateuk.ifs.project.monitoringofficer.builder.LegacyMonitoringOfficerBuilder.newMonitoringOfficer;
...
public class StatusServiceImplTest extends BaseServiceUnitTest<StatusService> {
    ...
    public void getCompetitionStatus() {
        ...
        LegacyMonitoringOfficer monitoringOfficerInDB = newMonitoringOfficer().build();
    ...
    private Project createProjectStatusResource(long projectId, ApprovalType spendProfileStatus,
        ...
        LegacyMonitoringOfficer monitoringOfficer = newMonitoringOfficer().build();
    ...
    public void getProjectTeamStatus() {
        ...
        LegacyMonitoringOfficer monitoringOfficerInDB = LegacyMonitoringOfficerBuilder.newMonitoringOfficer().build();
