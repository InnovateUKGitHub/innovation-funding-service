...
public class InterviewAssignmentServiceSecurityTest extends BaseServiceSecurityTest<InterviewAssignmentService> {
    ...
    public void isApplicationAssigned() {
        testOnlyAUserWithOneOfTheGlobalRolesCan(
                ...
                APPLICANT, ASSESSOR, COMP_ADMIN, PROJECT_FINANCE, EXTERNAL_FINANCE, INNOVATION_LEAD, STAKEHOLDER, SUPPORT, MONITORING_OFFICER, KNOWLEDGE_TRANSFER_ADVISER, SUPPORTER
        );
    }
