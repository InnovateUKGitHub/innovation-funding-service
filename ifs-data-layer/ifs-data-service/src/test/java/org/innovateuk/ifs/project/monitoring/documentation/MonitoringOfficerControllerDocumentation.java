...
public class MonitoringOfficerControllerDocumentation extends BaseControllerMockMVCTest<MonitoringOfficerController> {
    ...
    public void findAll() throws Exception {
        ...
        List<MonitoringAssignmentOfficerResource> expected =
                singletonList(new MonitoringAssignmentOfficerResource(1L,
                                                                   "firstName",
                                                                   "lastName",
                                                                   unassignedProjects,
                                                                   assignedProjects));
    ...
    public void getProjectMonitoringOfficer() throws Exception {
        long userId = 7;
        MonitoringAssignmentOfficerResource expected = new MonitoringAssignmentOfficerResource(1L, "firstName", "lastName",
