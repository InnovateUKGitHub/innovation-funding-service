...
public class ApplicationCountSummaryControllerDocumentation extends BaseControllerMockMVCTest<ApplicationCountSummaryController> {
    ...
    public void getApplicationCountSummariesByCompetitionIdAndAssessorId() throws Exception {
        ...
        mockMvc.perform(get("/application-count-summary/find-by-competition-id-and-assessor-id/{competitionId}/{assessorId}/{assessmentPeriodId}?sort={sortField}&filter={filter}", competitionId, assessorId, assessmentPeriodId, sortField, filter)
                .header("IFS_AUTH_TOKEN", "123abc"))
                .andExpect(status().isOk())
                .andDo(document("applicationCountSummary/{method-name}",
                        pathParameters(
    ...
    public void getApplicationIdsByCompetitionIdAndAssessorId() throws Exception {
        ...
        mockMvc.perform(get("/application-count-summary/find-ids-by-competition-id-and-assessor-id/{competitionId}/{assessorId}/{assessmentPeriodId}?filter={filter}", competitionId, assessorId, assessmentPeriodId, filter)
                .header("IFS_AUTH_TOKEN", "123abc"))
                .andExpect(status().isOk())
                .andDo(document("applicationCountSummary/{method-name}",
                        pathParameters(
