...
public class FormInputResponseFileUploadControllerTest extends BaseControllerMockMVCTest<FormInputResponseFileUploadController> {
    ...
    public void testCreateFile() throws Exception {
        ...
        FormInputResource formInput = newFormInputResource().build();

        when(formInputServiceMock.findFormInput(formInput.getId())).thenReturn(serviceSuccess(formInput));
        when(fileValidatorWithFormInputMock.validateFileHeaders("application/pdf", "1000", "original.pdf", formInput)).thenReturn(serviceSuccess(fileAttributesAfterValidation));
        ...
        verify(fileValidatorWithFormInputMock).validateFileHeaders("application/pdf", "1000", "original.pdf", formInput);
...
//
//        when(fileValidatorWithFormInputMock.validateFileHeaders(isA(String.class), isA(String.class), isA(String.class))).thenReturn(serviceSuccess(new FileHeaderAttributes(MediaType.valueOf("application/pdf"), 1000, "original.pdf")));
...
//
//        when(fileValidatorWithFormInputMock.validateFileHeaders("application/pdf", "99999999", "original.pdf")).thenReturn(serviceFailure(payloadTooLargeError(5000)));
//
//        MvcResult response = mockMvc.
//                perform(
//                        post("/forminputresponse/file").
...
//
//        when(fileValidatorWithFormInputMock.validateFileHeaders("application/pdf", null, "original.pdf")).thenReturn(serviceFailure(lengthRequiredError(5000L)));
//
//        MvcResult response = mockMvc.
//                perform(
//                        post("/forminputresponse/file").
...
//
//        when(fileValidatorWithFormInputMock.validateFileHeaders("text/plain", "1000", "original.pdf")).thenReturn(serviceFailure(unsupportedMediaTypeByNameError(asList("application/pdf", "application/json"))));
//
//        MvcResult response = mockMvc.
//                perform(
//                        post("/forminputresponse/file").
...
//
//        when(fileValidatorWithFormInputMock.validateFileHeaders(null, "1000", "original.pdf")).thenReturn(serviceFailure(unsupportedMediaTypeByNameError(asList("application/pdf", "application/json"))));
//
//        MvcResult response = mockMvc.
//                perform(
//                        post("/forminputresponse/file").
...
//        when(fileValidatorWithFormInputMock.validateFileHeaders("application/pdf", "1000", "updated.pdf")).thenReturn(serviceSuccess(fileAttributesAfterValidation));
...
//
//        verify(fileValidatorWithFormInputMock).validateFileHeaders("application/pdf", "1000", "updated.pdf");
...
//
//        FileHeaderAttributes fileAttributesAfterValidation = new FileHeaderAttributes(MediaType.valueOf("application/pdf"), 1000L, "original.pdf");
//        when(fileValidatorWithFormInputMock.validateFileHeaders("application/pdf", "1000", "original.pdf")).thenReturn(serviceSuccess(fileAttributesAfterValidation));
...
//
//        when(fileValidatorWithFormInputMock.validateFileHeaders("application/pdf", null, "original.pdf")).thenReturn(serviceFailure(lengthRequiredError(5000)));
//
//        MvcResult response = mockMvc.
//                perform(
//                        put("/forminputresponse/file").
...
//    }
    ...
    private void assertCreateFileButErrorOccurs(Error errorToReturn, String documentationSuffix, HttpStatus expectedStatus) throws Exception {
        ...
        when(fileValidatorWithFormInputMock.validateFileHeaders(isA(String.class), isA(String.class), isA(String.class), isA(FormInputResource.class))).thenReturn(serviceSuccess(new FileHeaderAttributes(MediaType.valueOf("application/pdf"), 1000, "original.pdf")));
        when(applicationServiceMock.createFormInputResponseFileUpload(isA(FormInputResponseFileEntryResource.class), isSupplierMatcher())).thenReturn(failureResponse);
