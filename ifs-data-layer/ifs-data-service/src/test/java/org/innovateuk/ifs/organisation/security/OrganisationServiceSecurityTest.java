...
public class OrganisationServiceSecurityTest extends BaseServiceSecurityTest<OrganisationService> {
    ...
    private void verifyUserHasAccessToOrganisation(int times) {
        ...
        verify(rules, times(times))
                .monitoringOfficersCanSeeApplicationOrganisations(isA(OrganisationResource.class), eq(getLoggedInUser()));
        verify(rules, times(times))
        ...
        verify(rules, times(times))
                .applicantCanSeeAllOrganisations(isA(OrganisationResource.class), eq(getLoggedInUser()));
