...
public class UserControllerTest extends BaseControllerMockMVCTest<UserController> {
    ...
    public void testFindActiveInternalUsers() throws Exception {
        when(userServiceMock.findActiveByProcessRoles(UserRoleType.internalUserRoleTypes(), new PageRequest(0, 5))).thenReturn(serviceSuccess(new UserPageResource()));
    ...
    public void testFindInactiveInternalUsers() throws Exception {
        when(userServiceMock.findInactiveByProcessRoles(UserRoleType.internalUserRoleTypes(), new PageRequest(0, 5))).thenReturn(serviceSuccess(new UserPageResource()));
