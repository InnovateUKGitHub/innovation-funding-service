...
public class AssessorServiceImplTest extends BaseUnitTestMocksTest {
    ...
    public void registerAssessorByHash_callCorrectServicesAndHaveSuccessfulOutcome() throws Exception {
        ...
        List<CompetitionAssessmentParticipant> participantsForOtherInvites = Stream.generate(
                () -> Mockito.spy(new CompetitionAssessmentParticipant())).limit(2).collect(Collectors.toList());
        ...
        InOrder inOrder = inOrder(competitionInviteServiceMock, registrationServiceMock,
