...
public class InterviewInviteBuilderTest {
    ...
    public void buildOne() {
        ...
        InterviewInvite invite = InterviewInviteBuilder.newInterviewInvite()
                .withId(expectedId)
    ...
    public void buildMany() {
        ...
        List<InterviewInvite> invites = InterviewInviteBuilder.newInterviewInvite()
                .withId(expectedIds)
        ...
        InterviewInvite first = invites.get(0);
        ...
        InterviewInvite second = invites.get(1);
