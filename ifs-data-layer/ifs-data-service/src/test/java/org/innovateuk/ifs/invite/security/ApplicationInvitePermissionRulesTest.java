...
public class ApplicationInvitePermissionRulesTest extends BasePermissionRulesTest<ApplicationInvitePermissionRules> {
    ...
    public void setup() throws Exception {
        ...
        collaborator = newUserResource().build();
        {
            ...
            when(processRoleRepositoryMock.findOneByUserIdAndRoleInAndApplicationId(collaborator.getId(), applicantRoles(), application.getId())).thenReturn(newProcessRole().withRole(getRole(COLLABORATOR)).build());
        ...
        otherCollaborator = newUserResource().build();
        {
            ...
            when(processRoleRepositoryMock.findOneByUserIdAndRoleInAndApplicationId(otherApplication.getId(), applicantRoles(), otherApplication.getId())).thenReturn(newProcessRole().withRole(getRole(LEADAPPLICANT)).build());
            when(processRoleRepositoryMock.findOneByUserIdAndRoleInAndApplicationId(otherCollaborator.getId(), applicantRoles(), otherApplication.getId())).thenReturn(newProcessRole().withRole(getRole(COLLABORATOR)).build());
