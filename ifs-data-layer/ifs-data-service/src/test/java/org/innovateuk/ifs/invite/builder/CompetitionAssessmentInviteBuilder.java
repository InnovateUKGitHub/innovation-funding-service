 ...
 */
public class CompetitionAssessmentInviteBuilder extends BaseInviteBuilder<Competition, CompetitionAssessmentInvite, CompetitionAssessmentInviteBuilder> {

    private CompetitionAssessmentInviteBuilder(List<BiConsumer<Integer, CompetitionAssessmentInvite>> multiActions) {
        super(multiActions);
    }
    ...
    @Override
    protected CompetitionAssessmentInviteBuilder createNewBuilderWithActions(List<BiConsumer<Integer, CompetitionAssessmentInvite>> actions) {
