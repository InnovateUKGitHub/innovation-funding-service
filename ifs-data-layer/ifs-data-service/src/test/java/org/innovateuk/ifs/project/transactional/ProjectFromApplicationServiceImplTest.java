...
public class ProjectFromApplicationServiceImplTest extends BaseServiceUnitTest<ProjectFromApplicationService> {
    ...
    public void testCreateProjectFromApplication() {
        ...
        ServiceResult<ProjectResource> project = service.createSingletonProjectFromApplicationId(applicationId);
    ...
    @Override
    protected ProjectFromApplicationService supplyServiceUnderTest() {
        return new ProjectFromApplicationServiceImpl();
    }
}
