...
public class InviteUserServiceImplTest extends BaseServiceUnitTest<InviteUserServiceImpl> {
    ...
    public void setUp() {
        ...
        invitedUser = UserResourceBuilder.newUserResource()
                ...
                .withEmail("Astle.Pimenta@iuk.ukri.test")
                .build();
    }
    ...
    public void inviteInternalUserSendEmailSucceeds() throws Exception {
        ...
        NotificationTarget notificationTarget = new UserNotificationTarget("Astle Pimenta", "Astle.Pimenta@iuk.ukri.test");
        ...
        assertEquals("Astle.Pimenta@iuk.ukri.test", captured.get(0).getEmail());
        ...
        assertEquals("Astle.Pimenta@iuk.ukri.test", captured.get(1).getEmail());
