...
public class ApplicationSummaryControllerTest extends BaseControllerMockMVCTest<ApplicationSummaryController> {
    ...
    public void searchSubmittedByCompetitionId() throws Exception {
        ...
        when(applicationSummaryService.getSubmittedApplicationSummariesByCompetitionId(competitionId, null, page, PAGE_SIZE, empty(), empty(), empty(), empty())).thenReturn(serviceSuccess(resource));
        ...
        verify(applicationSummaryService).getSubmittedApplicationSummariesByCompetitionId(competitionId, null, page, PAGE_SIZE, empty(), empty(), empty(), empty());
    }
    ...
    public void searchSubmittedByCompetitionIdWithSortField() throws Exception {
        ...
        when(applicationSummaryService.getSubmittedApplicationSummariesByCompetitionId(competitionId, sort, page, PAGE_SIZE, empty(), empty(), empty(), empty())).thenReturn(serviceSuccess(resource));
        ...
        verify(applicationSummaryService).getSubmittedApplicationSummariesByCompetitionId(competitionId, sort, page, PAGE_SIZE, empty(), empty(), empty(), empty());
    }
    ...
    public void searchSubmittedByCompetitionIdWithFilter() throws Exception {
        ...
        when(applicationSummaryService.getSubmittedApplicationSummariesByCompetitionId(competitionId, null, page, PAGE_SIZE, of(strFilter), of(fundingFilter), empty(), empty())).thenReturn(serviceSuccess(resource));
        ...
        verify(applicationSummaryService).getSubmittedApplicationSummariesByCompetitionId(competitionId, null, page, PAGE_SIZE, of(strFilter), of(fundingFilter), empty(), empty());
    }
    ...
    public void searchAllSubmittedApplicationIdsByCompetitionId() throws Exception {
        ...
        when(applicationSummaryService.getAllSubmittedApplicationIdsByCompetitionId(competitionId, of(strFilter), of(fundingFilter), empty())).thenReturn(serviceSuccess(applicationIds));
        ...
        verify(applicationSummaryService).getAllSubmittedApplicationIdsByCompetitionId(competitionId, of(strFilter), of(fundingFilter), empty());
    }
