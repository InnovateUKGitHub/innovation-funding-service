...
public class AssessmentInterviewPanelInviteBuilderTest {
    ...
    public void buildMany() {
        ...
        AssessmentInterviewPanelInvite first = invites.get(0);
        ...
        AssessmentInterviewPanelInvite second = invites.get(1);
