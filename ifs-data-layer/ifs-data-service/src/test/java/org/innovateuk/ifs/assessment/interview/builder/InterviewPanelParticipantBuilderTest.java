...
public class InterviewPanelParticipantBuilderTest {
    ...
    public void buildOne() {
        ...
        InterviewInvite expectedInvite = newAssessmentInterviewPanelInvite().build();

        InterviewParticipant participant = newAssessmentInterviewPanelParticipant()
                .withId(expectedId)
    ...
    public void buildMany() {
        ...
        InterviewInvite[] expectedCompetitionInvites = newAssessmentInterviewPanelInvite().buildArray(2, InterviewInvite.class);
        ...
        List<InterviewParticipant> participants = newAssessmentInterviewPanelParticipant()
                .withId(expectedIds)
