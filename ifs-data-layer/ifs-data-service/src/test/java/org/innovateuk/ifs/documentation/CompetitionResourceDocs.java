...
public class CompetitionResourceDocs {
    public static final FieldDescriptor[] competitionResourceFields = {
            ...
            fieldWithPath("includeYourOrganisationSection").description("The FundingType of the competition"),
            fieldWithPath("fundingType").description("Indicate if the competition has a your organisation section"),
