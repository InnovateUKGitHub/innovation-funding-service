...
public class InterviewPanelBuilderTest {
    ...
    public void buildOne() {
        ...
        InterviewAssignment interviewAssignment = newAssessmentInterviewPanel()
                .withId(expectedId)
    ...
    public void buildMany() {
        ...
        List<InterviewAssignment> interviewAssignments = newAssessmentInterviewPanel()
                .withId(expectedIds)
