...
public class ReviewInviteServiceSecurityTest extends BaseServiceSecurityTest<AssessmentReviewPanelInviteService> {
    ...
    public static class TestReviewInviteService implements AssessmentReviewPanelInviteService {
