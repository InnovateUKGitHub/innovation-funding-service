...
public class FinanceRowMetaValueTest {
    ...
    public void setUp() throws Exception {
        ...
        cost = new ApplicationFinanceRow("cost key", "cost item", "cost description", 10, price, applicationFinance, question);
        financeRowMetaField = new FinanceRowMetaField("NVP", "String");
        value = "19000";
    ...
    public void costValueShouldReturnCorrectAttributeValuesAfterSetters() throws Exception {
        FinanceRow newCost = new ApplicationFinanceRow("cost key", "cost item", "cost description", 10, price, applicationFinance, question);
        FinanceRowMetaField newFinanceRowMetaField = new FinanceRowMetaField("title","type");
