...
public class InterviewPanelInviteControllerTest extends BaseControllerMockMVCTest<InterviewInviteController> {
    ...
    public void getAllInvitesByUser() throws Exception {
        ...
        InterviewInviteResource invite = newAssessmentInterviewPanelInviteResource()
                .withCompetitionId(1L)
        ...
        InterviewParticipantResource interviewParticipantResource = newAssessmentInterviewPanelParticipantResource()
                ...
                .withInvite(invite)
                .build();
        when(assessmentInterviewPanelInviteServiceMock.getAllInvitesByUser(USER_ID)).thenReturn(serviceSuccess(singletonList(interviewParticipantResource)));
