...
public class QuestionServiceSecurityTest extends BaseServiceSecurityTest<QuestionService> {
    ...
    public void testGetPreviousQuestionBySection() {
        ...
        when(classUnderTestMock.getPreviousQuestionBySection(sectionId)).thenReturn(serviceSuccess(newQuestionResource().build()));
    ...
    public void testGetNextQuestionBySection() {
        ...
        when(classUnderTestMock.getNextQuestionBySection(sectionId)).thenReturn(serviceSuccess(newQuestionResource().build()));
