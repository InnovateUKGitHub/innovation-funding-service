...
public class ReviewParticipantBuilderTest {
    ...
    public void buildOne() {
        ...
        ReviewInvite expectedInvite = newAssessmentPanelInvite().build();

        ReviewParticipant participant = newAssessmentPanelParticipant()
                .withId(expectedId)
    ...
    public void buildMany() {
        ...
        ReviewInvite[] expectedCompetitionInvites = newAssessmentPanelInvite().buildArray(2, ReviewInvite.class);
        ...
        List<ReviewParticipant> participants = newAssessmentPanelParticipant()
                .withId(expectedIds)
