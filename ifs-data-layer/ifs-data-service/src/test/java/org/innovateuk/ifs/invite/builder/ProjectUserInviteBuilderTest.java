...
public class ProjectUserInviteBuilderTest {
    ...
    public void buildOne() {
        ...
        ProjectUserInvite applicationInvite = newProjectUserInvite()
                .withId(expectedId)
    ...
    public void buildMany() {
        ...
        List<ProjectUserInvite> applicationInvites = newProjectUserInvite()
                .withId(expectedIds)
        ...
        ProjectUserInvite first = applicationInvites.get(0);
        ...
        ProjectUserInvite second = applicationInvites.get(1);
