...
=== Get allocated applications by id
==== Request
include::{snippets}/interview-panel/get-allocated-applications-by-id/http-request.adoc[]
include::{snippets}/interview-panel/get-allocated-applications-by-id/path-parameters.adoc[]

==== Response
include::{snippets}/interview-panel/get-allocated-applications-by-id/http-response.adoc[]
include::{snippets}/interview-panel/get-allocated-applications-by-id/response-fields.adoc[]

==== Curl Example
include::{snippets}/interview-panel/get-allocated-applications-by-id/curl-request.adoc[]
