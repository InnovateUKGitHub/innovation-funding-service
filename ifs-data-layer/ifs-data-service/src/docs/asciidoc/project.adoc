...
==== Success
===== Request
include::{snippets}/inviteUser/internal/pending/find-pending-internal-users/http-request.adoc[]

==== Response
include::{snippets}/inviteUser/internal/pending/find-pending-internal-users/http-response.adoc[]
include::{snippets}/inviteUser/internal/pending/find-pending-internal-users/response-fields.adoc[]

==== Curl Example
include::{snippets}/inviteUser/internal/pending/find-pending-internal-users/curl-request.adoc[]
