...
include::{snippets}/inviteUser/internal/pending/inviteId/resend-internal-user-invite/response-fields.adoc[]
...
=== Is Signed Grant Offer Letter Rejected
==== Success
===== Request
include::{snippets}/project/is-signed-grant-offer-letter-rejected/http-request.adoc[]
include::{snippets}/project/is-signed-grant-offer-letter-rejected/path-parameters.adoc[]

===== Response
include::{snippets}/project/is-signed-grant-offer-letter-rejected/http-response.adoc[]

===== Curl Example
include::{snippets}/project/is-signed-grant-offer-letter-rejected/curl-request.adoc[]
