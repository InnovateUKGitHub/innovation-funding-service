...
=== Accept or reject Other Documents
==== Success
===== Request
include::{snippets}/project/accept-or-reject-other-documents/http-request.adoc[]
include::{snippets}/project/accept-or-reject-other-documents/path-parameters.adoc[]

===== Response
include::{snippets}/project/accept-or-reject-other-documents/http-response.adoc[]

===== Curl Example
include::{snippets}/project/accept-or-reject-other-documents/curl-request.adoc[]
