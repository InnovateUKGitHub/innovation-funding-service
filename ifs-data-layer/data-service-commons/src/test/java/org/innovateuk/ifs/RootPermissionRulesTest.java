...
public abstract class RootPermissionRulesTest<T> extends BaseUnitTestMocksTest {
    ...
    protected List<UserResource> compAdminsAndProjectFinance;
    ...
    protected UserResource stakeholderUser() {
    ...
    public void setupSetsOfData() {
        ...
        compAdminsAndProjectFinance = asList(compAdminUser(), projectFinanceUser());
    }
