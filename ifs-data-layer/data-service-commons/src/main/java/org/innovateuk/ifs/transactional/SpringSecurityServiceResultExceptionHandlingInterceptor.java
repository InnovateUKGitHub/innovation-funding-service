...
import static org.innovateuk.ifs.commons.error.CommonFailureKeys.GENERAL_SPRING_SECURITY_OTHER_EXCEPTION_THROWN;
...
public class SpringSecurityServiceResultExceptionHandlingInterceptor implements MethodInterceptor {
    ...
    public Object invoke(MethodInvocation invocation) throws Throwable {
        try {
            ...
            // There is more useful logging in DefaultPermissionMethodHandler.
