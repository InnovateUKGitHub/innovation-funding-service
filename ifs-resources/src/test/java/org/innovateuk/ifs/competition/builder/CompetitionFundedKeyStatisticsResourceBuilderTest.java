...
/**
 * Tests for CompetitionFundedKeyStatisticsResourceBuilder
 */
public class CompetitionFundedKeyStatisticsResourceBuilderTest {
    ...
    public void buildMany() {
        ...
        List<CompetitionFundedKeyStatisticsResource> keyStatisticsResources = newCompetitionFundedKeyStatisticsResource()
                .withApplicationsSubmitted(expectedApplicationsSubmitted)
                .withApplicationsFunded(expectedApplicationsFunded)
                .withApplicationsNotFunded(expectedApplicationsNotFunded)
                .withApplicationsOnHold(expectedApplicationsOnHold)
