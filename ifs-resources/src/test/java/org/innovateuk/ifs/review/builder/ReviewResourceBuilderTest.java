...
public class ReviewResourceBuilderTest {
    ...
    public void buildOne() throws Exception {
        ...
        ReviewRejectOutcomeResource expectedRejection = newReviewRejectOutcomeResource().build();
        Long expectedProcessRole = 2L;
        Long expectedApplication = 3L;
        String expectedApplicationName = "name";
        Long expectedCompetition = 4L;

        ReviewResource assessment = newReviewResource()
                .withId(expectedId)
    ...
    public void buildMany() {
        ...
        ReviewRejectOutcomeResource[] expectedRejections = newReviewRejectOutcomeResource()
        ...
        List<ReviewResource> assessments = newReviewResource()
                .withId(expectedIds)
