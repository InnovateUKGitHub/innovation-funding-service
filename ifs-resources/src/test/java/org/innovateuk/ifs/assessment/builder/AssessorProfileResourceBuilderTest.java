...
//
//        ProfileResource assessorProfileResource = newAssessorProfileResource()
...
//        List<InnovationAreaResource> expectedInnovationAreas = newInnovationAreaResource().build(2);
//
//        List<ProfileResource> assessorProfileResources = newAssessorProfileResource()
//                .withSkillsAreas(expectedSkillsAreas)
//                .withBusinessType(expectedBusinessType)
//                .withAffiliations(expectedAffiliations)
//                .withInnovationAreas(expectedInnovationAreas)
...
//                .build(2);
//
//        ProfileResource first = assessorProfileResources.get(0);
...
//
//        ProfileResource second = assessorProfileResources.get(1);
