...
public class FormInputResourceBuilder extends BaseBuilder<FormInputResource, FormInputResourceBuilder> {
    ...
    public FormInputResourceBuilder withAllowedFileTypes(List<FileTypeCategory>... fileTypes) {
        return withArray((types, formInput) -> formInput.setAllowedFileTypes(simpleJoiner(simpleMap(types, FileTypeCategory::getDisplayName), ",")), fileTypes);
    }
}
