...
public class AvailableAssessorPageResourceBuilderTest {
    ...
    public void buildOne() throws Exception {
        AvailableAssessorPageResource resource = newAvailableAssessorPageResource()
    ...
    public void buildMany() throws Exception {
        List<AvailableAssessorPageResource> resources = newAvailableAssessorPageResource()
