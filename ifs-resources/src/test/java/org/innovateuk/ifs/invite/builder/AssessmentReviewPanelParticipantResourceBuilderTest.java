...
public class AssessmentReviewPanelParticipantResourceBuilderTest {
    ...
    public void buildOne() {
        ...
        AssessmentReviewPanelParticipantResource competitionParticipant = newAssessmentReviewPanelParticipantResource()
                .withId(expectedId)
                .withUser(expectedUserId)
                .withCompetition(expectedCompetitionId)
                .withInvite(newAssessmentReviewPanelInviteResource().build())
    ...
    public void buildMany() {
        ...
        List<AssessmentReviewPanelParticipantResource> competitionParticipants = newAssessmentReviewPanelParticipantResource()
                .withId(expectedIds)
                .withUser(expectedUserIds)
                .withCompetition(expectedCompetitionIds)
                .withInvite(newAssessmentReviewPanelInviteResource().buildArray(2, AssessmentReviewPanelInviteResource.class))
        ...
        AssessmentReviewPanelParticipantResource first = competitionParticipants.get(0);
        ...
        AssessmentReviewPanelParticipantResource second = competitionParticipants.get(1);
