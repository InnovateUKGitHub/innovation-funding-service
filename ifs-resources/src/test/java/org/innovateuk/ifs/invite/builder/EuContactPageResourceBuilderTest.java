...
public class EuContactPageResourceBuilderTest {
    ...
    public void buildOne() {
        EuContactPageResource resource = newEuContactPageResource()
    ...
    public void buildMany() {
        List<EuContactPageResource> resources = newEuContactPageResource()
