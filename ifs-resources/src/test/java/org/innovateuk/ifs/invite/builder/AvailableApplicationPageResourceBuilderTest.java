...
public class AvailableApplicationPageResourceBuilderTest {
    ...
    public void buildOne() throws Exception {
        AvailableApplicationPageResource resource = newAvailableApplicationPageResource()
    ...
    public void buildMany() throws Exception {
        List<AvailableApplicationPageResource> resources = newAvailableApplicationPageResource()
