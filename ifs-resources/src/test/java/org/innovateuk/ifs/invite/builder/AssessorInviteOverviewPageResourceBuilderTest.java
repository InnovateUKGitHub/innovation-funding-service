...
public class AssessorInviteOverviewPageResourceBuilderTest {
    ...
    public void buildOne() throws Exception {
        AssessorInviteOverviewPageResource resource = newAssessorInviteOverviewPageResource()
    ...
    public void buildMany() throws Exception {
        List<AssessorInviteOverviewPageResource> resources = newAssessorInviteOverviewPageResource()
