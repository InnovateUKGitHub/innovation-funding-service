...
public class AccUserRegistrationResource {
    private final String firstName;
    private final String lastName;
    private final String phoneNumber;
    private final String password;

    public AccUserRegistrationResource() {
        firstName = null;
        lastName = null;
        phoneNumber = null;
        password = null;
    ...
    public AccUserRegistrationResource(String firstName, String lastName, String phoneNumber, String password) {
    ...
    public boolean equals(Object o) {
        ...
        AccUserRegistrationResource that = (AccUserRegistrationResource) o;
