...
public class AvailableAssessorResource extends AssessorInviteResource {
    ...
    public AvailableAssessorResource(String name, Set<InnovationAreaResource> innovationAreas, boolean compliant, String email, BusinessType businessType, boolean added) {
