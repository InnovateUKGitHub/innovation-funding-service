...
/**
 * DTO for {@link org.innovateuk.ifs.invite.domain.AssessmentReviewPanelParticipants}s.
 */
public class AssessmentReviewPanelParticipantResource {

    private Long id;
    private Long competitionId;
    private Long userId;
    private AssessmentReviewPanelInviteResource invite;
    ...
    public AssessmentReviewPanelInviteResource getInvite() {
        return invite;
    }

    public void setInvite(AssessmentReviewPanelInviteResource invite) {
        this.invite = invite;
    }
    ...
    public boolean equals(Object o) {
        ...
        AssessmentReviewPanelParticipantResource that = (AssessmentReviewPanelParticipantResource) o;
