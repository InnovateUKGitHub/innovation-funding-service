...
/**
 * DTO for {@link org.innovateuk.ifs.invite.domain.competition.ReviewParticipant}s.
 */
public class ReviewParticipantResource {

    private Long id;
    private Long competitionId;
    private Long userId;
    private ReviewInviteResource invite;
    ...
    public ReviewInviteResource getInvite() {
        return invite;
    }

    public void setInvite(ReviewInviteResource invite) {
        this.invite = invite;
    }
    ...
    public boolean equals(Object o) {
        ...
        ReviewParticipantResource that = (ReviewParticipantResource) o;
