...
public abstract class BaseOtherFunding extends AbstractFinanceRowItem{
    ...
    private BaseOtherFunding() {
        this(null);
    }

    public BaseOtherFunding(Long targetId) {
        super(targetId);
    }

    public BaseOtherFunding(Long id, String otherPublicFunding, String fundingSource, String securedDate, BigDecimal fundingAmount, Long targetId) {
        this(targetId);
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        BaseOtherFunding that = (BaseOtherFunding) o;
