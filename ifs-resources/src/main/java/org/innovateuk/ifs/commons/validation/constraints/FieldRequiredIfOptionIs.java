...
import org.innovateuk.ifs.commons.validation.FieldRequiredIfOptionIsValidator;
...
@Constraint(validatedBy = FieldRequiredIfOptionIsValidator.class)
@Repeatable(FieldRequiredIfOptionIsContainer.class)
public @interface FieldRequiredIfOptionIs {
    String message() default "{constraints.fieldrequiredifOptionIs}";
