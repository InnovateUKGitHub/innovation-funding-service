...
import org.innovateuk.ifs.commons.validation.ValidAggregatedDateOrEmptyValidator;
...
@Constraint(validatedBy = ValidAggregatedDateOrEmptyValidator.class)
@Repeatable(ValidAggregatedDateOrEmptyContainer.class)
public @interface ValidAggregatedDateOrEmpty {
