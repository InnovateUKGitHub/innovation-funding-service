...
public enum CompetitionSetupSection {
    ...
    APPLICATION_SUBMISSION(15L, "application-submission", "Milestones", emptyList(), false, Optional.of(MILESTONES)),
    MILESTONES(5L, "milestones", "Milestones", emptyList(), true, Optional.empty()),
