...
public enum CompetitionSetupSection {
    ...
    APPLICATION_SUBMISSION(15L, "application-submission", "Milestones", emptyList(), false, Optional.of(COMPLETION_STAGE)),
    MILESTONES(5L, "milestones", "Milestones", emptyList(), true, Optional.of(APPLICATION_SUBMISSION)),
