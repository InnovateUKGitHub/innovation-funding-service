...
then
    rm /tmp/openshift-local-run.jtl
    jmeter -n -l /tmp/openshift-local-run.jtl -Jinvite_user=0 -Japplicant_users=600 -Jregistration_users=0 -popenshift-local.properties -tload_test_representative.jmx
else
