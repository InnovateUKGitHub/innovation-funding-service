...
then
    jmeter -Jinvite_user=1 -Japplicant_users=10 -Jregistration_users=1 -Jfront_door_users=10 -Jcompetition_management_users=10 -puat.properties -tload_test_representative.jmx
else
