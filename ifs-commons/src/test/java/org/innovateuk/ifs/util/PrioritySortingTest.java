...
//        List<OrganisationResource> orgs = OrganisationResourceBuilder.newOrganisationResource().withName("C", "A", "exceptionElement").build(3);
//        List<OrganisationResource> list = new PrioritySorting<>(orgs, OrganisationResourceBuilder.newOrganisationResource()
//                .withName("exceptionElement").build(), OrganisationResource::getName).unwrap();
//        assertTrue(list.size() == 3);
//        Assert.assertEquals(CollectionFunctions.simpleMap(list, OrganisationResource::getName),
//                CollectionFunctions.simpleMap(OrganisationResourceBuilder.newOrganisationResource().withName("exceptionElement", "A", "C")
...
//        assertTrue(list.size() == 3);
//        Assert.assertEquals(CollectionFunctions.simpleMap(list, OrganisationResource::getName),
//                CollectionFunctions.simpleMap(OrganisationResourceBuilder.newOrganisationResource().withName("A", "C", "exceptionElement")
//                        .build(3), OrganisationResource::getName));
//    }
