...
public class ProjectFinanceChangesViewModel {
    ...
    private boolean orgPresentInApplication;
    ...
    public ProjectFinanceChangesViewModel(boolean isInternal, String organisationName, Long organisationId,
                                          ...
                                          boolean orgPresentInApplication,
        ...
        this.orgPresentInApplication = orgPresentInApplication;
    ...
    public boolean hasChanges() {
        ...
        if (financeSummary != null && financeSummary.hasChanges()) {
            return true;
        }
    ...
    public boolean showChanges() {
        if (isInternal) {
            return orgPresentInApplication;
        }
        return orgPresentInApplication && hasChanges();
    }
}
