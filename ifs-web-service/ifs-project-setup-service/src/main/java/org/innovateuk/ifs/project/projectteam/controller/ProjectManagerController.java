...
public class ProjectManagerController {
    ...
    private void populateProjectManagerModel(Model model, final long projectId, final List<ProjectUserResource> leadOrgPartners) {
        ...
        ProjectManagerViewModel viewModel = new ProjectManagerViewModel(leadOrgPartners, projectResource.getId(), projectResource.getName(), competition.isLoan(), competition.isKtp(), competition.isHorizonEuropeGuarantee());
