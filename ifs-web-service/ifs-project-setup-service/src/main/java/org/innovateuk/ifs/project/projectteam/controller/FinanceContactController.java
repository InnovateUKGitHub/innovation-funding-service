...
public class FinanceContactController {
    ...
    private String doViewFinanceContact(Model model, long projectId, long organisationId, UserResource loggedInUser, FinanceContactForm form) {
        ...
        FinanceContactViewModel viewModel = new FinanceContactViewModel(organisationProjectUsers, projectId, projectResource.getName(), competition.isLoan(), competition.isKtp(), competition.isHorizonEuropeGuarantee());
