...
public class ProjectFinanceChecksOverviewController {
    ...
    @GetMapping
    public String viewOverview(Model model, @PathVariable("projectId") final Long projectId, @ModelAttribute(name = "loggedInUser", binding = false) UserResource loggedInUser) {
