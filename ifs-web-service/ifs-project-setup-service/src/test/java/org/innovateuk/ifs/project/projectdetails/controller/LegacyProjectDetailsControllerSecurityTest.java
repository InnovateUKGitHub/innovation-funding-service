...
public class LegacyProjectDetailsControllerSecurityTest extends BaseProjectSetupControllerSecurityTest<LegacyProjectDetailsController> {
    ...
    @Override
    protected Class<? extends LegacyProjectDetailsController> getClassUnderTest() {
        return LegacyProjectDetailsController.class;
    }
