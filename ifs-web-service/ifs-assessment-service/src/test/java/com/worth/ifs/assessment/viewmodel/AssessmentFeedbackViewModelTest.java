...
public class AssessmentFeedbackViewModelTest {
    ...
    public void getAppendixFileDescription() throws Exception {
        ...
        final AssessmentFeedbackViewModel assessmentFeedbackViewModel = new AssessmentFeedbackViewModel(0L, 0L, null, null, null, null, questionShortName, null, null, false, false, false, false, null, null);
