 ...
 */
public class AssessmentFeedbackNavigationViewModel extends BaseAssessmentFeedbackViewModel {

    private final long assessmentId;
    private final Optional<QuestionResource> previousQuestion;
    private final Optional<QuestionResource> nextQuestion;

    public AssessmentFeedbackNavigationViewModel(long assessmentId, Optional<QuestionResource> previousQuestion, Optional<QuestionResource> nextQuestion) {
    ...
    public boolean equals(Object o) {
        ...
        AssessmentFeedbackNavigationViewModel that = (AssessmentFeedbackNavigationViewModel) o;
