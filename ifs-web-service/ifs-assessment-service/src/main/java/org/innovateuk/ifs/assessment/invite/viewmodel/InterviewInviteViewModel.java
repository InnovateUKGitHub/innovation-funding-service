...
public class InterviewInviteViewModel extends BaseInviteViewModel {
    ...
    public InterviewInviteViewModel(String interviewInviteHash, InterviewInviteResource invite, boolean userLoggedIn) {
        super(interviewInviteHash, invite.getCompetitionId(), invite.getCompetitionName(), userLoggedIn);
        this.interviewDate = invite.getInterviewDate();
    }

    public String getInterviewInviteHash() {
