...
public class AssessorDashboardModelPopulator {
    ...
    public AssessorDashboardViewModel populateModel(Long userId) {
        ...
        List<AssessmentReviewPanelParticipantResource> assessmentReviewPanelParticipantResourceList = assessmentPanelInviteRestService.getAllInvitesByUser(userId).getSuccessObject();
