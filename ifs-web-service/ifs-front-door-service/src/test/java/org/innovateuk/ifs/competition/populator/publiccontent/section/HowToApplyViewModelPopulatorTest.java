...
public class HowToApplyViewModelPopulatorTest {

    @InjectMocks
    private HowToApplyViewModelPopulator populator;
    ...
    @Test
    public void getType() {
        assertEquals(PublicContentSectionType.HOW_TO_APPLY, populator.getType());
    }
}
