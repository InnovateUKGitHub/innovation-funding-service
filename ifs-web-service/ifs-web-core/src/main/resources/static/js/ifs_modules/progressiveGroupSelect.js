...
IFS.core.progressiveGroupSelect = (function () {
  ...
  return {
    ...
    createParentSelect: function (el) {
      ...
      var parentSelect = jQuery('<select class="govuk-select width-full js-progressive-group-select" aria-label="' + parentSelectTitle + '" id="' + parentSelectId + '" required="required" data-required-errormessage="' + parentSelectErrorMessage + '"><option value="">' + parentSelectInstruction + '</option></select>')
