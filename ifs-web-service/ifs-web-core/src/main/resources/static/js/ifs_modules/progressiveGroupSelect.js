  ...
  return {
    ...
    createParentSelect: function (el) {
      ...
      var parentSelectId = el.attr('data-progressive-group-select-id')
	    var parentSelectErrorMessage = el.attr('data-progressive-group-select-id')
      var parentSelect = jQuery('<select class="form-control width-full js-progressive-group-select" aria-label="' + parentSelectTitle + '" id="' + parentSelectId + '" required="required" data-errormessage="' + parentSelectErrorMessage + '"><option value="">' + parentSelectInstruction + '</option></select>')
