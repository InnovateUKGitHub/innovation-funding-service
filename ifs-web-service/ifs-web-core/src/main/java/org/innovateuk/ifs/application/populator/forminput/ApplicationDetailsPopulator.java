...
/**
 * Populator for application details form inputs.
 */
@Component
public class ApplicationDetailsPopulator extends AbstractFormInputPopulator<ApplicationDetailsInputViewModel> {
