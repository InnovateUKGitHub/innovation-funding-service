 ...
 */
public class RegisteredAsyncFutureDetails {

    private CompletableFuture<?> future;
    private String futureName;
    private AsyncFutureDetails parentFutureDetails;

    public RegisteredAsyncFutureDetails(CompletableFuture<?> future, String futureName, AsyncFutureDetails asyncFutureDetails) {
        this.future = future;
