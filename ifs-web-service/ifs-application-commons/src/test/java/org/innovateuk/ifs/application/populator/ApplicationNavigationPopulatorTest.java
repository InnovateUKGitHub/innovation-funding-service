...
public class ApplicationNavigationPopulatorTest {
    ...
    public void testAddAppropriateBackURLToModelWithoutSection(){
        ...
        target.addAppropriateBackURLToModel(applicationId, model, null, Optional.empty(), Optional.empty());
    ...
    public void testAddAppropriateBackURLToModelWithFinanceSubSection(){
        ...
        target.addAppropriateBackURLToModel(applicationId, model, section, Optional.empty(), Optional.empty());
    ...
    public void testAddAppropriateBackURLToModelWithApplicantOrganisation(){
        ...
        target.addAppropriateBackURLToModel(applicationId, model, section, Optional.of(22L), Optional.empty());
