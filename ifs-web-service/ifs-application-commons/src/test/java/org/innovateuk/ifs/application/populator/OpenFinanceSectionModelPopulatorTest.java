...
public class OpenFinanceSectionModelPopulatorTest extends BaseUnitTest {
    ...
    private void setupServices(CompetitionResource competitionResource, ApplicationResource applicationResource, UserResource userResource, List<FormInputResource> formInputs) {
        ...
        when(userService.getLeadApplicantProcessRole(applicationResource.getId())).thenReturn(leadApplicantProcessRole);
        ...
        when(financeViewHandlerProvider.getFinanceModelManager(competitionResource, OrganisationTypeEnum.BUSINESS.getId())).thenReturn(financeManager);
