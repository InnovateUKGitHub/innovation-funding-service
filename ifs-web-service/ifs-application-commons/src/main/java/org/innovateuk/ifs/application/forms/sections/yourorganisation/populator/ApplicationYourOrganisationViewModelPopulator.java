...
public class ApplicationYourOrganisationViewModelPopulator {
    ...
    public YourOrganisationViewModel populate(long applicationId, long competitionId, long organisationId) {
        ...
        return new YourOrganisationViewModel(applicationId, competitionId, competition.getName(), showAidAgreement, showOrganisationSizeAlert, competition.isH2020(), competition.isProcurement());
    }
}
