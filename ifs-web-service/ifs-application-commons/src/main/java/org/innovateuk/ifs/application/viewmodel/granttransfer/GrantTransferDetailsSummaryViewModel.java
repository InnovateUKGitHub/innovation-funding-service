...
public class GrantTransferDetailsSummaryViewModel extends AbstractLeadOnlyViewModel {
    ...
    public GrantTransferDetailsSummaryViewModel(Long questionId, Long applicationId, Long competitionId, String competitionName, boolean closed, boolean complete, boolean canMarkAsComplete, boolean allReadOnly) {
        this(questionId, applicationId, competitionId, competitionName, closed, complete, canMarkAsComplete, allReadOnly, null, null, null, null, null, null, null, null);
    }

    public GrantTransferDetailsSummaryViewModel(Long questionId, Long applicationId, Long competitionId, String competitionName, boolean closed, boolean complete, boolean canMarkAsComplete, boolean allReadOnly, String grantAgreementNumber, String participantId, String projectName, LocalDate startDate, LocalDate endDate, BigDecimal fundingContribution, Boolean projectCoordinator, EuActionTypeResource actionType) {
        super(questionId, applicationId, competitionId, competitionName, closed, complete, canMarkAsComplete, allReadOnly);
