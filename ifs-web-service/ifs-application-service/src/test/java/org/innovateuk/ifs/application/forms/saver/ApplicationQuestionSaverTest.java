 ...
 */
@Service
public class ApplicationQuestionSaverTest extends AbstractApplicationSaver {

    private static final Log LOG = LogFactory.getLog(ApplicationQuestionSaverTest.class);
