...
public class HorizonEuropeGuaranteeCostsSaverTest {
    ...
    public void save() {
        PersonnelCost workingDays = newPersonnelCost()
                ...
                .withLabourDays(1)
                .build();
        HecpIndirectCosts indirectCost = newHecpIndirectCosts()
        ...
        ApplicationFinanceResource finance = newApplicationFinanceResource().withFinanceOrganisationDetails(asMap(
                ...
                FinanceRowType.HECP_INDIRECT_COSTS, newHecpIndirectCostsCostCategory().withCosts(singletonList(indirectCost)).build(),
        ...
        verify(financeRowRestService).update(indirectCost);
        ...
        assertEquals(newPersonnelCost.getTotal(workingDays.getLabourDays()).toBigInteger().longValue(), 1L);
        assertEquals(HORIZON_EUROPE_GUARANTEE_TOTAL, indirectCost.getRateType());
        assertEquals(indirectCost.getRate(), (Integer) 2);
    ...
    public void save_zeros() {
        ...
        HecpIndirectCosts indirect = newHecpIndirectCosts()
        ...
        ApplicationFinanceResource finance = newApplicationFinanceResource().withFinanceOrganisationDetails(asMap(
                ...
                FinanceRowType.HECP_INDIRECT_COSTS, newHecpIndirectCostsCostCategory().withCosts(singletonList(indirect)).build(),
        ...
        verify(financeRowRestService).update(workingDays);
        verify(financeRowRestService).update(indirect);
