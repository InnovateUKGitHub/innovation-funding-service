...
public class ApplicationServiceSecurityAnnotationsTest extends AbstractServiceSecurityAnnotationsTest {
    ...
    protected List<Class<?>> excludedClasses() {
        return asList(BenchmarkController.class, IfsErrorController.class);
    }
}
