...
public class QuestionViewModel extends AbstractApplicationFormViewModel<ApplicantQuestionResource> {
    ...
    public QuestionViewModel(ApplicantQuestionResource applicantResource, List<AbstractFormInputViewModel> formInputViewModels, NavigationViewModel navigationViewModel, boolean allReadOnly, Optional<Long> applicantOrganisationId) {
