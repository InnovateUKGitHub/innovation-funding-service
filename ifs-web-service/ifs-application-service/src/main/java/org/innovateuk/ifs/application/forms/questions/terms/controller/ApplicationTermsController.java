...
@PreAuthorize("hasAnyAuthority('applicant', 'project_finance', 'ifs_administrator', 'comp_admin', 'support', 'innovation_lead', 'monitoring_officer', 'knowledge_transfer_adviser', 'assessor', 'stakeholder', 'external_finance', 'supporter')")
