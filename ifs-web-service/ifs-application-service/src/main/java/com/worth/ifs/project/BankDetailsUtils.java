...
class BankDetailsUtils {
    static RestResult<BankDetailsResource> getBankDetails(Long projectId, Long organisationId, BankDetailsRestService bankDetailsRestService) {
