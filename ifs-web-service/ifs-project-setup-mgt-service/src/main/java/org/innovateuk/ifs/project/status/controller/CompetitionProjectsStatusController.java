...
public class CompetitionProjectsStatusController {
    ...
    public String viewCompetitionStatus(Model model, @ModelAttribute(name = "loggedInUser", binding = false) UserResource loggedInUser,
    ...
    public void exportBankDetails(Model model, @ModelAttribute(name = "loggedInUser", binding = false) UserResource loggedInUser,
