 ...
 */
@ZeroDowntime(reference = "IFS-2579", description = "Rename in Sprint 19 to GrantOfferLetterModel")
public class GrantOfferLetterModelImproved {
    ...
    public GrantOfferLetterModelImproved(CompetitionSummaryResource competitionSummary,
    ...
    public boolean equals(Object o) {
        ...
        GrantOfferLetterModelImproved that = (GrantOfferLetterModelImproved) o;
