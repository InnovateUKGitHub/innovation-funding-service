...
public class EditOrganisationDetailsWithGrowthTableControllerTest extends BaseControllerMockMVCTest<EditOrganisationDetailsWithGrowthTableController> {
    ...
    private static PublicContentItemResource publicContentItemResource;
    private static final String VIEW_WITH_GROWTH_TABLE_PAGE = "project/organisationdetails/edit-organisation-size";

    @Override
    protected EditOrganisationDetailsWithGrowthTableController supplyControllerUnderTest() {
        return new EditOrganisationDetailsWithGrowthTableController();
    }
