...
public class OrganisationDetailsKtpFinancialYearsControllerTest extends BaseControllerMockMVCTest<OrganisationDetailsKtpFinancialYearsController> {
    ...
    public void setup() {
        ...
        when(partnerOrganisationRestService.getProjectPartnerOrganisations(projectId)).thenReturn(new RestResult(restSuccess(List.of(new PartnerOrganisationResource()))));
