...
public class FinanceChecksQueriesAddResponseControllerSecurityTest extends BaseProjectSetupControllerSecurityTest<FinanceChecksQueriesAddResponseController> {

    @Override
    protected Class<? extends FinanceChecksQueriesAddResponseController> getClassUnderTest() {
        return FinanceChecksQueriesAddResponseController.class;
    }
    ...
    public void testCancelNewForm() {
        ...
        assertSecured(() -> classUnderTest.cancelNewForm(1L, 2L, 3L, "", null, null, null));
        ...
        nonFinanceTeamRoles.forEach(role -> {
            ...
            try {
                classUnderTest.cancelNewForm(1L, 2L, 3L, "", null, null, null);
    ...
    public void testDownloadAttachment() {
        setLoggedInUser(newUserResource().withRolesGlobal(singletonList(newRoleResource().withType(PROJECT_FINANCE).build())).build());
        assertSecured(() -> classUnderTest.downloadAttachment(1L, 2L, 3L, 4L, null, null));
        ...
        nonFinanceTeamRoles.forEach(role -> {
            ...
            setLoggedInUser(
                    newUserResource().withRolesGlobal(singletonList(newRoleResource().withType(role).build())).build());
            try {
                classUnderTest.downloadAttachment(1L, 2L, 3L, 4L, null, null);
    ...
    public void testSaveResponse() {
        setLoggedInUser(newUserResource().withRolesGlobal(singletonList(newRoleResource().withType(PROJECT_FINANCE).build())).build());
        assertSecured(() -> classUnderTest.saveResponse(null, 1L, 2L, 3L, "", null, null, null, null, null));
        ...
        nonFinanceTeamRoles.forEach(role -> {
            ...
            setLoggedInUser(
                    newUserResource().withRolesGlobal(singletonList(newRoleResource().withType(role).build())).build());
            try {
                classUnderTest.saveResponse(null, 1L, 2L, 3L, "", null, null, null, null, null);
