...
public class ProjectFinanceFundingLevelControllerTest extends BaseControllerMockMVCTest<ProjectFinanceFundingLevelController> {
    ...
    public void viewFundingLevels() throws Exception {
        ...
        assertEquals(totalGrant.setScale(2, RoundingMode.HALF_UP), viewModel.getTotalFundingSought());
        ...
        assertEquals(industrialFinances.getTotalFundingSought().setScale(2, RoundingMode.HALF_UP), industrialViewModel.getFundingSought());
