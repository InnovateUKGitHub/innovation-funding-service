...
public class ProjectFinanceFundingLevelControllerTest extends BaseControllerMockMVCTest<ProjectFinanceFundingLevelController> {
    ...
    public void viewFundingLevels() throws Exception {
        ...
        assertEquals(totalGrant.setScale(0, RoundingMode.HALF_UP), viewModel.getTotalFundingSought());
        ...
        assertEquals(new BigDecimal("85.87"), industrialViewModel.getPercentageOfTotalGrant().setScale(MAX_DECIMAL_PLACES, RoundingMode.HALF_UP));
    ...
    public void viewFundingLevels_withChangeInOrganisationSize() throws Exception {
        ...
        assertEquals(industrialFinances.getTotal(), industrialViewModel.getCosts());
        assertEquals(industrialFinances.getTotalFundingSought().setScale(0, RoundingMode.HALF_UP), industrialViewModel.getFundingSought());
        assertEquals(new BigDecimal("85.87"), industrialViewModel.getPercentageOfTotalGrant().setScale(2, RoundingMode.HALF_UP));
        assertEquals(BigDecimal.ZERO, industrialViewModel.getOtherFunding());
        assertEquals(totalGrant, industrialViewModel.getTotalGrant());
