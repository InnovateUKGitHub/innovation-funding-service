...
html
  ...
  body
    header.navbar.navbar-static-top.bs-docs-nav#top(role='banner')
      .container
        .navbar-header
          ...
          .col-md-9(role='main')
             each section, i in sections
              .bs-docs-section
                !{section.docs}
          .col-md-3
            .bs-docs-sidebar.hidden-print(role='complementary')
              ul.nav.bs-docs-sidenav
              a.back-to-top(href="#top") Back to top
    footer.bs-docs-footer(role="contentinfo")
      .container
        a(href="http://www.worth.systems")
          img(src="./images/worth-logo.png",alt="Worth Systems")
        p &copy; #{project.name}
        .bar.bottom
          .settings.container(hidden)
            ...
            button.random(title="Random size",data-width="auto") Random
