...
public class AllocateCofundersController {
    ...
    @GetMapping
    public String allocation(@PathVariable("competitionId") long competitionId, Model model) {

        AllocateCofundersViewModel allocateCofundersViewModel = allocateCofundersViewModelPopulator.populateModel(competitionId);
