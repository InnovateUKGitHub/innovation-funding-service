...
import org.innovateuk.ifs.management.assessor.viewmodel.AssessorsProfileDOIViewModel;
 ...
 */
@Component
public class AssessorProfileDOIModelPopulator {

    private AffiliationRestService affiliationRestService;
    private CompetitionService competitionService;
    private AssessorRestService assessorRestService;

    public AssessorProfileDOIModelPopulator(AffiliationRestService affiliationRestService,
    ...
    public AssessorsProfileDOIViewModel populateModel(long assessorId, long competitionId, String originQuery) {
        ...
        return new AssessorsProfileDOIViewModel(
                competition,
                assessorId,
