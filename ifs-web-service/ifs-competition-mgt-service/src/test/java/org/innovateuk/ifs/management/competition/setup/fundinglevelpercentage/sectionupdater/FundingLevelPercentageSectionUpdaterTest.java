...
public class FundingLevelPercentageSectionUpdaterTest {
    ...
    public void update_table() {
        ...
        form.setMaximums(
                asList(
                        newArrayList(new FundingLevelMaximumForm(100L, matchingResearchCategory.getId(), OrganisationSize.SMALL, 10)),
                        newArrayList(new FundingLevelMaximumForm(101L, matchingResearchCategory.getId(), OrganisationSize.MEDIUM, 20)),
                        newArrayList(new FundingLevelMaximumForm(102L, matchingResearchCategory.getId(), OrganisationSize.LARGE, 30))
                )
        );
