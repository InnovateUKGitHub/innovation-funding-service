...
public class MenuModelPopulatorTest {
	...
	private GeneralSetupViewModel getBasicGeneralSetupView(CompetitionResource competition) {
	    return new GeneralSetupViewModel(Boolean.FALSE, false, competition, CompetitionSetupSection.HOME, CompetitionSetupSection.values(), Boolean.TRUE, Boolean.FALSE, true, true, true);
    }
}
