...
public class OrganisationalEligibilityViewModelPopulatorTest {
    ...
    public void populateModel() {
        ...
        GeneralSetupViewModel generalSetupViewModel = new GeneralSetupViewModel(true, false, competition, ORGANISATIONAL_ELIGIBILITY, CompetitionSetupSection.values(), true, false, true);
