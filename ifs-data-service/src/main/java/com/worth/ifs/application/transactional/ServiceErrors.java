...
public class ServiceErrors {
    ...
    public enum FailureKeys implements ErrorTemplate {

        //
        // General
        //
        GENERAL_UNEXPECTED_ERROR("An unexpected error occurred", INTERNAL_SERVER_ERROR), //
        GENERAL_NOT_FOUND_ENTITY("Unable to find entity", NOT_FOUND), //
        ...
        FailureKeys(String errorMessage, HttpStatus category) {
