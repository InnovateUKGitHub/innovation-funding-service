...
public interface ApplicationSummaryService {
	...
	@SecuredBySpring(value = "READ", description = "Comp Admins can see all com.worth.ifs.Application Summaries across the whole system", securedType = ApplicationSummaryPageResource.class)
	...
	@PreAuthorize("hasAuthority('comp_admin') || hasAuthority('project_finance')")
	@SecuredBySpring(value = "READ", description = "Comp Admins can see all submitted com.worth.ifs.Application Summaries across the whole system", securedType = ApplicationSummaryPageResource.class)
	...
	@PreAuthorize("hasAuthority('comp_admin') || hasAuthority('project_finance')")
    @SecuredBySpring(value = "READ", description = "Comp Admins can see all not-yet submitted com.worth.ifs.Application Summaries across the whole system", securedType = ApplicationSummaryPageResource.class)
	...
	@PreAuthorize("hasAuthority('comp_admin') || hasAuthority('project_finance')")
    @SecuredBySpring(value = "READ", description = "Comp Admins can see all com.worth.ifs.Application Summaries requiring feedback across the whole system", securedType = ApplicationSummaryPageResource.class)
