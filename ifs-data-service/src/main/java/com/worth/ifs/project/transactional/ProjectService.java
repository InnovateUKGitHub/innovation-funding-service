...
public interface ProjectService {
    ...
    @PreAuthorize("hasPermission(#projectId, 'com.worth.ifs.project.resource.ProjectResource', 'VIEW_STATUS')")
    ServiceResult<ProjectStatusResource> getProjectStatus(Long projectId);
}
