...
public class InviteProjectResource {
    ...
    public InviteProjectResource(Long id, Long user, String name, String email, Long project, Long organisation, Long applicationId, String hash, InviteStatus status) {
        this.id = id;
        this.user = user;
        this.name = name;
        this.email = email;
