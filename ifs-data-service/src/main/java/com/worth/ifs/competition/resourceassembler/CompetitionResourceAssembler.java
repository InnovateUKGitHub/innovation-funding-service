...
@Service
public class CompetitionResourceAssembler extends ResourceAssemblerSupport<Competition, CompetitionResource> {
    ...
    @Override
    public CompetitionResource toResource(Competition entity) {
        final CompetitionResource resource = createResourceWithId(entity.getId(), entity);
    ...
    @Override
    protected CompetitionResource instantiateResource(Competition competition) {
        return new CompetitionResource(competition.getId(),
