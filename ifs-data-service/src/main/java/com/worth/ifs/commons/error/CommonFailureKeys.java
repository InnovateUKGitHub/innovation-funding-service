...
public enum CommonFailureKeys implements ErrorTemplate {
    ...
    ASSESSMENT_FORM_INPUT_RESPONSE_WORD_LIMIT_EXCEEDED(BAD_REQUEST),
    ASSESSMENT_SUMMARY_FEEDBACK_WORD_LIMIT_EXCEEDED(BAD_REQUEST),
    ASSESSMENT_SUMMARY_COMMENT_WORD_LIMIT_EXCEEDED(BAD_REQUEST),
