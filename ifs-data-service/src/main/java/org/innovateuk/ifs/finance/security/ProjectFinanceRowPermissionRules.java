...
//        return (isOrganisationProjectFinanceContact(organisation, user) || isCompAdmin(user) || isProjectFinanceUser(user));
//    }
//
//     static boolean isOrganisationProjectFinanceContact(OrganisationResource organisation, UserResource user) {
