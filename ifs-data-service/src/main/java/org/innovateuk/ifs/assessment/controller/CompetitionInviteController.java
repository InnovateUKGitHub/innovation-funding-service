...
public class CompetitionInviteController {
    ...
    public RestResult<AssessorInviteToSendResource> sendInvite(@PathVariable long inviteId) {
        return competitionInviteService.sendInvite(inviteId).toPostWithBodyResponse();
    }
}
