...
INSERT INTO `process` (`event`, `last_modified`, `process_type`, `target_id`, `participant_id`, `activity_state_id`) VALUES ('accept','2016-07-14 11:00:59','Assessment',@jugglingisveryfunapplicationid,@paulplumjugglingisveryfunparticipantid,@acceptedactivitystateid);
INSERT INTO `process` (`event`, `last_modified`, `process_type`, `target_id`, `participant_id`, `activity_state_id`) VALUES ('accept','2016-07-14 10:24:11','Assessment',@jugglingisnotfunapplicationid,@paulplumjugglingisnotfunparticipantid,@acceptedactivitystateid);
INSERT INTO `process` (`event`, `last_modified`, `process_type`, `target_id`, `participant_id`, `activity_state_id`) VALUES ('accept','2016-07-15 17:21:09','Assessment',@jugglingisveryfunapplicationid,@felixwilsonjugglingisveryfunparticipantid,@acceptedactivitystateid);
INSERT INTO `process` (`event`, `last_modified`, `process_type`, `target_id`, `participant_id`, `activity_state_id`) VALUES ('accept','2016-07-14 12:58:12','Assessment',@jugglingisnotfunapplicationid,@felixwilsonjugglingisnotfunparticipantid,@acceptedactivitystateid);