...
INSERT  IGNORE INTO `section` (`id`, `assessor_guidance_description`, `description`, `display_in_assessment_application_summary`, `name`, `priority`, `competition_id`, `parent_section_id`, `question_group`, `section_type`) VALUES (17,NULL,'Each partner must submit their finances','\0','Finances',2,2,NULL,0,'EACH_COLLABORATOR_FINANCE');
...
INSERT  IGNORE INTO `section` (`id`, `assessor_guidance_description`, `description`, `display_in_assessment_application_summary`, `name`, `priority`, `competition_id`, `parent_section_id`, `question_group`, `section_type`) VALUES (28,NULL,'Each partner must submit their finances','\0','Finances',2,3,NULL,0,'EACH_COLLABORATOR_FINANCE');
...
INSERT  IGNORE INTO `section` (`id`, `assessor_guidance_description`, `description`, `display_in_assessment_application_summary`, `name`, `priority`, `competition_id`, `parent_section_id`, `question_group`, `section_type`) VALUES (39,NULL,'Each partner must submit their finances','\0','Finances',2,4,NULL,0,'EACH_COLLABORATOR_FINANCE');
