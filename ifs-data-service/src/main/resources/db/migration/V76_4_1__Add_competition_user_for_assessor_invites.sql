...
CREATE TABLE competition_user (
  ...
  user_id bigint(20),
  invite_id bigint(20),
  competition_user_status_id bigint(20),
  ...
  CONSTRAINT competition_user_to_competition_user_status_fk FOREIGN KEY (competition_user_status_id) REFERENCES competition_user_status(id),
