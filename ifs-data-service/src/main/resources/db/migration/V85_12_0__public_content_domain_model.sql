...
CREATE TABLE `content` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_content_section_to_content_section` (`content_section_id`),
  KEY `FK_content_section_to_file_entry` (`file_entry_id`),
  CONSTRAINT `FK_content_section_to_content_section` FOREIGN KEY (`content_section_id`) REFERENCES `content_section` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
