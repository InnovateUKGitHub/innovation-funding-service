CREATE TABLE `competition_type_assessor_option` (
  ...
  `assessor_option_value` int(4) NOT NULL COMMENT 'Assessor option value to be used for any business logic.',
...
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='Table to store the options for the assessor that are used for various competition types.';
