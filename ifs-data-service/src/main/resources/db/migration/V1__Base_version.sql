...
CREATE TABLE `assessment` (
  ...
  `temp_total_score` double DEFAULT NULL,
  `temp_recommended_value` varchar(255) DEFAULT NULL,
  `submitted` char(1) DEFAULT NULL,
  `recommendation_feedback` varchar(255) DEFAULT NULL,
  `process_id` bigint(20) NOT NULL,
  `application` bigint(20) DEFAULT NULL,
  `assessor` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`process_id`),
  UNIQUE KEY `UK_askgolnqedh54ohsowrokj60w` (`assessor`,`application`),
  KEY `FK_r35qmg4sdcabo2d5edqyxhjlh` (`application`),
  CONSTRAINT `FK_jkjk18y9q6mc4bt4uk4dvo485` FOREIGN KEY (`assessor`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_r35qmg4sdcabo2d5edqyxhjlh` FOREIGN KEY (`application`) REFERENCES `application` (`id`),
  CONSTRAINT `FK_r3msmt44r3jsubh01vx200w98` FOREIGN KEY (`process_id`) REFERENCES `process` (`id`)
) ENGINE=InnoDB ;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `question` (
  ...
  `child_question_id` bigint(20) DEFAULT NULL,
  `competition_id` bigint(20) DEFAULT NULL,
  `question_type_id` bigint(20) DEFAULT NULL,
  `section_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_l4j1k8qe6sldwi2nfd1lguwhi` (`child_question_id`),
  KEY `FK_hgdynqsaela2nuwm41nohmxg0` (`competition_id`),
  KEY `FK_sjwlpsl4l3y7jyh202b9p4rwj` (`question_type_id`),
  ...
  CONSTRAINT `FK_l4j1k8qe6sldwi2nfd1lguwhi` FOREIGN KEY (`child_question_id`) REFERENCES `question` (`id`),
  CONSTRAINT `FK_sjwlpsl4l3y7jyh202b9p4rwj` FOREIGN KEY (`question_type_id`) REFERENCES `question_type` (`id`)
...
INSERT  IGNORE INTO `question_type` (`id`, `title`) VALUES (1,'textinput'),(2,'textarea'),(3,'date'),(4,'fileupload'),(5,'application_details'),(6,'empty'),(7,'finance'),(8,'labour'),(9,'overheads'),(10,'materials'),(11,'capital_usage'),(12,'subcontracting_costs'),(13,'travel'),(14,'other_costs'),(15,'your_finance'),(16,'financial_summary'),(17,'other_funding'),(18,'percentage');
...
INSERT  IGNORE INTO `response` (`id`, `update_date`, `value`, `application_id`, `question_id`, `updated_by_id`) VALUES (1,'2015-09-18 10:33:27','Within the Industry one issue has caused progress in the field to be stifled.  Up until now any advancement has been made by working around this anomaly.  \r\n\r\nWe propose to tackle the situation head on and develop a tool that will circumvent the problem entirely allowing development to advance.\r\n',1,1,1),(4,'2015-09-18 10:35:56','Wastage in our industry can be attributed in no small part to one issue.  To date businesses have been reluctant to tackle that problem and instead worked around it.  That has stifled progress.\r\n\r\nThe end result of our project will be a novel tool to manage the issue and substantially reduce the wastage caused by it.\r\n',1,12,1),(5,'2015-09-18 10:35:16','The amount of money needed to complete this project is large.  \r\n\r\nThe academic phase will require the acquisition of several pieces of lab equipment and the employ of additional graduates to ensure the experiments run smoothly.\r\n\r\nThe Materials and use of the fabricators equipment will account for approximately some of the budget.\r\n\r\nThe time and expertise required across all 3 partners to complete each phase will amount to the lion share of the cost.\r\n',1,15,1),(6,'2015-09-18 10:35:16','Although steps are under way to get this project off the ground, investment by Innovate UK will stimulate Industry leads to supply additional resource funding and use of their facilities as required to advance the progress of this project.  \r\n\r\nUK Investment will ensure that we are able to retain the onward manufacture internally instead of needing to create international deals taking work and profit out of the country.\r\n',1,16,1),(7,'2015-09-18 10:33:27','The issue affects the entire field, the market value of which is significant, and accounts for a percentage of its annual overhead.  A tool to reduce that amount by a significant proportion would be taken up by the entire industry.  \r\n\r\nAt this time no other solutions are available or near market giving us the leading edge on market share.  \r\n\r\nManufacture and development could remain in the United Kingdom with an international export market.\r\n',1,2,1),(8,'2015-09-18 10:33:27','The planned end result of the project would be a fully implementable tool that could be rolled out to the industry. \r\n\r\n Once a fully tested prototype can be demonstrated we can start to take orders and travel to international Industry leaders the exhibit the value of the tool.\r\n',1,3,1),(9,'2015-09-18 10:33:27','The tool will give the consortium the leading edge on the technology as currently no one else is close to considering developing a solution.  \r\n\r\nThe Industry will be able to reduce wastage by a significant degree and pass those savings on to the consumer or reinvest into advancing the field.\r\n  \r\nInside 2 years it is estimated that a very large sum of money can be recouped by using our solution\r\n',1,4,1),(10,'2015-09-18 10:26:33','Our Academic partner has developed a technique to identify the precise cause of the issue and have been able to demonstrate it at a small scale.  Taking this information they will scale up the experiment to a percentage of industrial scale to confirm.  \r\n\r\nWe will take this data and engineer a solution to isolate the problem we will then collude with our fabrication partner to design and prototype a tool to correct the obstacle. \r\n',1,5,1),(11,'2015-09-18 10:26:33','The project is based on Manchester’s novel IP that, for the first time, allows SLM to be conducted without any need for anchors/supports. A search of the literature has established that the advances proposed in this project on which RAMP are based are not available via any commercially available process. In addition, the development and supply of tailored materials by Empire and a dedicated high temperature rig by Ludlow will involve further, critical degrees of innovation that will help to build a portfolio of IP to enhance commercial exploitation. NB. RAMP does not simply reduce stresses by working at higher temperatures; it involves a novel step based on manufacturing engineering and material science that completely eliminates stresses.',1,6,1),(12,'2015-09-18 10:26:33','Three principal risks exist at this stage:\r\n1.        The academic scale up fails to replicate the smaller results either entirely or not to a satisfactory level. In this event the academic partner would begin a controlled scale back to identify if the method needs to be altered during scale up to replicate results.  In the event that the issue can only be identified in the small scale we would build that into our planning for the isolation phase\r\n2.      During the phase to engineer a technique to isolate the issue we anticipate that there are inherent safety issues.  We have consulted an independent firm to ensure that suitable equipment and measures have been put in place to minimise the risk to staff.\r\n3.    Although we are confident that our fabrication partner is the best option for the prototype solution there is an indication that a particular piece of heavy machinery, currently unavailable in the UK will be required.  Our Fabrication partner has already investigated options for accessing this equipment in the Far East and an appropriate budget has been set aside to be used for this purpose if required.\r\n',1,7,1),(13,'2015-09-18 10:26:33','The team consists of:\r\nUs - We have been supplying engineering solutions to the industry for a number of years and have been principal deliverers for various advancements within the field.  We are a suitably sized team capable of developing flexible solutions to a wide variety of clients internationally.\r\n\r\nAcademic – the principal investigator and his team have been studying the issue for a number of years and have qualifications across the spectrum that apply to the field.  Together they have already identified several efficiencies that can be made within the industry.\r\n\r\nThe Fabricators – Are a leading team within complex engineering fabrication.  They have work on multiple high budget engineering solutions and consist of a team of people with many years’ experience in a range of industries\r\n',1,8,1),(15,'2015-09-18 10:35:56','The Project aims to identify, isolate and correct an issue that has hindered progress in this field for a number of years.\r\nIdentification will involve the university testing conditions to determine the exact circumstance of the Issue.\r\nOnce Identification has been assured we will work to Isolate the issue but replicating the circumstances in which it occurs within a laboratory environment.\r\nAfter this we will work with our prototyping partner to create a tool to correct the issue.  Once tested and certified this will be rolled out to mass production.\r\n',1,11,1),(16,'2015-08-08 00:00:00','file.doc',1,14,1),(17,'2015-08-08 00:00:00','file.pdf',1,17,1),(18,'2015-09-18 10:30:39','The Project aims to identify, isolate and correct an issue that has hindered progress in this field for a number of years.\r\nIdentification will involve the university testing conditions to determine the exact circumstance of the Issue.\r\nOnce Identification has been assured we will work to Isolate the issue but replicating the circumstances in which it occurs within a laboratory environment.\r\nAfter this we will work with our prototyping partner to create a tool to correct the issue.  Once tested and certified this will be rolled out to mass production.\r\n',1,13,1),(19,'2015-10-02 17:03:28','The Project aims to identify, isolate and correct an issue that has hindered progress in this field for a number of years.\r\nIdentification will involve the university testing conditions to determine the exact circumstance of the Issue.\r\nOnce Identification has been assured we will work to Isolate the issue but replicating the circumstances in which it occurs within a laboratory environment.\r\nAfter this we will work with our prototyping partner to create a tool to correct the issue.  Once tested and certified this will be rolled out to mass production.\r\n',5,11,10),(20,'2015-10-02 17:03:42','Wastage in our industry can be attributed in no small part to one issue.  To date businesses have been reluctant to tackle that problem and instead worked around it.  That has stifled progress.\r\n\r\nThe end result of our project will be a novel tool to manage the issue and substantially reduce the wastage caused by it.\r\n',5,12,10),(21,'2015-10-02 17:04:24','Within the Industry one issue has caused progress in the field to be stifled.  Up until now any advancement has been made by working around this anomaly.  \r\n\r\nWe propose to tackle the situation head on and develop a tool that will circumvent the problem entirely allowing development to advance.\r\n',5,1,10),(22,'2015-10-02 17:05:51','The issue affects the entire field, the market value of which is significant, and accounts for a percentage of its annual overhead.  A tool to reduce that amount by a significant proportion would be taken up by the entire industry.  \r\n\r\nAt this time no other solutions are available or near market giving us the leading edge on market share.  \r\n\r\nManufacture and development could remain in the United Kingdom with an international export market.\r\n',5,2,10),(23,'2015-10-02 17:06:06','The planned end result of the project would be a fully implementable tool that could be rolled out to the industry. \r\n\r\n Once a fully tested prototype can be demonstrated we can start to take orders and travel to international Industry leaders the exhibit the value of the tool.',5,3,10),(24,'2015-10-02 17:06:20','The tool will give the consortium the leading edge on the technology as currently no one else is close to considering developing a solution.  \r\n\r\nThe Industry will be able to reduce wastage by a significant degree and pass those savings on to the consumer or reinvest into advancing the field.\r\n  \r\nInside 2 years it is estimated that a very large sum of money can be recouped by using our solution\r\n',5,4,10),(25,'2015-10-02 17:04:05','The Project aims to identify, isolate and correct an issue that has hindered progress in this field for a number of years.\r\nIdentification will involve the university testing conditions to determine the exact circumstance of the Issue.\r\nOnce Identification has been assured we will work to Isolate the issue but replicating the circumstances in which it occurs within a laboratory environment.\r\nAfter this we will work with our prototyping partner to create a tool to correct the issue.  Once tested and certified this will be rolled out to mass production.',5,13,10),(26,'2015-10-02 17:06:42','Our Academic partner has developed a technique to identify the precise cause of the issue and have been able to demonstrate it at a small scale.  Taking this information they will scale up the experiment to a percentage of industrial scale to confirm.  \r\n\r\nWe will take this data and engineer a solution to isolate the problem we will then collude with our fabrication partner to design and prototype a tool to correct the obstacle. \r\n',5,5,10),(27,'2015-10-02 17:06:54','The project is based on Manchester’s novel IP that, for the first time, allows SLM to be conducted without any need for anchors/supports. A search of the literature has established that the advances proposed in this project on which RAMP are based are not available via any commercially available process. In addition, the development and supply of tailored materials by Empire and a dedicated high temperature rig by Ludlow will involve further, critical degrees of innovation that will help to build a portfolio of IP to enhance commercial exploitation. NB. RAMP does not simply reduce stresses by working at higher temperatures; it involves a novel step based on manufacturing engineering and material science that completely eliminates stresses.',5,6,10),(28,'2015-10-02 17:07:17','Three principal risks exist at this stage:\r\n1.        The academic scale up fails to replicate the smaller results either entirely or not to a satisfactory level. In this event the academic partner would begin a controlled scale back to identify if the method needs to be altered during scale up to replicate results.  In the event that the issue can only be identified in the small scale we would build that into our planning for the isolation phase\r\n2.      During the phase to engineer a technique to isolate the issue we anticipate that there are inherent safety issues.  We have consulted an independent firm to ensure that suitable equipment and measures have been put in place to minimise the risk to staff.\r\n3.    Although we are confident that our fabrication partner is the best option for the prototype solution there is an indication that a particular piece of heavy machinery, currently unavailable in the UK will be required.  Our Fabrication partner has already investigated options for accessing this equipment in the Far East and an appropriate budget has been set aside to be used for this purpose if required.\r\n',5,7,10),(29,'2015-10-02 17:07:31','The team consists of:\r\nUs - We have been supplying engineering solutions to the industry for a number of years and have been principal deliverers for various advancements within the field.  We are a suitably sized team capable of developing flexible solutions to a wide variety of clients internationally.\r\n\r\nAcademic – the principal investigator and his team have been studying the issue for a number of years and have qualifications across the spectrum that apply to the field.  Together they have already identified several efficiencies that can be made within the industry.\r\n\r\nThe Fabricators – Are a leading team within complex engineering fabrication.  They have work on multiple high budget engineering solutions and consist of a team of people with many years’ experience in a range of industries\r\n',5,8,10),(30,'2015-10-02 17:07:50','The amount of money needed to complete this project is large.  \r\n\r\nThe academic phase will require the acquisition of several pieces of lab equipment and the employ of additional graduates to ensure the experiments run smoothly.\r\n\r\nThe Materials and use of the fabricators equipment will account for approximately some of the budget.\r\n\r\nThe time and expertise required across all 3 partners to complete each phase will amount to the lion share of the cost.\r\n',5,15,10),(31,'2015-10-02 17:08:03','Although steps are under way to get this project off the ground, investment by Innovate UK will stimulate Industry leads to supply additional resource funding and use of their facilities as required to advance the progress of this project.  \r\n\r\nUK Investment will ensure that we are able to retain the onward manufacture internally instead of needing to create international deals taking work and profit out of the country.\r\n',5,16,10),(32,'2015-10-02 17:08:03','score',5,14,10),(33,'2015-10-02 17:08:03','score',5,17,10),(34,'2015-10-02 17:08:03','score',5,18,10),(35,'2015-10-08 21:05:45','2',1,38,1);
...
INSERT  IGNORE INTO `section` (`id`, `assessor_guidance_description`, `description`, `display_in_assessment_application_summary`, `name`, `priority`, `competition_id`, `parent_section_id`) VALUES (1,'This section provides context for the application but should not be assessed.',NULL,'\0','Application details',1,1,NULL),(2,'Please indicate whether this application is in scope for this competition.','','','Scope (Gateway question)',2,1,NULL),(3,NULL,'We will score each of the 4 questions in this section out of 10. Maximum score 40 points.','','Your business proposition (Q1-Q4)',3,1,NULL),(4,NULL,'We will score each of the 4 questions in this section out of 10. Maximum score 40 points.','','Your approach to the project (Q5-Q8)',4,1,NULL),(5,NULL,'We will score each of the 2 questions in this section out of 10. Maximum score 20 points.','','Funding (Q9-Q10)',5,1,NULL),(6,NULL,'In this section we need to understand the project costs for each partner in your consortium. They mush provide details of their costs within each category according to their role.','\0','Finances',6,1,NULL),(7,NULL,'You can use this section to detail costs for your organisation only. Only your organisation can see this level of detail.','\0','Your finances',1,1,6),(8,NULL,'This is the financial overview of all partners in this collaboration. Each partner should submit their organisations finances in \"your finances\" section. All partners will see this level of detail.','\0','Project financial summary',2,1,6),(9,NULL,NULL,'\0','Labour',1,1,7),(10,NULL,NULL,'\0','Overheads',2,1,7),(11,NULL,NULL,'\0','Materials',3,1,7),(12,NULL,NULL,'\0','Capital usage',4,1,7),(13,NULL,NULL,'\0','Subcontracting costs',5,1,7),(14,NULL,NULL,'\0','Travel and subsistence',6,1,7),(15,NULL,NULL,'\0','Other Costs',7,1,7);
...
-- Dump completed on 2015-10-28 11:30:16
