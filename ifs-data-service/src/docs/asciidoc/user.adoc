...
== Retrieve Profile Contract
=== Success case
=== Request
include::{snippets}/user/get-profile-contract/http-request.adoc[]
include::{snippets}/user/get-profile-contract/path-parameters.adoc[]

=== Response
include::{snippets}/user/get-profile-contract/http-response.adoc[]

=== Curl Example
include::{snippets}/user/get-profile-contract/curl-request.adoc[]

== Update Profile Contract
=== Success case
=== Request
include::{snippets}/user/update-profile-contract/http-request.adoc[]
include::{snippets}/user/update-profile-contract/path-parameters.adoc[]

=== Response
include::{snippets}/user/update-profile-contract/http-response.adoc[]

=== Curl Example
include::{snippets}/user/update-profile-contract/curl-request.adoc[]
