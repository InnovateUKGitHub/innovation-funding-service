...
==== Success
===== Request
include::{snippets}/project/get-eligibility/http-request.adoc[]
include::{snippets}/project/get-eligibility/path-parameters.adoc[]

===== Response
include::{snippets}/project/get-eligibility/http-response.adoc[]
include::{snippets}/project/get-eligibility/response-fields.adoc[]

===== Curl Example
include::{snippets}/project/get-eligibility/curl-request.adoc[]

=== Save Eligibility
==== Success
===== Request
include::{snippets}/project/save-eligibility/http-request.adoc[]
include::{snippets}/project/save-eligibility/path-parameters.adoc[]

===== Response
include::{snippets}/project/save-eligibility/http-response.adoc[]

===== Curl Example
include::{snippets}/project/save-eligibility/curl-request.adoc[]
...
=== Approve Finance Check
==== Success
===== Request
include::{snippets}/project/approve-finance-check/http-request.adoc[]
include::{snippets}/project/approve-finance-check/path-parameters.adoc[]

===== Response
include::{snippets}/project/approve-finance-check/http-response.adoc[]

===== Curl Example
include::{snippets}/project/approve-finance-check/curl-request.adoc[]


=== Get Finance Check Approval Status
==== Success
===== Request
include::{snippets}/project/get-finance-check-approval-status/http-request.adoc[]
include::{snippets}/project/get-finance-check-approval-status/path-parameters.adoc[]

===== Response
include::{snippets}/project/get-finance-check-approval-status/http-response.adoc[]
include::{snippets}/project/get-finance-check-approval-status/response-fields.adoc[]

===== Curl Example
include::{snippets}/project/get-finance-check-approval-status/curl-request.adoc[]

=== Save Finance Check
==== Success
===== Request
include::{snippets}/project/save-finance-check/http-request.adoc[]
include::{snippets}/project/save-finance-check/request-fields.adoc[]

===== Response
include::{snippets}/project/save-finance-check/http-response.adoc[]

===== Curl Example
include::{snippets}/project/save-finance-check/curl-request.adoc[]
...
==== Success
===== Request
include::{snippets}/project/get-grant-offer-letter-workflow-state/http-request.adoc[]
include::{snippets}/project/get-grant-offer-letter-workflow-state/path-parameters.adoc[]

===== Response
include::{snippets}/project/get-grant-offer-letter-workflow-state/http-response.adoc[]

===== Curl Example
include::{snippets}/project/get-grant-offer-letter-workflow-state/curl-request.adoc[]

=== Get Finance Check Eligibility
==== Success
===== Request
include::{snippets}/project/get-finance-check-eligibility/http-request.adoc[]
include::{snippets}/project/get-finance-check-eligibility/path-parameters.adoc[]

===== Response
include::{snippets}/project/get-finance-check-eligibility/http-response.adoc[]
include::{snippets}/project/get-finance-check-eligibility/response-fields.adoc[]

===== Curl Example
include::{snippets}/project/get-finance-check-eligibility/curl-request.adoc[]
