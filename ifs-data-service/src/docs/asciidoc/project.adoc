...
==== Request
include::{snippets}/project/save-mo-with-diff-project-id-in-url-and-mo-resource/http-request.adoc[]
include::{snippets}/project/save-mo-with-diff-project-id-in-url-and-mo-resource/path-parameters.adoc[]
include::{snippets}/project/save-mo-with-diff-project-id-in-url-and-mo-resource/request-fields.adoc[]

==== Response
include::{snippets}/project/save-mo-with-diff-project-id-in-url-and-mo-resource/http-response.adoc[]

==== Curl Example
include::{snippets}/project/save-mo-with-diff-project-id-in-url-and-mo-resource/curl-request.adoc[]

=== Save Monitoring Officer when project details are not yet submitted
==== Request
include::{snippets}/project/save-mo-when-project-details-not-yet-submitted/http-request.adoc[]
include::{snippets}/project/save-mo-when-project-details-not-yet-submitted/path-parameters.adoc[]
include::{snippets}/project/save-mo-when-project-details-not-yet-submitted/request-fields.adoc[]

==== Response
include::{snippets}/project/save-mo-when-project-details-not-yet-submitted/http-response.adoc[]

==== Curl Example
include::{snippets}/project/save-mo-when-project-details-not-yet-submitted/curl-request.adoc[]
