...
public class ProjectFinanceNotesServiceSecurityTest extends BaseServiceSecurityTest<ProjectFinanceNotesService> {
    ...
    @Override
    protected Class<? extends ProjectFinanceNotesService> getClassUnderTest() {
        return TestProjectFinanceNotesService.class;
    }
    ...
    public static class TestProjectFinanceNotesService implements ProjectFinanceNotesService {
