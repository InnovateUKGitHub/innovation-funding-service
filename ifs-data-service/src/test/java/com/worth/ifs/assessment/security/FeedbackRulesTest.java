...
public class FeedbackRulesTest extends BaseUnitTestMocksTest {
    ...
    public void test_assessorCanReadTheirOwnFeedback() {
        ...
        feedback.setResponseId(response.getId()).setAssessorUserId(user.getId());
        ...
        when(processRoleRepositoryMock.findByUserIdAndRoleAndApplicationId(user.getId(), assessorRole, application.getId())).thenReturn(singletonList(assessorProcessRole));
    ...
    public void test_assessorCanReadTheirOwnFeedback_doesntBelongToThisUser() {
        ...
        verify(processRoleRepositoryMock, never()).findByUserIdAndRoleAndApplicationId(user.getId(), assessorRole, application.getId());
    }
    ...
    public void test_assessorCanUpdateTheirOwnFeedback() {
        ...
        verify(processRoleRepositoryMock).findByUserIdAndRoleAndApplicationId(user.getId(), assessorRole, application.getId());
    }
