...
import static com.worth.ifs.application.transactional.ServiceFailureKeys.NOTIFICATIONS_UNABLE_TO_SEND_MULTIPLE;
...
public class NotificationServiceImplTest extends BaseServiceUnitTest<NotificationServiceImpl> {
    ...
    public void testSendNotificationByUnknownMedium() {
        ...
        assertTrue(result.getLeft().is(NOTIFICATIONS_UNABLE_TO_SEND_MULTIPLE));
    }
