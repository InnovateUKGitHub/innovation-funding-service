...
public class CompetitionResourceDocs {
    public static final FieldDescriptor[] competitionResourceFields = {
            ...
            fieldWithPath("assessorAcceptsDate").description("date by which assessors should accept or reject invitations to assess applications by"),
            fieldWithPath("assessorDeadlineDate").description("date by which assessors should submit their application feedback by"),
