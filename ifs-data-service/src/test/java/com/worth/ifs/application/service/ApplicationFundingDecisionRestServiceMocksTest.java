...
public class ApplicationFundingDecisionRestServiceMocksTest extends BaseRestServiceUnitTest<ApplicationFundingDecisionRestServiceImpl> {
    ...
    public void testFundingDecision() {
    	...
    	Map<Long, FundingDecision> applicationIdToFundingDecision = MapFunctions.asMap(1L, FundingDecision.APPLICATION_FUNDED, 2L, FundingDecision.APPLICATION_NOT_FUNDED, 3L, FundingDecision.APPLICATION_FUNDED);
