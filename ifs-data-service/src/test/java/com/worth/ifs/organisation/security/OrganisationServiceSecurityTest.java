...
public class OrganisationServiceSecurityTest extends BaseServiceSecurityTest<OrganisationService> {
    ...
    public void testFindByApplicationId() {
        ...
        verify(rules, times(2)).projectPartnerUserCanSeeAllOrganisations(isA(OrganisationResource.class), eq(getLoggedInUser()));
    ...
    public void testFindById() {
        assertAccessDenied(() -> classUnderTest.findById(1L), () -> {
            ...
            verify(rules).projectPartnerUserCanSeeAllOrganisations(isA(OrganisationResource.class), eq(getLoggedInUser()));
            verifyNoMoreInteractions(rules);
        });
    }
