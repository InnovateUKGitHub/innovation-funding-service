...
public class FileEntryServiceSecurityTest extends BaseServiceSecurityTest<FileEntryService> {
    ...
    public void testGetFileEntryByApplicationFinanceId() {
        ...
        assertAccessDenied(
                ...
                () -> {
                    verify(applicationFinanceRules).leadApplicantCanGetFileEntryResourceByFinanceIdOfACollaborator(isA(ApplicationFinanceResource.class), isA(UserResource.class));
