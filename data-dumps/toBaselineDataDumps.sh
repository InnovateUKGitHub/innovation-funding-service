...
#git checkout src/main/resources/db/migration/SCRIPTS_THAT_WILL_BE_RUN_ON_PRODUCTION src/main/resources/db/migration/V10_3__Created_organisation_type_table.sql src/main/resources/db/migration/V11_1__invite_tables.sql
#rm src/main/resources/db/migration/V1__BaseVersion.sql
#rm src/main/resources/db/migration/V2__ReferenceData.sql
#rm src/main/resources/db/webtest/V2_2__RemoveCosts.sql src/main/resources/db/webtest/V2_1__TestDataBase.sql src/main/resources/db/development/V2_1__TestDataBase.sql src/main/resources/db/integration/V2_1__TestDataBase.sql 
#cd ../data-dumps
