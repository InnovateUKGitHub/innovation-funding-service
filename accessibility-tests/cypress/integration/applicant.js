...
describe('Accessibility test - Applicant', function () {
  ...
  it('Add person to team', function () {
    cy.visit(`/application/149/form/question/507/team`);
  ...
  it('application details', function () {
    cy.visit(`/application/149/form/question/508/application-details`);
  ...
  it('Research category', function () {
    cy.visit(`/application/149/form/question/509`);
    cy.injectAxe();
    cy.checkA11y(OPTIONS);
  });

  it('Project summary', function () {
    cy.visit(`/application/149/form/question/510/generic`);
    cy.injectAxe();
    cy.checkA11y(OPTIONS);
  });

  it('Public description', function () {
    cy.visit(`/application/149/form/question/511/generic`);
    cy.injectAxe();
    cy.checkA11y(OPTIONS);
  });

  it('Scope', function () {
    cy.visit(`/application/149/form/question/512/generic`);
    cy.injectAxe();
    cy.checkA11y(OPTIONS);
  });
