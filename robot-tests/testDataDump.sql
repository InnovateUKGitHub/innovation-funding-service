...
INSERT INTO `assessment` VALUES ('',72,'YES','N','hey',1,3,3);
INSERT INTO `assessment` VALUES (NULL,82,'EMPTY','N',NULL,2,4,3);
INSERT INTO `assessment` VALUES ('asdf',37,'YES','N','',3,5,3);
INSERT INTO `assessment` VALUES (NULL,60,'EMPTY','N',NULL,4,6,3);
INSERT INTO `assessment` VALUES (NULL,0,'EMPTY','N',NULL,5,3,9);
INSERT INTO `assessment` VALUES (NULL,0,'EMPTY','N',NULL,6,4,9);
INSERT INTO `assessment` VALUES ('qwer',10,'YES','N','',7,5,9);
INSERT INTO `assessment` VALUES (NULL,0,'EMPTY','N',NULL,8,6,9);
...
INSERT INTO `form_input` VALUES (1,500,2,1,1,'1. What is the business opportunity that your project addresses?');
INSERT INTO `form_input` VALUES (2,500,2,1,1,'2. What is the size of the potential market for your project?');
INSERT INTO `form_input` VALUES (3,500,2,1,1,'3. How will you exploit and market your project?');
INSERT INTO `form_input` VALUES (4,500,2,1,1,'4. What economic, social and environmental benefits do you expect your project to deliver and when?');
INSERT INTO `form_input` VALUES (5,500,2,1,1,'5. What technical approach will you use and how will you manage your project?');
INSERT INTO `form_input` VALUES (6,500,2,1,1,'6. What is innovative about your project?');
INSERT INTO `form_input` VALUES (7,500,2,1,1,'7. What are the risks (technical, commercial and environmental) to your project\'s success? What is your risk management strategy?');
INSERT INTO `form_input` VALUES (8,500,2,1,1,'8. Does your project team have the skills, experience and facilities to deliver this project?');
INSERT INTO `form_input` VALUES (9,500,5,1,1,'Application details');
INSERT INTO `form_input` VALUES (11,500,2,1,1,'Project summary');
INSERT INTO `form_input` VALUES (12,500,2,1,1,'Public description');
INSERT INTO `form_input` VALUES (13,500,2,1,1,'How does your project align with the scope of this competition?');
INSERT INTO `form_input` VALUES (14,500,4,1,0,'Appendix');
INSERT INTO `form_input` VALUES (15,500,2,1,1,'9. What will your project cost?');
INSERT INTO `form_input` VALUES (16,500,2,1,1,'10. How does financial support from Innovate UK and its funding partners add value?');
INSERT INTO `form_input` VALUES (17,0,4,1,0,'Appendix');
INSERT INTO `form_input` VALUES (18,0,4,1,0,'Appendix');
INSERT INTO `form_input` VALUES (19,0,6,1,1,'Funding rules for this competition');
...
INSERT INTO `form_input` VALUES (39,0,6,1,1,NULL);
...
INSERT INTO `form_input_response` VALUES (16,'2015-08-08 00:00:00','file.doc',14,1,1);
INSERT INTO `form_input_response` VALUES (17,'2015-08-08 00:00:00','file.pdf',17,1,1);
...
INSERT INTO `form_input_response` VALUES (32,'2015-10-02 17:08:03','score',14,10,5);
INSERT INTO `form_input_response` VALUES (33,'2015-10-02 17:08:03','score',17,10,5);
INSERT INTO `form_input_response` VALUES (34,'2015-10-02 17:08:03','score',18,10,5);
INSERT INTO `form_input_response` VALUES (35,'2015-10-08 21:05:45','2',38,1,1);
...
INSERT INTO `organisation` VALUES (1,'Nomensa');
INSERT INTO `organisation` VALUES (2,'Worth Internet Systems');
INSERT INTO `organisation` VALUES (3,'Empire Ltd');
INSERT INTO `organisation` VALUES (4,'Ludlow');
INSERT INTO `organisation` VALUES (5,'Manchester University');
INSERT INTO `organisation` VALUES (6,'EGGS');
INSERT INTO `organisation` VALUES (7,'AA Ltd');
...
INSERT INTO `process` VALUES (1,NULL,NULL,'ASSESSMENT','2015-10-01 11:42:40',NULL,NULL,'assessed');
INSERT INTO `process` VALUES (2,NULL,NULL,'ASSESSMENT','2015-09-22 14:34:16',NULL,NULL,'pending');
INSERT INTO `process` VALUES (3,NULL,NULL,'ASSESSMENT','2015-10-08 15:16:19',NULL,NULL,'assessed');
INSERT INTO `process` VALUES (4,'not-my-area-of-interest',NULL,'ASSESSMENT','2015-10-01 11:42:54','',NULL,'pending');
INSERT INTO `process` VALUES (5,NULL,NULL,'ASSESSMENT','2015-10-07 11:22:33',NULL,NULL,'pending');
INSERT INTO `process` VALUES (6,NULL,NULL,'ASSESSMENT','2015-10-07 11:22:33',NULL,NULL,'pending');
INSERT INTO `process` VALUES (7,NULL,NULL,'ASSESSMENT','2015-10-08 16:31:00',NULL,NULL,'assessed');
INSERT INTO `process` VALUES (8,NULL,NULL,'ASSESSMENT','2015-10-07 11:22:33',NULL,NULL,'pending');
...
INSERT INTO `question_form_input` VALUES (19,19,0);
...
INSERT INTO `question_form_input` VALUES (39,39,0);
...
INSERT INTO `question_status` VALUES (2,'2015-10-02 17:37:31','','\0',1,NULL,NULL,1,11);
...
INSERT INTO `question_status` VALUES (6,'2015-10-02 17:46:54','','\0',1,NULL,NULL,NULL,13);
...
INSERT INTO `question_status` VALUES (9,'2015-09-25 00:27:25',NULL,'',1,1,5,NULL,4);
...
INSERT INTO `schema_version` VALUES (1,1,'1','Base version','SQL','V1__Base_version.sql',1613992993,'root','2015-12-10 17:15:04',400,1);
INSERT INTO `schema_version` VALUES (2,2,'2.1','Add Form Input Tables','SQL','V2_1__Add_Form_Input_Tables.sql',1182368876,'root','2015-12-10 17:15:04',73,1);
INSERT INTO `schema_version` VALUES (11,11,'2.10','MakeOriginalFirstPriorityQuestionsAssessable','SQL','V2_10__MakeOriginalFirstPriorityQuestionsAssessable.sql',-350651558,'root','2015-12-10 17:15:04',18,1);
INSERT INTO `schema_version` VALUES (3,3,'2.2','Migrate Questions To Form Inputs','SQL','V2_2__Migrate_Questions_To_Form_Inputs.sql',1067513257,'root','2015-12-10 17:15:04',6,1);
INSERT INTO `schema_version` VALUES (4,4,'2.3','Migrate Responses To Form Input Responses','SQL','V2_3__Migrate_Responses_To_Form_Input_Responses.sql',-876851300,'root','2015-12-10 17:15:04',6,1);
INSERT INTO `schema_version` VALUES (5,5,'2.4','RemoveChildQuestions','SQL','V2_4__RemoveChildQuestions.sql',1799033600,'root','2015-12-10 17:15:04',5,1);
INSERT INTO `schema_version` VALUES (6,6,'2.5','RemoveQuestionTypes','SQL','V2_5__RemoveQuestionTypes.sql',875814196,'root','2015-12-10 17:15:04',70,1);
INSERT INTO `schema_version` VALUES (7,7,'2.6','DropChildQuestions','SQL','V2_6__DropChildQuestions.sql',829955878,'root','2015-12-10 17:15:04',61,1);
INSERT INTO `schema_version` VALUES (8,8,'2.7','RemoveValuesFromQuestionsAndResponses','SQL','V2_7__RemoveValuesFromQuestionsAndResponses.sql',395469415,'root','2015-12-10 17:15:04',136,1);
INSERT INTO `schema_version` VALUES (9,9,'2.8','AddIncludedInApplicationSummaryColumn','SQL','V2_8__AddIncludedInApplicationSummaryColumn.sql',689541774,'root','2015-12-10 17:15:04',35,1);
INSERT INTO `schema_version` VALUES (10,10,'2.9','AddDescriptionColumnToFormInput','SQL','V2_9__AddDescriptionColumnToFormInput.sql',299512244,'root','2015-12-10 17:15:04',29,1);
INSERT INTO `schema_version` VALUES (12,12,'3.1','Add Form Input Validator Tables','SQL','V3_1__Add_Form_Input_Validator_Tables.sql',-2024327682,'root','2015-12-10 17:15:05',29,1);
INSERT INTO `schema_version` VALUES (13,13,'3.2','Add Validators For Textarea','SQL','V3_2__Add_Validators_For_Textarea.sql',623679638,'root','2015-12-10 17:15:05',6,1);
INSERT INTO `schema_version` VALUES (14,14,'3.3','Refactor Validator Link Table','SQL','V3_3__Refactor_Validator_Link_Table.sql',599640107,'root','2015-12-10 17:15:05',24,1);
INSERT INTO `schema_version` VALUES (15,15,'3.4','Add Textarea Validations','SQL','V3_4__Add_Textarea_Validations.sql',-1741635849,'root','2015-12-10 17:15:05',5,1);
INSERT INTO `schema_version` VALUES (16,16,'3.5','SetQuestionNameForCustomFinanceSummaryCompleteHandling','SQL','V3_5__SetQuestionNameForCustomFinanceSummaryCompleteHandling.sql',-146831348,'root','2015-12-10 17:15:05',4,1);
INSERT INTO `schema_version` VALUES (17,17,'4.1','Add finances default values','SQL','V4_1__Add_finances_default_values.sql',1230154785,'root','2015-12-10 17:15:05',5,1);
INSERT INTO `schema_version` VALUES (18,18,'4.2','Add finances cost fields','SQL','V4_2__Add_finances_cost_fields.sql',-1006528488,'root','2015-12-10 17:15:05',5,1);
INSERT INTO `schema_version` VALUES (19,19,'4.3','Add finances default values','SQL','V4_3__Add_finances_default_values.sql',1412732844,'root','2015-12-10 17:15:05',1,1);
INSERT INTO `schema_version` VALUES (20,20,'5.1','Update section names','SQL','V5_1__Update_section_names.sql',-1783932958,'root','2015-12-10 17:15:05',11,1);
INSERT INTO `schema_version` VALUES (21,21,'5.2','Update competition startdate','SQL','V5_2__Update_competition_startdate.sql',1719325543,'root','2015-12-10 17:15:05',4,1);
INSERT INTO `schema_version` VALUES (22,22,'5.3','AddWordCountValidatorToFormInputs','SQL','V5_3__AddWordCountValidatorToFormInputs.sql',-1171581430,'root','2015-12-10 17:15:05',7,1);
...
INSERT INTO `section` VALUES (1,'This section provides context for the application but should not be assessed.',NULL,'\0','Application details',1,1,NULL);
INSERT INTO `section` VALUES (2,'Please indicate whether this application is in scope for this competition.','','','Scope (Gateway question)',2,1,NULL);
INSERT INTO `section` VALUES (3,NULL,'We will score each of the 4 questions in this section out of 10. Maximum score 40 points.','','Your business proposition (Q1-Q4)',3,1,NULL);
INSERT INTO `section` VALUES (4,NULL,'We will score each of the 4 questions in this section out of 10. Maximum score 40 points.','','Your approach to the project (Q5-Q8)',4,1,NULL);
INSERT INTO `section` VALUES (5,NULL,'We will score each of the 2 questions in this section out of 10. Maximum score 20 points.','','Funding (Q9-Q10)',5,1,NULL);
INSERT INTO `section` VALUES (6,NULL,'In this section we need to understand the project costs for each partner in your consortium. They mush provide details of their costs within each category according to their role.','\0','Finances',6,1,NULL);
INSERT INTO `section` VALUES (7,NULL,'You can use this section to detail costs for your organisation only. Only your organisation can see this level of detail.','\0','Your finances',1,1,6);
INSERT INTO `section` VALUES (8,NULL,'This is the financial overview of all partners in this collaboration. Each partner should submit their organisations finances in \"your finances\" section. All partners will see this level of detail.','\0','Project financial summary',2,1,6);
INSERT INTO `section` VALUES (9,NULL,NULL,'\0','Labour',1,1,7);
INSERT INTO `section` VALUES (10,NULL,NULL,'\0','Overheads',2,1,7);
INSERT INTO `section` VALUES (11,NULL,NULL,'\0','Materials',3,1,7);
INSERT INTO `section` VALUES (12,NULL,NULL,'\0','Capital usage',4,1,7);
INSERT INTO `section` VALUES (13,NULL,NULL,'\0','Subcontracting costs',5,1,7);
INSERT INTO `section` VALUES (14,NULL,NULL,'\0','Travel and subsistence',6,1,7);
INSERT INTO `section` VALUES (15,NULL,NULL,'\0','Other Costs',7,1,7);
...
INSERT INTO `user` VALUES (1,'steve.smith@empire.com','image.jpg','Steve Smith','67bf8182199a451fbae14c67711f2f05eef8e2f464e4bd51f3b810111a0033dc64ef696e02cf8f27','123abc');
INSERT INTO `user` VALUES (2,'jessica.doe@ludlow.co.uk','image2.jpg','Jessica Doe','67bf8182199a451fbae14c67711f2f05eef8e2f464e4bd51f3b810111a0033dc64ef696e02cf8f27','456def');
INSERT INTO `user` VALUES (3,'paul.plum@gmail.com','image3.jpg','Professor Plum','67bf8182199a451fbae14c67711f2f05eef8e2f464e4bd51f3b810111a0033dc64ef696e02cf8f27','789ghi');
INSERT INTO `user` VALUES (6,'competitions@innovateuk.gov.uk','image4.jpg','Comp Exec (Competitions)','67bf8182199a451fbae14c67711f2f05eef8e2f464e4bd51f3b810111a0033dc64ef696e02cf8f27','123def');
INSERT INTO `user` VALUES (7,'finance@innovateuk.gov.uk','image5.jpg','Project Finance Analyst (Finance)','67bf8182199a451fbae14c67711f2f05eef8e2f464e4bd51f3b810111a0033dc64ef696e02cf8f27','123ghi');
INSERT INTO `user` VALUES (8,'pete.tom@egg.com','image2.jpg','Pete Tom','67bf8182199a451fbae14c67711f2f05eef8e2f464e4bd51f3b810111a0033dc64ef696e02cf8f27','867def');
INSERT INTO `user` VALUES (9,'felix.wilson@gmail.com','image3.jpg','Felix Wilson','67bf8182199a451fbae14c67711f2f05eef8e2f464e4bd51f3b810111a0033dc64ef696e02cf8f27','123qwe');
...
-- Dump completed on 2015-12-10 17:16:29
