...
browser = BuiltIn().get_library_instance('Selenium2Library')

def get_webdriver_instance():
    return browser._current_browser()  # This is used because switch_to needs a webdriver instance, not a Selenium2Library instance.
