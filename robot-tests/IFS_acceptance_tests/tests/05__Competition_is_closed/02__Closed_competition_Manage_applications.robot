...
Search for applications
    ...
    When The user enters text to a text field    css=#filterSearch    ${application_ids["Neural networks to optimise freight train routing"]}
    and The user clicks the button/link    jQuery=button:contains(Filter)
    Then the user should see the element    jQuery=tr:nth-child(1) td:nth-child(1):contains("${application_ids["Neural networks to optimise freight train routing"]}")
