...
The applicant enters organisation size details      [Arguments]     ${org_size_option}  ${funding_level}
...
The 'your finances' section can be successfully saved       [Arguments]     ${org_size_option}  ${funding_level}
    Applicant goes to the Your finances section
...
The 'your finances' section cannot be successfully saved
    ...
    Page Should Contain     This field should be





Applicant enters the organisation size  [Arguments]     ${org_size_option}
    Select Radio Button         financePosition-organisationSize          ${org_size_option}

Applicant enters the funding level  [Arguments]     ${funding_level}
...
Applicant can see the correct funding level has been saved     [Arguments]   ${funding_level}
