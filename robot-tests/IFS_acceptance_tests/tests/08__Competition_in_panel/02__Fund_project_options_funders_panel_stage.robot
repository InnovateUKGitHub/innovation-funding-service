...
Internal user can view ineligible applications
    ...
    Then the user should see the element       jQuery=td:contains("${FUNDERS_PANEL_APPLICATION_2_NUMBER}") + td:contains(${FUNDERS_PANEL_APPLICATION_2_TITLE}) ~ td:contains("Ineligible")
    ...
    And the user navigates to the page         ${server}/management/competition/${FUNDERS_PANEL_COMPETITION_NUMBER}/applications/unsuccessful
    Then the user should not see the element   jQuery=td:contains("${FUNDERS_PANEL_APPLICATION_2_NUMBER}") + td:contains(${FUNDERS_PANEL_APPLICATION_2_TITLE}) ~ td:contains("Ineligible")
...
internal user can view unsuccessful applications
    ...
    the user should see the element  jQuery=td:contains("${FUNDERS_PANEL_APPLICATION_2_NUMBER}") + td:contains(${FUNDERS_PANEL_APPLICATION_2_TITLE}) ~ td:contains("Unsuccessful")
    # TODO To uncomment below line once 1581 is fixed
