...
Project finance user cannot add query for an organisation not part of the project
    ...
    Then the user navigates to the page    ${server}/project-setup-management/project/${FUNDERS_PANEL_APPLICATION_1_PROJECT}/finance-check/organisation/22/query/new-query
