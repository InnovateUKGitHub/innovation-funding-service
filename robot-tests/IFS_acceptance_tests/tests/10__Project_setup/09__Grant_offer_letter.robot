...
Support user cannot access spend profile until it is approved
    ...
    Then the user should see the element   css=#table-project-status tr:nth-of-type(7) td:nth-of-type(5).status.action  # Spend profile status
    And the user should not see the element   css=#table-project-status tr:nth-of-type(7) td:nth-of-type(5).status.action a  # Spend profile link
...
Verify support users permissions in project setup tab
    ...
    Then the user should see the element     css=#table-project-status tr:nth-of-type(7) td:nth-of-type(1).status.ok a  # Project details
    And the user should see the element      css=#table-project-status tr:nth-of-type(7) td:nth-of-type(2).status.ok a  # MO
    And the user should see the element      css=#table-project-status tr:nth-of-type(7) td:nth-of-type(3).status.ok    # Bank details
    And the user should not see the element  css=#table-project-status tr:nth-of-type(7) td:nth-of-type(3).status.ok a  # Bank details link
    And the user should see the element      css=#table-project-status tr:nth-of-type(7) td:nth-of-type(4).status.ok    # Finance checks
    And the user should not see the element  css=#table-project-status tr:nth-of-type(7) td:nth-of-type(4).status.ok a  # Finance checks link
    And the user should see the element      css=#table-project-status tr:nth-of-type(7) td:nth-of-type(5).status.ok a  # Spend profile
    And the user should see the element      css=#table-project-status tr:nth-of-type(7) td:nth-of-type(6).status.ok a  # Other docs
    And the user clicks the button/link      css=#table-project-status tr:nth-of-type(7) td:nth-of-type(7).status.ok a  # GOL
