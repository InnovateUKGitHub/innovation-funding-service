...
The user edits the KTP costs section
    ...
    the user enters text to a text field     jQuery = td:contains("Associate 1") ~ td input[id^="associateDevelopmentCostRows"][id$="cost"]    40
    the user enters text to a text field     jQuery = td:contains("Associate 2") ~ td input[id^="associateDevelopmentCostRows"][id$="cost"]    45
