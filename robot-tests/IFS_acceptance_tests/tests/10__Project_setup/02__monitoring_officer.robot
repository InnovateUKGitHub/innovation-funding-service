...
Assign MO role to existing IFS user
    ...
    And the user enters text to a text field    id = emailAddress   ${lead_applicant_credentials["email"]}
...
the user should see exisitng IFS user details and add phone number
    ...
    the user should see the element          jQuery = dt:contains("Email address") ~ dd:contains("${lead_applicant_credentials["email"]}")
    the user should see the element          jQuery = dt:contains("First name") ~ dd:contains("Steve")
    the user should see the element          jQuery = dt:contains("Last name") ~ dd:contains("Smith")
