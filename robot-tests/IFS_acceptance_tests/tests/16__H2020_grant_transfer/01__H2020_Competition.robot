...
The user is able to complete Application details section
    ...
    Wait Until Keyword Succeeds Without Screenshots      1User can populate Funding information and Project eligibility 0s    200ms   input text    id = actionType    (CSA) Coordination and Support Actions
