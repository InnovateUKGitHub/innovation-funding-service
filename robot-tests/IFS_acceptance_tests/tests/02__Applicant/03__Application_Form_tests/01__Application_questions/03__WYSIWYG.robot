...
all text entered should be Bold and stay the same after page refresh
    ...
    ${STATUS}    ${VALUE}=    IFS Run Keyword And Ignore Error    Element Should Be Visible    css=#form-input-1 .editor b
...
all text entered should be Italic and stay the same after page refresh
    ...
    ${STATUS}    ${VALUE}=    IFS Run Keyword And Ignore Error    Element Should Be Visible    css=#form-input-1 .editor i
