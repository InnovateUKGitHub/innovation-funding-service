...
${PROVIDING_SUSTAINABLE_CHILDCARE_FINANCE_SECTION}    ${SERVER}/application/${IN_ASSESSMENT_APPLICATION_2}/form/section/7
${PROVIDING_SUSTAINABLE_CHILDCARE_FINANCE_SUMMARY}    ${SERVER}/application/${IN_ASSESSMENT_APPLICATION_2}/form/section/8
