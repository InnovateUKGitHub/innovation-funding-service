...
The applicant selects 'Yes' and fills two rows
    ...
    IFS Run Keyword And Ignore Error    Click element    jQuery=#other-funding-table button:contains("Remove")
...
Totals should be correct
    ...
    IFS Wait Until Element Contains    ${TOTAL_COLLAPSIBLE}    ${COLLAPSIBLE_VALUE}
...
the grant value should be correct in the finance summary page
    ...
    IFS Wait Until Element Contains    css=.finance-summary tr:nth-of-type(1) td:nth-of-type(2)    25
