...
Green check shows when finances are marked as complete
    ...
    ...    AND    Run Keyword And Ignore Error Without Screenshots    Focus    jQuery=button:contains("Edit")
    ...    AND    Run Keyword And Ignore Error Without Screenshots    the user clicks the button/link    jQuery=button:contains("Edit")
