...
First Assessor shouldn't be able to see second assessor's assessments
    ...
    When the user navigates to the page and gets a custom error message     ${Assessment_overview_11}   ${403_error_message}

First assessor shouldn't be able to access second assessor's application questions
    [Documentation]    INFUND-4568
    [Tags]
    When the user navigates to the page and gets a custom error message     ${ASSESSOR_ASSESSMENT_QUESTIONS_11}   ${403_error_message}
    [Teardown]    the user closes the browser
