...
User can update initial details of a competition before notify date
    ...
    Then the user should see that the element is disabled    id=openingDateDay
    ...
    And the user selects the option from the drop-down menu    Peter Freeman    id=leadTechnologistUserId
