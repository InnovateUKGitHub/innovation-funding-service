...
Successful applicants are notified of the funding decision
    ...
    [Tags]    Email
    Then the user reads his email    worth.email.test+fundsuccess@gmail.com    Your application into the competition La Fromage    pleased to inform you

Unsuccessful applicants are notified of the funding decision
    [Documentation]    INFUND-2603
    [Tags]    Email
    Then the user reads his email    worth.email.test.two+fundfailure@gmail.com    Your application into the competition La Fromage    unable to fund your application
