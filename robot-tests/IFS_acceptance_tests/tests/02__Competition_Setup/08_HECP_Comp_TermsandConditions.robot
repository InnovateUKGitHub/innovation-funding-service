...
${hecpTermsAndConditionsTitle}     Horizon Europe Contingency Programme Privacy Notice
...
HECP terms and conditions are correct
    ...
    And select window                                    title = ${hecpTermsAndConditionsLink} - Innovation Funding Service
    Then the user should see the element                 jQuery = h1:contains("${hecpTermsAndConditionsTitle}")
