...
...
...               IFS-10693 Horizon Europe - Increase project duration in months
...
...
Funding information: calculations
    ...
    And click element                           name = funders[1].funderBudget
    And the user enters text to a text field    name = funders[1].funderBudget    1000
...
the pre-field date should be correct
    Element Should Contain        id = milestoneWeekdayEntry-OPEN_DATE    Tuesday
