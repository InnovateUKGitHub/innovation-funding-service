...
MO details(email step)
    ...
    And the user reads his email from the default mailbox    worth.email.test+projectlead@gmail.com    Your Monitoring Officer    has been assigned a Monitoring Officer
