...
Project details can be submitted with PM, project address and start date
    ...
    Submit all project details button should be enabled
...
the submit button should be disabled
    Element Should Be Disabled    jQuery=.button:contains("Submit all project details")

the applicant clicks the submit button and then clicks cancel in the submit modal
    Wait Until Element Is Enabled    jQuery=.button:contains("Submit all project details")
...
Submit all project details button should be enabled
    Then Wait Until Element Is Enabled    jQuery=.button:contains("Submit all project details")
