...
View feedback from each assessor
    ...
    [Tags]  HappyPath
    Then the user should see the element    jQuery = .wysiwyg-styles p:contains("I have no problem recommending this application")
    And the user should see the element     jQuery = .wysiwyg-styles p:contains("Very good, but could have been better in areas")
    And the user should see the element     jQuery = .wysiwyg-styles p:contains("I enjoyed reading this application, well done")
