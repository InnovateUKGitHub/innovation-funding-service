...
the user should should see lead and partners details
    the user should see the element    jQuery = #accordion-questions-content-1-1 h2:contains("Empire Ltd")+td:contains("Type")+td:contains("Business")
    ...
    the user should see the element    jQuery = #accordion-questions-content-1-1 h2:contains("EGGS")+td:contains("Type")+td:contains("Research")
    ...
    the user should see the element    jQuery = #accordion-questions-content-1-1 h2:contains("${PROJECT_SETUP_APPLICATION_1_ADDITIONAL_PARTNER_NAME}")+td:contains("Type")+td:contains("Business")
    ...
    the user should see the element    jQuery = #accordion-questions-content-1-1 h2:contains("${organisationLudlowName}")+td:contains("Type")+td:contains("Business")
