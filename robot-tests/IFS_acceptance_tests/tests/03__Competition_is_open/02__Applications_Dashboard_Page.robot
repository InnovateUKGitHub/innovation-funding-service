...
Application has team limk
    ...
    And the user should see the element    jQuery=table#applicationTeamOrganisationUser0 tbody tr:nth-of-type(1) td:contains("steve.smith@empire.com")
    ...
    And the user should see the element    jQuery=table#applicationTeamOrganisationUser1 tbody tr:nth-of-type(1) td:contains("pete.tom@egg.com")
    ...
    And the user should see the element    jQuery=table#applicationTeamOrganisationUser2 tbody tr:nth-of-type(1) td:contains("ewan+1@hiveit.co.uk")
    ...
    And the user should see the element    jQuery=table#applicationTeamOrganisationUser3 tbody tr:nth-of-type(1) td:contains("jessica.doe@ludlow.co.uk")
