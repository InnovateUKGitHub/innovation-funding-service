...
the applicant goes to the project summary, and performs actions
    ...
    Input Text    css=#form-input-885 .editor    This is some random text
...
the applicant goes to the public description, and performs actions
    ...
    Input Text    css=#form-input-886 .editor    This is some random text
...
the applicant goes to the scope section, and performs actions
    ...
    Input Text    css=#form-input-887 .editor    This is some random textThis is some random textThis is some random textThis is some random textThis is some random textThis is some random textThis is some random textThis is some random textThis is some random textThis is some random textThis is some random textThis is some random textThis is some random textThis is some random textThis is some random textThis is some random text
...
the applicant goes to the business opportunity section, and performs actions
    ...
    Input Text    css=#form-input-891 .editor    This is some random text
...
the applicant goes to the potential market section, and performs actions
    ...
    Input Text    css=#form-input-895 .editor    This is some random text
...
the applicant goes to the project exploitation section, and performs actions
    ...
    Input Text    css=#form-input-899 .editor    This is some random text
...
the applicant goes to the technical approach section, and performs actions
    ...
    Input Text    css=#form-input-907 .editor    This is some random text
...
the applicant goes to the innovation section, and performs actions
    ...
    Input Text    css=#form-input-911 .editor    This is some random text
...
the applicant goes to the risks section, and performs actions
    ...
    Input Text    css=#form-input-915 .editor    This is some random text
...
the applicant goes to the project team section, and performs actions
    ...
    Input Text    css=#form-input-919 .editor    This is some random text
...
the applicant goes to the funding section, and performs actions
    ...
    Input Text    css=#form-input-923 .editor    This is some random text
...
the applicant goes to the adding value section, and performs actions
    ...
    Input Text    css=#form-input-927 .editor    This is some random text
...
Assign the adding value section to Jessica Doe
    focus    css=#form-input-927 .editor
    Input Text    css=#form-input-927 .editor    lead Applicant's text 123...
    Click Element    css=#form-input-927 .assign-button button
    Click Element    xpath=//div[@id="form-input-927"]//button[contains(text(),"Jessica Doe")]
