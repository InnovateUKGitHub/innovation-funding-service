...
Comp Admin starts a new Competition
    ...
    [Tags]    HappyPath
    [Setup]    Guest user log-in in new browser in new browser    &{Comp_admin1_credentials}
...
Invite Collaborator in Application with Growth table
    ...
    When Guest user log-in in new browser in new browser    &{collaborator1_credentials}
