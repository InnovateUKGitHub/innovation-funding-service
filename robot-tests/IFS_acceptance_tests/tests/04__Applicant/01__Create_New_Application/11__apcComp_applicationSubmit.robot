...
Comp Admin creates an APC competition
    ...
    Then the competition admin creates competition   ${business_type_id}  ${apcCompetitionTitle}  APC  ${compType_APC}  SUBSIDY_CONTROL  GRANT  PROJECT_SETUP  yes  30  true  single  No
