...
Comp admin can not complete the competition setup without organisational eligibility category completetion
     ...
     When the user completes all categories except organisational eligibility category     ${business_type_id}  ${ukLeadInternationalCompetition}  ${compType_Programme}  PROJECT_SETUP  yes  1  true  collaborative
