...
the user completes assessment and moves to PS
    ...
    the user reads his email                       steve.smith@empire.com   	Important message about your application ${application_id}: ${COVIDdeminimusapplicationTitle1} for the competition ${COVIDdeminimuscompetitionTitle}   Average assessor score
