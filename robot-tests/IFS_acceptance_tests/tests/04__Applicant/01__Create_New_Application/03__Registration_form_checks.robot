...
...
...               IFS-11981 IFS Contact Details change process
...
...
Your details: Server-side first and last name field validations
    [Documentation]    INFUND-885
...
Your details: Server-side empty field validations
    [Documentation]    INFUND-885  IFS-11981
    ...
    Then the user should see your details summary and field validations
    And the user should see valid guidance text
...
the user should see your details summary and field validations
...
the user should see valid guidance text
    the user should see the element     jQuery = p:contains("To continue, you need to create an account with the Innovation Funding Service. This account will be associated with your organisation.")
    the user should see the element     jQuery = span:contains("You will need this to sign in to your account and we may use this to contact you. We recommend using a professional email address.")
