...
#create application for international organisation
...
Moving International Competition to Project Setup
    ...
    Given Requesting IDs of this Project
    ...
    log to console     "this is tear down project ID"
