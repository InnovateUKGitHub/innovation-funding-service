...
*** Variables ***
${hecpPreregCompName}                           Hecp Pre Registration Competition with Release feedback
${hecpPreregAppName}                            preRegApplication with Release feedback
...
Comp Admin creates a prereg competitionarden.pimenta@innovateuk.test
    ...
    Then the competition admin creates prereg competition    ${BUSINESS_TYPE_ID}  ${hecpPreregCompName}  Pre Registration  ${compType_HESTA}  NOT_AID  HECP  Release_Feedback  no  50  false  single-or-collaborative
