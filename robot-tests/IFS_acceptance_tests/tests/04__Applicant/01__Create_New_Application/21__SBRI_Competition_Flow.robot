...
Internal users can see SBRI competition in previous tab
    ...
    The user clicks the button/link in the paged list   link = ${openSBRICompetitionName}
    Then the user should see the element     jQuery = h1:contains(${openSBRICompetitionName})
...
Internal user can view validation message when payment requested is less than total project cost
    ...
    When The user enters text to a text field       jQuery = [id$=payment]:first   10000000
