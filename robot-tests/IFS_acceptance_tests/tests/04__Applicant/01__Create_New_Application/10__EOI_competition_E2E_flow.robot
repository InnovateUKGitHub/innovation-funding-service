...
Comp Admin Creates EOI type competition
    ...
    Then the competition admin creates competition    ${business_type_id}  ${comp_name}  EOI  ${compType_EOI}  SUBSIDY_CONTROL  GRANT  RELEASE_FEEDBACK  no  30  true  collaborative  No
