...
the user fills in Labour
    the user clicks the button/link            jQuery=#form-input-931 button:contains("Labour")
...
the user chooses 20% overheads option
    ...
    the user clicks the button/link    jQuery=#form-input-931 button:contains("Overhead costs")
    the user clicks the button/link    css=label[data-target="overhead-default-percentage"]
    the user clicks the button/link    jQuery=#form-input-931 button:contains("Overhead costs")

the user fills in Material
    the user clicks the button/link       jQuery=#form-input-931 button:contains("Materials")
...
the user fills in Capital usage
    the user clicks the button/link       jQuery=#form-input-931 button:contains("Capital usage")
...
the user fills in Travel and subsistence
    the user clicks the button/link       jQuery=#form-input-931 button:contains("Travel and subsistence")
...
the user fills in Other costs
    the user clicks the button/link       jQuery=#form-input-931 button:contains("Other costs")
