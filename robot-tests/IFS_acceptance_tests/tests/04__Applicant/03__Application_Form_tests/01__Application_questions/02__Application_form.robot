...
Incomplete sections contain mark as complete link
    [Documentation]  IFS-751
    [Tags]
    Given the user should see the element  jQuery = div:contains("Incomplete") button:contains("Application details")
...
the question should be marked as complete on the application overview page
    The user clicks the button/link    link = Back to application overview
    The user should see the element    jQuery = li:contains("Project summary") span:contains("Complete")
