...
the Applicant clicks on the Bold button in the "business opportunity" field
    Clear Element Text    css=#form-input-891 .editor
    Press Key    css=#form-input-891 .editor    \\8
    wait for autosave
...
all text entered should be Bold and stay the same after page refresh
    The user enters text to a text field    css=#form-input-891 .editor    Entering text to verify BOLD.
    ${STATUS}    ${VALUE}=    Run Keyword And Ignore Error Without Screenshots    Element Should Be Visible    css=#form-input-891 .editor b
    Run Keyword If    '${status}' == 'FAIL'    Element Should Be Visible    css=#form-input-891 .editor strong
    Focus    css=.app-submit-btn
    wait for autosave
    the user reloads the page
    the user should see the element    css=#form-input-891 .editor strong

the Applicant clicks on the Numbering bullet button in the "business opportunity" field
    The user enters text to a text field    css=#form-input-891 .editor    This is testing for numbering bullets.
    Press Key    css=#form-input-891 .editor    \\8
...
the Applicant clicks on the Bullet format button in the "business opportunity" field
    The user enters text to a text field    css=#form-input-891 .editor    testing
    Press Key    css=#form-input-891 .editor    \\8
...
all text entered should be Italic and stay the same after page refresh
    The user enters text to a text field    css=#form-input-891 .editor    Entering text to verify ITALIC.
    ${STATUS}    ${VALUE}=    Run Keyword And Ignore Error Without Screenshots    Element Should Be Visible    css=#form-input-891 .editor i
    Run Keyword If    '${status}' == 'FAIL'    the user should see the element    css=#form-input-891 .editor em
    Focus    css=.app-submit-btn
    wait for autosave
    the user reloads the page
    the user should see the element    css=#form-input-891 .editor em

all text entered should be in Numbering bullets and stay the same after page refresh
    the user should see the element    css=#form-input-891 .editor ol
    Focus    css=.app-submit-btn
    wait for autosave
    the user reloads the page
...
all text entered should be in Bullet format and stay the same after page refresh
    the user should see the element    css=#form-input-891 .editor li
    Focus    css=.app-submit-btn
    wait for autosave
    the user reloads the page
    Focus    css=.app-submit-btn
