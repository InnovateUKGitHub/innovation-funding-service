...
Mark as complete is impossible for empty questions
    ...
    And The user clicks the button/link    css=#form-input-886 .buttonlink[name="mark_as_complete"]
    Then the user should see the element    css=#form-input-886 .error-message
...
the "Project Summary" question is empty
    the user enters text to a text field    css=#form-input-886 .editor    ${empty}
    mouse out    css=#form-input-886 .editor
    wait for autosave
...
the applicant inserts some text again in the "Project Summary" question
    The user enters text to a text field    css=#form-input-886 .editor    test if the applicant can mark the question as complete
    mouse out    css=#form-input-886 .editor
    wait for autosave

applicant should be able to mark the question as complete
    the user clicks the button/link    jQuery=button:contains("Mark as complete")
    the user should not see the element    css=#form-input-886 .error-message
