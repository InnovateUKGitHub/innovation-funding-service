...
Guidance of the questions
    ...
    [Tags]
    When the user clicks the button/link    css=#form-input-885 .summary
...
Mark a question as incomplete
    ...
    When the user clicks the button/link    css=#form-input-885 div.form-footer .form-footer__actions > button[name="mark_as_incomplete"]
...
the text should be visible
    Wait Until Element Contains Without Screenshots    css=#form-input-885 .editor    I am a robot
...
the Applicant edits the Project summary
    ...
    Press Key    css=#form-input-885 .editor    \\8
    Focus    css=.app-submit-btn
    Wait Until Element Contains Without Screenshots    css=#form-input-885 .count-down    400
    Focus    css=#form-input-885 .editor
    The user enters text to a text field    css=#form-input-885 .editor    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris test @.
    Focus    css=.app-submit-btn
    wait for autosave

the word count should be correct for the Project summary
    Wait Until Element Contains Without Screenshots    css=#form-input-885 .count-down    369

the Applicant edits the Project description question (300 words)
    Clear Element Text    css=#form-input-885 .editor
    Press Key    css=#form-input-885 .editor    \\8
    The user enters text to a text field    css=#form-input-885 .editor    Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc, quis gravida magna mi a libero. Fusce vulputate eleifend sapien. Vestibulum purus quam, scelerisque ut, mollis sed, nonummy id, metus. Nullam accumsan lorem in dui. Cras ultricies mi eu turpis hendrerit fringilla. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; In ac dui quis mi consectetuer lacinia. Nam pretium turpis et arcu. Duis arcu tortor, suscipit eget, imperdiet nec, imperdiet iaculis, ipsum. Sed aliquam ultrices mauris. Integer ante arcu, accumsan a, consectetuer eget, posuere ut, mauris. Praesent adipiscing. Phasellus ullamcorper ipsum rutrum nunc. Nunc nonummy metus. Vestibulum volutpat pretium libero. Cras id dui. Aenean ut
    Focus    css=.app-submit-btn
    wait for autosave

the text box should turn to green
    the user should see the element    css=#form-input-885 div.success-alert
    Element Should Be Disabled    css=#form-input-885 textarea
...
the word count for the Project description question should be correct (100 words)
    Element Should Contain    css=#form-input-885 .count-down    100
...
the Applicant edits Project summary and marks it as complete
    ...
    Press Key    css=#form-input-885 .editor    \\8
    focus    css=#form-input-885 .editor
    The user enters text to a text field    css=#form-input-885 .editor    Hi, I’m a robot @#$@#$@#$
    the user clicks the button/link    css=#form-input-885 .form-footer .form-footer__actions button[name="mark_as_complete"]
...
the text box should be editable
    Wait Until Element Is Enabled Without Screenshots    css=#form-input-885 textarea
