...
Labour
    ...
    Then Totals should be correct                               jQuery=h4:contains("Total labour costs") [data-mirror^="#section-total"]  Â£ 104,348  jQuery=button:contains("Labour") [data-mirror^="#section-total"]  Â£ 104,348
    ...
    Then Totals should be correct                               jQuery=h4:contains("Total labour costs") [data-mirror^="#section-total"]  Â£ 52,174   jQuery=button:contains("Labour") [data-mirror^="#section-total"]  Â£ 52,174
    And the applicant edits the working days field
    Then Totals should be correct                               jQuery=h4:contains("Total labour costs") [data-mirror^="#section-total"]  Â£ 48,000   jQuery=button:contains("Labour") [data-mirror^="#section-total"]  Â£ 48,000
...
Overhead costs
    ...
    and admin costs total should be correct      jQuery=button:contains("Overhead costs") [data-mirror^="#section-total"]  Â£ 9,600
...
Materials
    ...
    Then Totals should be correct                  jQuery=h4:contains("Total materials costs") [data-mirror^="#section-total"]  Â£ 2,000  jQuery=button:contains("Materials") [data-mirror^="#section-total"]  Â£ 2,000
    And the user clicks the button/link            css=#material-costs-table tbody tr:nth-of-type(1) button
    And the user reloads the page
    Then Totals should be correct                  jQuery=h4:contains("Total materials costs") [data-mirror^="#section-total"]    Â£ 1,000  jQuery=button:contains("Materials") [data-mirror^="#section-total"]  Â£ 1,000
...
Capital usage
    ...
    Then Totals should be correct                       jQuery=h4:contains("Total capital usage costs") [data-mirror^="#section-total"]  Â£ 200  jQuery=button:contains("Capital usage") [data-mirror^="#section-total"]  Â£ 200
    And the user clicks the button/link                 css=#capital_usage [data-repeatable-row]:nth-child(1) button
    And the user reloads the page
    Then Totals should be correct                       jQuery=h4:contains("Total capital usage costs") [data-mirror^="#section-total"]  Â£ 100  jQuery=button:contains("Capital usage") [data-mirror^="#section-total"]  Â£ 100
    And the user clicks the button/link                 css=#capital_usage [data-repeatable-row]:nth-child(1) button
...
Capital usage - negative total
    ...
    Then Totals should be correct                  jQuery=h4:contains("Total capital usage costs") [data-mirror^="#section-total"]  Â£ 0  jQuery=button:contains("Capital usage") [data-mirror^="#section-total"]  Â£ 0
    And the user clicks the button/link            css=#capital_usage [data-repeatable-row]:nth-child(1) button
    [Teardown]    the user clicks the button/link  jQuery=button:contains("Capital usage")
...
Subcontracting costs
    ...
    Then the user should see the element              jQuery=button:contains("Subcontracting") > *:contains("Â£ 200")
...
Travel and subsistence
    ...
    Then Totals should be correct                jQuery=h4:contains("Total travel and subsistence costs") [data-mirror^="#section-total"]  Â£ 2,000  jQuery=button:contains("Travel and subsistence") [data-mirror^="#section-total"]  Â£ 2,000
    And the user clicks the button/link          css=#travel-costs-table [data-repeatable-row]:nth-child(1) button
    And the user reloads the page
    Then Totals should be correct                jQuery=h4:contains("Total travel and subsistence costs") [data-mirror^="#section-total"]  Â£ 1,000  jQuery=button:contains("Travel and subsistence") [data-mirror^="#section-total"]  Â£ 1,000
...
Other costs
    ...
    Then Totals should be correct                        jQuery=h4:contains("Total other costs") [data-mirror^="#section-total"]  Â£ 200  jQuery=button:contains("Other costs") [data-mirror^="#section-total"]  Â£ 200
