...
Edit link navigates to the application form
    ...
    When the user clicks the button/link    jQuery=#form-input-885 button:contains("Return and edit")
    Then the user redirects to the page    Please provide a short summary of your project    Project summary
    And The user enters text to a text field    css=#form-input-885 .editor    Test text 123
...
Mark as complete possible for questions with text
    ...
    [Setup]
    Given The user navigates to the summary page of the Robot test application
    When the user clicks the button/link    jQuery=#form-input-885 button:contains("Mark as complete")
    Then the Project summary question should be marked as complete
    And The user should not see the element    jQuery=#form-input-885 button:contains("Mark as complete")
    [Teardown]  the user clicks the button/link    jQuery=#form-input-885 button:contains("Return and edit")
...
Mark as complete not possible for empty questions
    ...
    When the user clicks the button/link    jQuery=#form-input-907 button:contains("Mark as complete")
    Then the user should see the element    jQuery=#form-input-907 button:contains("Mark as complete")
