...
the Scope section should be expanded
    the user should see the element    css=.section-overview > section:nth-of-type(1) .collapsible:nth-of-type(5) > h3 button[aria-expanded="true"]
    the user should see the element    css=.section-overview > section:nth-of-type(1) .collapsible:nth-of-type(5) > div[aria-hidden="false"]
