...
Partner should be able to log-in and see the new company name
    ...
    When Guest user log-in in new browser in new browser    ${invite_email}    ${correct_password}
...
Login and create a new application
    Guest user log-in in new browser in new browser                     &{lead_applicant_credentials}
