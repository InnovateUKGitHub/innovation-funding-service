...
Business organisation (partner accepts invitation)
    ...
    When the user reads his email and clicks the link  ${invite_email}  Invitation to collaborate in ${OPEN_COMPETITION_NAME_2}  You will be joining as part of the organisation  3
...
Registered partner should not create new org but should follow the create account flow
    ...
    [Tags]    Email
    When the user reads his email and clicks the link      ${TEST_MAILBOX_ONE}+inviteorg2@gmail.com    Invitation to collaborate in ${OPEN_COMPETITION_NAME_2}    You will be joining as part of the organisation    3
