...
The type of organisation navigates to the correct page
    ...
    [Tags]
    When the user should see the text in the page    UK based business.
    And the user selects the radio button    organisationType    1
    And the user clicks the button/link    jQuery=.button:contains("Continue")
    Then the user should see the text in the page    Enter your organisation name or registration number.
    When the user goes back to the previous page
    And the user should see the text in the page    Registered on J-eS, universities, colleges.
    ...
    When the user goes back to the previous page
    And the user should see the text in the page    Organisations which solely promote and conduct collaborative research and innovation.
    Given the user selects the radio button    organisationType    3
    And the user clicks the button/link    jQuery=.button:contains("Continue")
    ...
    When the user goes back to the previous page
    And the user should see the text in the page    A not-for-profit public sector body or charity working on innovation.
