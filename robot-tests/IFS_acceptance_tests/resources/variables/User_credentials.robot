...
&{existing_assessor1_credentials}         email=worth.email.test+jeremy.alufson@gmail.com    password=Passw0rd
&{nonregistered_assessor2_credentials}    email=worth.email.test+david.peters@gmail.com    password=Passw0rd
&{nonregistered_assessor3_credentials}    email=worth.email.test+thomas.fister@gmail.com    password=Passw0rd123
