...
${READY_TO_OPEN_COMPETITION_NAME}    Sarcasm Stupendousness

${COMP_SETUP_COMPETITION}    9

${FUNDERS_PANEL_COMPETITION}    5
${FUNDERS_PANEL_COMPETITION_NAME}    La Fromage
...
${PROJECT_SETUP_COMPETITION_NAME}    Killer Riffs
...
${IN_ASSESSMENT_COMPETITION_NAME}    Juggling Craziness
...
${INFORM_COMPETITION_NAME}    Theremin Theory
