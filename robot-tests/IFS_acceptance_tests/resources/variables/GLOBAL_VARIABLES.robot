...
${READY_TO_OPEN_COMPETITION2}              ${competition_ids['${READY_TO_OPEN_COMPETITION_NAME}']}
${READY_TO_OPEN_COMPETITION_OPEN_DATE_DB2}     ${getMilestoneDateTimeDb(${READY_TO_OPEN_COMPETITION}, "OPEN_DATE")}
${READY_TO_OPEN_COMPETITION_CLOSE_DATE_DB2}    ${getMilestoneDateTimeDb(${READY_TO_OPEN_COMPETITION}, "SUBMISSION_DATE")}
${READY_TO_OPEN_COMPETITION_OPEN_DATE_DATE_LONG2}  ${getPrettyLongMilestoneDate(${READY_TO_OPEN_COMPETITION}, "OPEN_DATE")}
