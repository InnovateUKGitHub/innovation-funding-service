...
${OPEN_COMPETITION}  ${OPEN_COMPETITION_ID}
...
${READY_TO_OPEN_COMPETITION}    ${READY_TO_OPEN_COMPETITION_ID}
${COMP_SETUP_COMPETITION}    9
${FUNDERS_PANEL_COMPETITION_NAME}    Internet of Things
${FUNDERS_PANEL_COMPETITION}    ${FUNDERS_PANEL_COMPETITION_ID}
...
${IN_ASSESSMENT_COMPETITION}  ${IN_ASSESSMENT_COMPETITION_ID}
