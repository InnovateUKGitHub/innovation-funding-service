...
${WITHDRAWN_PROJECT_COMPETITION_NAME_2_NUMBER}       ${application_ids['${WITHDRAWN_PROJECT_COMPETITION_NAME_2}']}
${WITHDRAWN_PROJECT_COMPETITION_NAME_3}    Electricity harvesting from rough terrain driving
${WITHDRAWN_PROJECT_COMPETITION_NAME_3_NUMBER}       ${application_ids['${WITHDRAWN_PROJECT_COMPETITION_NAME_3}']}
