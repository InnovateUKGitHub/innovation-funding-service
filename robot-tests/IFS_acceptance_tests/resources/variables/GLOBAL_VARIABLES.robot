...
${OPEN_COMPETITION}    11
${OPEN_COMPETITION_NAME}    Home and industrial efficiency programme
${OPEN_COMPETITION_APPLICATION_1}    96
${OPEN_COMPETITION_APPLICATION_1_NUMBER}    96
${OPEN_COMPETITION_APPLICATION_2}    99
${OPEN_COMPETITION_APPLICATION_3}    98
${OPEN_COMPETITION_APPLICATION_3_TITLE}    Hydrology the dynamics of Earth's surface water
${OPEN_COMPETITION_APPLICATION_4}    97
${OPEN_COMPETITION_APPLICATION_5}    95
${OPEN_COMPETITION_APPLICATION_5_NUMBER}    95
...
${PUBLIC_DESCRIPTION_URL}    ${SERVER}/application/${OPEN_COMPETITION_APPLICATION_1}/form/question/360
${TECHNICAL_APPROACH_URL}    ${SERVER}/application/${OPEN_COMPETITION_APPLICATION_1}/form/question/366
${YOUR_FINANCES_URL}    ${SERVER}/application/${OPEN_COMPETITION_APPLICATION_1}/form/section/157
${FINANCES_OVERVIEW_URL}    ${SERVER}/application/${OPEN_COMPETITION_APPLICATION_1}/form/section/168
