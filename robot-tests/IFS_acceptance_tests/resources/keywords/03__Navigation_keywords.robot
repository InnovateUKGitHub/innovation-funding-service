...
The user navigates to the page
    ...
    Wait for autosave
    Wait Until Keyword Succeeds Without Screenshots    30    2000ms    Go To    ${TARGET_URL}
    # Error checking
...
The user should be redirected to the correct page
    [Arguments]    ${URL}
    Wait Until Keyword Succeeds Without Screenshots    30    2000ms    Location Should Contain    ${URL}
    the user should not see an error in the page
