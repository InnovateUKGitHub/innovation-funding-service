...
public final class AsyncFuturesHolder {
     ...
     *
     * Most importantly, this method is used within org.innovateuk.ifs.async.controller.AwaitModelFuturesCompletionMethodInterceptor
     ...
     */
    public static void waitForAllFuturesToComplete(long timeoutValue) {

        try {
            waitForFuturesAndChildFuturesToCompleteByFutureName(singletonList("Top level"), timeoutValue);
        } finally {
            clearFutures();
        }
    }
