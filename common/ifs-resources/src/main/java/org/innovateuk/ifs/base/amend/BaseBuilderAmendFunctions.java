package org.innovateuk.ifs.base.amend;
...
public class BaseBuilderAmendFunctions {
    ...
    public static <T> Long getId(T instance) {
        return (Long) ReflectionHelper.getField(instance, "id");
    }
    ...
    public static <T> T setField(String fieldName, Object value, T instance) {
        try {
            ReflectionHelper.invokeSetterMethod(instance, fieldName, value);
        } catch (Exception e) {
            ReflectionHelper.setField(instance, fieldName, value);
        }
        return instance;
    }
    ...
    public static <T> T addToList(String fieldName, Object value, T instance) {
        ...
        List<Object> existingList = (List<Object>) ReflectionHelper.getField(instance, fieldName);
