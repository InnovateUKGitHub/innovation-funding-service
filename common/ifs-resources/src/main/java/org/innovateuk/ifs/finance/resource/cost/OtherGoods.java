...
/**
 * {@code OtherGoods} implements {@link FinanceRowItem}
 */
public class OtherGoods extends AbstractFinanceRowItem {
    Long id;
    ...
    public OtherGoods(Long targetId) {
        super(targetId);
    }

    public OtherGoods(Long id, Integer deprecation, String description, String existing,
