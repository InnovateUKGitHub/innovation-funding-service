...
public class FieldRequiredIfValidator implements ConstraintValidator<FieldRequiredIf, Object> {
    ...
    private boolean isPredicateMet(Object object, String argumentFieldName, boolean predicateValue) {
        BeanWrapper beanWrapper = PropertyAccessorFactory.forBeanPropertyAccess(object);
        Boolean argumentValue = (Boolean) beanWrapper.getPropertyValue(argumentFieldName);
        return argumentValue != null && argumentValue == predicateValue;
    }

    private boolean isRequiredFieldBlank(Object object, String requiredFieldName) {
        BeanWrapper beanWrapper = PropertyAccessorFactory.forBeanPropertyAccess(object);
        Object requiredFieldValue = beanWrapper.getPropertyValue(requiredFieldName);
