...
public class ApplicationAssessmentResourceBuilder extends BaseBuilder<ApplicationAssessmentResource, ApplicationAssessmentResourceBuilder> {
    ...
    public ApplicationAssessmentResourceBuilder withTotalScoreGiven(Integer... totalScoreGivens) {
        return withArraySetFieldByReflection("totalScoreGiven", totalScoreGivens);
    }
