...
public class AssessorCompetitionDashboardResourceBuilder extends BaseBuilder<AssessorCompetitionDashboardResource, AssessorCompetitionDashboardResourceBuilder> {
    ...
    public AssessorCompetitionDashboardResourceBuilder withOpenEndCompetition(Boolean... openEndCompetitions) {
        return withArraySetFieldByReflection("openEndCompetition", openEndCompetitions);
    }

    public AssessorCompetitionDashboardResourceBuilder withBatchIndex(Long... batchIndexes) {
        return withArraySetFieldByReflection("batchIndex", batchIndexes);
    }
