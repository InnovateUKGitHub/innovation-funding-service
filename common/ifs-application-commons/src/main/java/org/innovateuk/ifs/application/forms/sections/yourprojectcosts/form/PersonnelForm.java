...
public class PersonnelForm {
    ...
    private Map<String, PersonnelRowForm> rows = new LinkedHashMap<>();
    ...
    public Map<String, PersonnelRowForm> getRows() {
        return rows;
    }

    public void setRows(Map<String, PersonnelRowForm> rows) {
        this.rows = rows;
    }
}
