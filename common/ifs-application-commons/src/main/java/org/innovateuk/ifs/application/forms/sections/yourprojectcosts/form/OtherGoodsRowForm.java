...
public class OtherGoodsRowForm extends AbstractCostRowForm<OtherGoods> {
    ...
    public OtherGoodsRowForm() {}

    public OtherGoodsRowForm(OtherGoods cost) {
        super(cost);
    ...
    @Override
    public OtherGoods toCost(Long financeId) {
        return new OtherGoods(getCostId(), deprecation, item, Boolean.TRUE.equals(newItem) ? "New" : "Existing", netValue, residualValue, utilisation, financeId);
    }
