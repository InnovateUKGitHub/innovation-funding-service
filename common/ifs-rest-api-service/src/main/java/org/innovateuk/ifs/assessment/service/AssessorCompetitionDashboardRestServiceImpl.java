...
public class AssessorCompetitionDashboardRestServiceImpl extends BaseRestService implements AssessorCompetitionDashboardRestService {
    ...
    @Override
    public RestResult<AssessorCompetitionDashboardResource> getAssessorCompetitionDashboard(long competitionId, long assessmentPeriodId, long userId) {
        return getWithRestResult(format(baseUrl + "/period/%d/dashboard", userId, competitionId, assessmentPeriodId), AssessorCompetitionDashboardResource.class);
    }
}
