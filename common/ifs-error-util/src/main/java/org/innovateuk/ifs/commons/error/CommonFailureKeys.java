...
public enum CommonFailureKeys implements ErrorTemplate {
    ...
    GENERAL_INVALID_ARGUMENT(BAD_REQUEST),
    ...
    GENERAL_OPTIMISTIC_LOCKING_FAILURE(CONFLICT),
    ...
    FILES_SELECT_AT_LEAST_ONE_FILE_TYPE(BAD_REQUEST),
    ...
    FILES_ALREADY_UPLOADED(BAD_REQUEST),
    FILES_PAYLOAD_TOO_LARGE(PAYLOAD_TOO_LARGE),
    ...
    COMPETITION_WITH_ASSESSORS_CANNOT_BE_DELETED(BAD_REQUEST),
    COMPETITION_DUPLICATE_FUNDERS(BAD_REQUEST),
    STAKEHOLDER_INVITE_INVALID(BAD_REQUEST),
    STAKEHOLDER_INVITE_INVALID_EMAIL(BAD_REQUEST),
    STAKEHOLDER_INVITE_EMAIL_TAKEN(BAD_REQUEST),
    STAKEHOLDER_INVITE_TARGET_USER_ALREADY_INVITED(BAD_REQUEST),
    STAKEHOLDERS_CANNOT_BE_INTERNAL_USERS(BAD_REQUEST),
    STAKEHOLDER_HAS_ACCEPTED_INVITE(BAD_REQUEST),
    ...
    /**
     * Applications eoi evidence submission
     */
    APPLICATION_UNABLE_TO_UPLOAD_EOI_EVIDENCE_AS_APPLICATION_NOT_YET_SUBMITTED(CONFLICT),
    APPLICATION_UNABLE_TO_FIND_UPLOADED_EOI_EVIDENCE(NOT_FOUND),
    APPLICATION_NOT_ENABLED_FOR_EOI_EVIDENCE_UPLOAD(INTERNAL_SERVER_ERROR),
    APPLICATION_UNABLE_TO_INITIALISE_EOI_EVIDENCE_UPLOAD(INTERNAL_SERVER_ERROR),
    APPLICATION_UNABLE_TO_REMOVE_EOI_EVIDENCE_UPLOAD(INTERNAL_SERVER_ERROR),
    APPLICATION_UNABLE_TO_SUBMIT_EOI_EVIDENCE_UPLOAD(INTERNAL_SERVER_ERROR),
    APPLICATION_UNABLE_TO_SEND_EOI_EVIDENCE_UPLOADED_NOTIFICATION(INTERNAL_SERVER_ERROR),
    ...
    USER_EMAIL_UPDATE_EMAIL_ALREADY_EXISTS(CONFLICT),
    USER_EMAIL_UPDATE_EMAIL_EXISTS_ON_APPLICATION(CONFLICT),
    ...
    FUNDING_DECISION_WORKFLOW_FAILURE(BAD_REQUEST),
    FUNDING_DECISION_KTP_PROJECT_NOT_YET_CREATED(BAD_REQUEST),

    /**
     * Assessor Journey
     */
    ASSESSMENT_CREATE_FAILED(BAD_REQUEST),
    ASSESSMENT_CREATE_FAILED_NO_DEFAULT_ASSESSMENT_PERIOD_EXISTS(BAD_REQUEST),
    ASSESSMENT_PERIOD_MISSING_FROM_MILESTONE(BAD_REQUEST),
    ...
    ASSESSMENT_UNSUBMIT_FAILED(BAD_REQUEST),
    ...
    COMPETITION_CANNOT_REOPEN_ASSESSMENT_PERIOD(BAD_REQUEST),
    COMPETITION_CANNOT_RELEASE_FEEDBACK(BAD_REQUEST),
    ASSESSMENT_PANEL_PARTICIPANT_CANNOT_ACCEPT_UNOPENED_INVITE(BAD_REQUEST),
    ASSESSMENT_PANEL_PARTICIPANT_CANNOT_REJECT_UNOPENED_INVITE(BAD_REQUEST),
    ASSESSMENT_PANEL_PARTICIPANT_CANNOT_ACCEPT_ALREADY_ACCEPTED_INVITE(BAD_REQUEST),
    ASSESSMENT_PANEL_PARTICIPANT_CANNOT_REJECT_ALREADY_ACCEPTED_INVITE(BAD_REQUEST),
    ASSESSMENT_PANEL_PARTICIPANT_CANNOT_ACCEPT_ALREADY_REJECTED_INVITE(BAD_REQUEST),
    ASSESSMENT_PANEL_PARTICIPANT_CANNOT_REJECT_ALREADY_REJECTED_INVITE(BAD_REQUEST),
    ASSESSMENT_PANEL_INVITE_CLOSED(BAD_REQUEST),
    ASSESSMENT_PANEL_INVITE_CANNOT_DELETE_ONCE_SENT(BAD_REQUEST),
    ...
    INTERVIEW_PANEL_PARTICIPANT_CANNOT_ACCEPT_UNOPENED_INVITE(BAD_REQUEST),
    INTERVIEW_PANEL_PARTICIPANT_CANNOT_REJECT_UNOPENED_INVITE(BAD_REQUEST),
    INTERVIEW_PANEL_PARTICIPANT_CANNOT_ACCEPT_ALREADY_ACCEPTED_INVITE(BAD_REQUEST),
    INTERVIEW_PANEL_PARTICIPANT_CANNOT_REJECT_ALREADY_ACCEPTED_INVITE(BAD_REQUEST),
    INTERVIEW_PANEL_PARTICIPANT_CANNOT_ACCEPT_ALREADY_REJECTED_INVITE(BAD_REQUEST),
    INTERVIEW_PANEL_PARTICIPANT_CANNOT_REJECT_ALREADY_REJECTED_INVITE(BAD_REQUEST),
    INTERVIEW_PANEL_INVITE_CLOSED(BAD_REQUEST),
    INTERVIEW_PANEL_INVITE_CANNOT_DELETE_ONCE_SENT(BAD_REQUEST),
    INTERVIEW_PANEL_INVITE_EXPIRED(BAD_REQUEST),
    INTERVIEW_PANEL_INVITE_ALREADY_CREATED(BAD_REQUEST),
    INTERVIEW_PANEL_INVITE_ALREADY_SENT(BAD_REQUEST),
    CANNONT_NOTIFY_BY_COMPETITION_WHEN_MULTIPLE_ASSESSMENT_PERIODS(BAD_REQUEST),
    ...
    PROJECT_SETUP_PROJECT_DURATION_MUST_BE_MINIMUM_ONE_MONTH(BAD_REQUEST),
    PROJECT_SETUP_PROJECT_DURATION_MUST_BE_GREATER_THAN_OR_EQUAL_TO_MAX_EXISTING_MILESTONE(BAD_REQUEST),
    PROJECT_SETUP_PROJECT_DURATION_CANNOT_BE_CHANGED_ONCE_SPEND_PROFILE_HAS_BEEN_GENERATED(BAD_REQUEST),
    ...
    PROJECT_SETUP_FINANCE_CONTACT_CANNOT_BE_UPDATED_IF_GOL_GENERATED(BAD_REQUEST),
    ...
    PROJECT_SETUP_LOCATION_CANNOT_BE_UPDATED_IF_GOL_GENERATED(BAD_REQUEST),
    ...
    PROJECT_SETUP_PROJECT_DOCUMENT_NOT_YET_UPLOADED(BAD_REQUEST),
    PROJECT_SETUP_PROJECT_DOCUMENT_CANNOT_BE_DELETED(BAD_REQUEST),
    PROJECT_SETUP_PROJECT_DOCUMENT_INVALID_DECISION(BAD_REQUEST),
    PROJECT_SETUP_PROJECT_DOCUMENT_CANNOT_BE_ACCEPTED_OR_REJECTED(BAD_REQUEST),
    ...
    USER_ADD_ROLE_INVALID_EMAIL(BAD_REQUEST),
    USER_ADD_ROLE_ROLE_ALREADY_EXISTS(BAD_REQUEST),
    ...
    CANNOT_REMOVE_LEAD_ORGANISATION_FROM_PROJECT(BAD_REQUEST),
    ...
    CANNOT_CREATE_PROJECT_IF_COMP_HAS_NO_FINANCES(BAD_REQUEST),
    ...
    BANK_DETAILS_COMPANY_NAME_TOO_LONG(BAD_REQUEST),
    ...
    SPEND_PROFILE_CANNOT_BE_GENERATED_UNTIL_ALL_FUNDING_RULES_APPROVED(BAD_REQUEST),
    SPEND_PROFILE_CANNOT_BE_GENERATED_UNTIL_ALL_PARTNERS_ARE_NO_LONGER_PENDING(BAD_REQUEST),
    ...
    SPEND_PROFILE_NOT_READY_TO_APPROVE(BAD_REQUEST),
    SPEND_PROFILE_CANNOT_BE_APPROVED(BAD_REQUEST),
    SPEND_PROFILE_CANNOT_BE_REJECTED(BAD_REQUEST),
    /**
     * Finance Checks
     */
    ...
    PAYMENT_MILESTONE_CANNOT_BE_APPROVED(INTERNAL_SERVER_ERROR),
    PAYMENT_MILESTONE_CANNOT_BE_RESET(INTERNAL_SERVER_ERROR),

    FUNDING_RULES_CANNOT_BE_APPROVED(INTERNAL_SERVER_ERROR),
    ...
    PARTNER_ALREADY_TO_JOINED_PROJECT(BAD_REQUEST),
    ORGANISATION_ALREADY_EXISTS_FOR_PROJECT(INTERNAL_SERVER_ERROR),

    /**
     * SIL CRM
     */
    CONTACT_NOT_UPDATED(INTERNAL_SERVER_ERROR),
    APPLICATION_NOT_UPDATED(INTERNAL_SERVER_ERROR),
     ...
     * Supporter
     */
    SUPPORTER_ASSIGNMENT_ALREADY_EXISTS(BAD_REQUEST),
    SUPPORTER_WORKFLOW_TRANSITION_FAILURE(BAD_REQUEST),
    SUPPORTER_AFTER_ASSESSMENT_CLOSE(BAD_REQUEST);
