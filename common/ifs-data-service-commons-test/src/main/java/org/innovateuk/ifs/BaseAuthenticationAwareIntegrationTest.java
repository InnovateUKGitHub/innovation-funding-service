...
public abstract class BaseAuthenticationAwareIntegrationTest extends BaseIntegrationTest {
    ...
    protected void loginSteveSmith() {
        BaseIntegrationTest.setLoggedInUser(getSteveSmith());
    }

    protected void loginCompAdmin() {
        BaseIntegrationTest.setLoggedInUser(getCompAdmin());
    }

    protected void loginIfsAdmin() {
        BaseIntegrationTest.setLoggedInUser(getIfsAdmin());
    }

    protected void loginSystemRegistrationUser() {
        BaseIntegrationTest.setLoggedInUser(getSystemRegistrationUser());
    }

    protected void loginSystemMaintenanceUser() {
        BaseIntegrationTest.setLoggedInUser(getSystemMaintenanceUser());
    }

    protected void loginPeteTom() {
        BaseIntegrationTest.setLoggedInUser(getPeteTom());
    }

    protected void loginPaulPlum() {
        BaseIntegrationTest.setLoggedInUser(getPaulPlum());
    }

    protected void loginFelixWilson() {
        BaseIntegrationTest.setLoggedInUser(getFelixWilson());
    }

    protected void loginSuperAdmin() {
        BaseIntegrationTest.setLoggedInUser(getSuperAdminUser());
    }
