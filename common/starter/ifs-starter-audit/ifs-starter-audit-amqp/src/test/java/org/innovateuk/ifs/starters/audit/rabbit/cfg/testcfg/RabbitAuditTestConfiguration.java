...
import org.innovateuk.ifs.starters.audit.rabbit.cfg.RabbitAuditAutoConfiguration;
...
@Configuration
@Import({RabbitAuditAutoConfiguration.class, AuditAutoConfiguration.class})
