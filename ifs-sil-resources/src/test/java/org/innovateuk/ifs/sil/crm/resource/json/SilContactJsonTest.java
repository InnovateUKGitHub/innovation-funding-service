...
public class SilContactJsonTest {
    ...
    public void setup() throws IOException {
        ...
        baseCrmPayloadFromFile = FileUtils.readFileToString(base, StandardCharsets.UTF_8);
        File extra = new File(classLoader.getResource("payloads/CRMPayload_ExtraAttributes.json").getFile());
        extraCrmPayloadFromFile = FileUtils.readFileToString(extra, StandardCharsets.UTF_8);
    }
