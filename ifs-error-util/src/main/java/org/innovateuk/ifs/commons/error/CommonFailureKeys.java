...
public enum CommonFailureKeys implements ErrorTemplate {
    ...
    /**
     * Competition finance users
     */
    COMPETITION_FINANCE_INVITE_INVALID(BAD_REQUEST),
    COMPETITION_FINANCE_INVITE_TARGET_USER_ALREADY_INVITED(BAD_REQUEST),
    COMPETITION_FINANCE_HAS_ACCEPTED_INVITE(BAD_REQUEST),
