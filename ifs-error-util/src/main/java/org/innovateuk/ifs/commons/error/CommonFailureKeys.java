...
public enum CommonFailureKeys implements ErrorTemplate {
    ...
    PROJECT_SETUP_PROJECT_DOCUMENT_NOT_YET_UPLOADED(INTERNAL_SERVER_ERROR),
    PROJECT_SETUP_PROJECT_DOCUMENT_CANNOT_BE_DELETED(INTERNAL_SERVER_ERROR),
    PROJECT_SETUP_PROJECT_DOCUMENT_INVALID_DECISION(INTERNAL_SERVER_ERROR),
    PROJECT_SETUP_PROJECT_DOCUMENT_CANNOT_BE_ACCEPTED_OR_REJECTED(INTERNAL_SERVER_ERROR),
