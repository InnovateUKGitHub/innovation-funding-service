...
do_baseline () {
    ...
    ./gradlew -Pifs.generate.test.data.execution=SINGLE_THREADED :ifs-data-layer:ifs-data-service:cleanTest :ifs-data-layer:ifs-data-service:test --tests org.innovateuk.ifs.testdata.GenerateTestData -x asciidoctor
