...
while getopts ":c: :p: :d: :t: :i: :m:" opt ; do
    case $opt in
        ...
        \?)
            ...
            echo '-p project       : project name (ifs-prod, ifs-demo, ifs-uat, ifs-sysint)'
...
SVC_ACCOUNT_CLAUSE="--namespace=$PROJECT --token=$SVC_ACCOUNT_TOKEN --server=$BAMBOO_OPENSHIFT_CONSOLE_URL --insecure-skip-tls-verify=true"
