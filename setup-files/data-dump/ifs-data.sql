...
INSERT  IGNORE INTO `section` (`id`, `name`, `competition_id`) VALUES (1,'Application details',1),(2,'Scope (Gateway question)',1),(3,'Business proposition (Q1 - Q4)',1),(4,'Project approach (Q5 - Q8)',1),(5,'Funding (Q9 - Q10)',1),(6,'Finances',1);
...
INSERT  IGNORE INTO `user_application_role` (`id`, `application_id`, `role_id`, `user_id`) VALUES (1,1,1,1),(2,2,1,1),(3,3,1,1),(4,4,1,1),(5,1,2,2),(6,4,2,2);
...
-- Dump completed on 2015-08-11 17:44:24
