...
public class OrganisationRestServiceMocksTest extends BaseRestServiceUnitTest<OrganisationRestServiceImpl> {
    ...
    @Test
     public void test_getOrganisationsByApplicationId() {
        ...
        List<OrganisationResource> returnedResponse = OrganisationResourceBuilder.newOrganisationResource().build(3);
        ResponseEntity<List<OrganisationResource>> responseEntity = new ResponseEntity<>(returnedResponse, OK);

        when(mockRestTemplate.exchange(expectedUrl, GET, httpEntityForRestCall(), ParameterizedTypeReferences.organisationResourceListType())).thenReturn(responseEntity);
    ...
    public void test_getOrganisationById() {
        ...
        OrganisationResource returnedResponse = OrganisationResourceBuilder.newOrganisationResource().build();
