...
public class PublicContentItemRestServiceMocksTest extends BaseRestServiceUnitTest<PublicContentItemRestServiceImpl> {
    ...
    public void test_getByFilterValues() {
        ...
        setupGetWithRestResultExpectations(PUBLIC_CONTENT_ITEM_REST_URL + "find-by-filter?innovationAreaId=12&searchString=Search+my+competition&pageNumber=32&pageSize=20", PublicContentItemPageResource.class, expectedResponse);
