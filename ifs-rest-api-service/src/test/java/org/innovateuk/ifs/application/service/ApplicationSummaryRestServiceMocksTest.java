...
public class ApplicationSummaryRestServiceMocksTest extends BaseRestServiceUnitTest<ApplicationSummaryRestServiceImpl> {
    ...
    public void testFindSubmittedApplicationsByCompetitionWithoutSortField() {
        ...
        RestResult<ApplicationSummaryPageResource> result = service.getSubmittedApplications(Long.valueOf(123L), null, 6, 20, null, Optional.empty());
    ...
    public void testFindSubmittedApplicationsByCompetitionWithSortField() {
        ...
        RestResult<ApplicationSummaryPageResource> result = service.getSubmittedApplications(Long.valueOf(123L), "id", 6, 20, null, Optional.empty());
    ...
    public void testFindSubmittedApplicationsByCompetitionWithFilter() {
        ...
        RestResult<ApplicationSummaryPageResource> result = service.getSubmittedApplications(Long.valueOf(123L), null, 6, 20, "10", of(FUNDED));
    ...
    public void testFindSubmittedApplicationsByCompetitionWithFilterAndSortField() {
        ...
        RestResult<ApplicationSummaryPageResource> result = service.getSubmittedApplications(Long.valueOf(123L), "id", 6, 20, "10", empty());
